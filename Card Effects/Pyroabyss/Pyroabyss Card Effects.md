# Pyroabyss — Card Abilities

## Abyss Amplifier
* On play: Gain 3 Heat
* Burst up to 2 Heat (+40.0 Oblivion per Heat)
* +60 Oblivion
* Draw 1 card
* While on board: Ophanim plays gain +30 Oblivion

## Abyssal Detonation
* Burst up to 4 Heat (+44.0 Oblivion per Heat)
* +80 Oblivion
* Draw 1 card
...
* Gain 1 Heat
* If you have 8+ Heat, Draw 1 card
...
* On play: +35 Oblivion
* Gain 3 Heat
* While on board: +12 Oblivion per card played

## Ash Kings Unbound
* Gain 3 Furnace Heat
* Gain 2 Chroma Embers
* If you have 2+ Chroma Embers, Ignite up to 1 Chroma Embers (+68.0 Oblivion × echoes²)
* Gain 1 Furnace Heat
* +900 Oblivion

## Ash Kings' Apocalypse
* Gain 6 Furnace Heat
* Gain 10 Chroma Embers
* If you have 6+ Furnace Heat, Spend 6 Furnace Heat
...
* Gain 3 Chroma Embers
* If you have 3+ Furnace Heat, Gain 2 Chroma Embers
* Draw 1 card
* +700 Oblivion
* While on board: Adjacent active Seraphim gain +90 Oblivion per card played
...
* On play: Gain 4 Heat
* Draw 1 card
* While on board: Gain 1 Heat per card played

## Cinder Threshold
* +36 Oblivion
* If you have 8+ Heat, +44 Oblivion
* Draw 1 card
...
## Cinderwing
* On summon: Gain 6 Heat
* +60 Oblivion
* Draw 1 card
* After 3 cards played: Gain 3 Heat
* Draw 1 card
* While on board: +22 Oblivion per card played while on board
* **[Ashen Wingbeat]** Gain 3 Heat; Draw 1 card

## Conflagration
* +22 Oblivion
* Gain 2 Heat
* If you have played 4+ cards this turn, +40 Oblivion
* If you have 9+ Heat, Draw 1 card

## Flame Burst
* Burst up to 3 Heat (+42.0 Oblivion per Heat)
* +36 Oblivion
...
* On play: +22 Oblivion
* Gain 2 Heat
* If you control 1+ active Cherubim, Gain 3 Heat
* While on board: +18 Oblivion whenever you play an Ophanim while active
...
## Infernal Surge
* +34 Oblivion
* If you control 1+ active Cherubim, Gain 4 Heat

## Infernal Ward
* On play: +45 Oblivion
* Gain 2 Heat
* Draw 1 card
* While on board: Buffs Seraphim and Angel attacks: base +34, cooldown -1
...
* +240 Oblivion
* Draw 2 cards
* While on board: +46 Oblivion per card played while on board
* **[Cataclysm Engine]** Burst up to 5 Heat (+60.0 Oblivion per Heat); +240 Oblivion; Draw 2 cards

## Phoenix Judge of the Abyss
* Gain 2 Furnace Heat
* Gain 1 Chroma Ember
* +900 Oblivion
* If this is the first card you played this turn, Gain 2 Chroma Embers
* Draw 1 card
...
## Pyre Hunt
* Search your deck for 1 matching Cherubim
* Gain 2 Heat

## Pyre Ignite
* Gain 4 Heat
* If you have 6+ Heat, Draw 1 card

## Pyre Mantle
* On play: Gain 3 Heat
* +40 Oblivion
* Search your deck for 1 matching Ophanim
* While on board: Gain 2 Heat per card played
...
## Pyroclasm Engine
* On play: Gain 4 Furnace Heat
* Gain 8 Chroma Embers
* Salvage any 1 card
* If you have 5+ Furnace Heat, Gain 3 Chroma Embers
* Draw 1 card
* +1700 Oblivion
* If you have 9+ Chroma Embers, Spend 3 Chroma Embers
* +1800 Oblivion
* While on board: Adjacent active Seraphim gain +235 Oblivion per card played
...
* Gain 4 Chroma Embers
* +1000 Oblivion
* After 5 cards played: If you have 5+ Furnace Heat, Spend 5 Furnace Heat
* +2600 Oblivion
...
* Gain 5 Chroma Embers
* +1800 Oblivion
* After 5 cards played: If you have 9+ Furnace Heat, Cash out up to 9 Furnace Heat (+1000 Oblivion per stack)
* +4800 Oblivion
* If you have 8+ Chroma Embers, Ignite up to 8 Chroma Embers (+118.0 Oblivion × echoes²)
...
* **[Cataclysm Coronation]** Gain 2 Inferno Tiers and 2 Chroma Embers, then Confluence up to 5 matched pairs for a crowned burst
...
## Void Combustion
* Burst up to 4 Heat (+56.0 Oblivion per Heat)
* If you have 12+ Heat, Draw 2 cards

## Void Flare
* +18 Oblivion
* If you have 6+ Heat, Gain 2 Heat
* Draw 1 card
