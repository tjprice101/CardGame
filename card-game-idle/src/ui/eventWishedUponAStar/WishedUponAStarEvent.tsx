...
const MECHANIC_ROWS: { label: string; desc: string }[] = [
  ...
  { label: 'Nova Wish Burst',   desc: 'WUAS burst action that converts setup into Divine Light. Exact scaling and triggers vary by card — check each card text for live values.' },
        ...
        {activeTab === 'story' && (
          <div style={{ maxWidth: 720, margin: '0 auto' }}>
            ...
            <p style={{ fontSize: 14, lineHeight: 1.8, color: C.textMuted, marginBottom: 16 }}>
              ...
              Divine Light nova-bursts capable of erasing entire boss phases.
            </p>
