    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2, minWidth: 180 }}>
          ...
          <div style={{ fontSize: 13, letterSpacing: 2, color: G.text, fontFamily: G.cinzel }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 15, fontWeight: 600, color: G.electric, fontVariantNumeric: 'tabular-nums' }}>
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 20, fontWeight: 700, letterSpacing: 2, fontVariantNumeric: 'tabular-nums',
        ...
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 600, color: G.entropyColor, fontVariantNumeric: 'tabular-nums' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 14, fontWeight: 600, color: G.shardColor, fontVariantNumeric: 'tabular-nums' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ fontSize: 11, letterSpacing: 1.5, color: G.text, fontFamily: G.cinzel }}>
            {currentBoss?.name ?? currentBossId ?? 'Unknown'}
          </div>
          <div style={{ fontSize: 11, color: G.textMuted, fontVariantNumeric: 'tabular-nums' }}>
      ...
      <div style={{ display: 'flex', gap: 5, alignItems: 'center' }}>
        ...
        <span style={{ fontSize: 9, color: G.textMuted, marginLeft: 6, letterSpacing: 1 }}>
