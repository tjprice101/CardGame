...
const ADVANCED_LINES_MAP: Record<EngineKey, CoreMechanicAdvancedLine[]> = {
  ...
  pyro: [
    ...
    },
    {
      ...
      sequence: 'In higher-rarity Fire turns, Ignite before your Eternal/Infinite Seraphim/Angel attack so the attack consumes fresh Chroma Embers.',
      whyItWorks: 'Chroma Embers add same-turn attack scaling and disappear after attack or turn end.',
    },
  ],
  blazingGarden: [
    {
