    ...
    <div style={styles.backdrop} onClick={onClose}>
      <div style={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ fontSize: 11, color: 'rgba(190,215,245,0.60)', lineHeight: 1.5 }}>
          Play a curated practice deck. No Card-light, mastery rewards, Divine Light, or Resonance points are gained. Your collection is fully restored when the trial ends.
        </div>
