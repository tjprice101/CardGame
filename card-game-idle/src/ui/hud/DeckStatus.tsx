...
const styles: Record<string, React.CSSProperties> = {
  ...
  icon: { fontSize: 14 },
  count: { fontSize: 16, fontWeight: 'bold', color: 'rgba(244,244,248,0.95)' },
  label: { fontSize: 11, color: 'rgba(244,244,248,0.55)', letterSpacing: 1.5, textTransform: 'uppercase' },
  hint: { fontSize: 9, color: 'rgba(244,244,248,0.3)', letterSpacing: 0.8 },
};
