...
export const pyroabyssAngels: AngelDefinition[] = [
  {
    ...
    attacks: {
      primary: {
        ...
        description: '400 base Oblivion · 3 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 400,
        cooldownCards: 3,
        costs: [],
      ...
      exalted: {
        ...
        description: '760 base Oblivion · 5 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 760,
        cooldownCards: 5,
        costs: [],
  ...
  },
  {
    ...
    description: 'On summon: Gain 5 Heat; +110 Oblivion; If you have 10+ Heat, Draw 1 card. After 4 cards played: Burst up to 4 Heat (+52.0 Oblivion per Heat); +100 Oblivion; Empower the next card you play. While on board: +38 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Burst up to 4 Heat (+52.0 Oblivion per Heat); +100 Oblivion; Empower the next card you play',
      effects: [
    ...
    attacks: {
      primary: {
        ...
        description: '470 base Oblivion · 4 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 470,
        cooldownCards: 4,
        costs: [],
        tags: ['angel', 'primary', 'fire'],
      ...
      exalted: {
        ...
        description: '940 base Oblivion · 6 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 940,
        cooldownCards: 6,
        costs: [],
        tags: ['angel', 'exalted', 'fire'],
  ...
  },
  {
    ...
    rarity: 'Legendary',
    name: 'Obliteron',
    description: 'On summon: Gain 7 Heat; +140 Oblivion; Empower the next card you play. After 5 cards played: Burst up to 5 Heat (+60.0 Oblivion per Heat); +240 Oblivion; Draw 2 cards. While on board: +46 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Burst up to 5 Heat (+60.0 Oblivion per Heat); +240 Oblivion; Draw 2 cards',
      effects: [
    ...
    attacks: {
      primary: {
        ...
        description: '970 base Oblivion · 5 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 970,
        cooldownCards: 5,
        costs: [],
        tags: ['angel', 'primary', 'fire'],
      ...
      exalted: {
        ...
        description: '2230 base Oblivion · 7 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 2230,
        cooldownCards: 7,
        costs: [],
        tags: ['angel', 'exalted', 'fire'],
