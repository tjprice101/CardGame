...
export const pyroabyssAngels: AngelDefinition[] = [
  {
    ...
    attacks: {
      primary: {
        ...
        description: '432 base Oblivion · 3 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 432,
        cooldownCards: 3,
        costs: [],
      ...
      exalted: {
        ...
        description: '821 base Oblivion · 5 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 821,
        cooldownCards: 5,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      primary: {
        ...
        description: '508 base Oblivion · 4 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 508,
        cooldownCards: 4,
        costs: [],
        tags: ['angel', 'primary', 'fire'],
      ...
      exalted: {
        ...
        description: '1015 base Oblivion · 6 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 1015,
        cooldownCards: 6,
        costs: [],
        tags: ['angel', 'exalted', 'fire'],
  ...
  },
  {
    ...
    attacks: {
      primary: {
        ...
        description: '1048 base Oblivion · 5 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 1048,
        cooldownCards: 5,
        costs: [],
        tags: ['angel', 'primary', 'fire'],
      ...
      exalted: {
        ...
        description: '2408 base Oblivion · 7 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 2408,
        cooldownCards: 7,
        costs: [],
        tags: ['angel', 'exalted', 'fire'],
