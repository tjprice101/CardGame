...
export const pyroabyssAngels: AngelDefinition[] = [
  ...
  },
  {
    ...
    description: 'Summon: sacrifice Cinderwing + Infernal. Gain 10 Embers, draw 2, and gain +120 Oblivion. After 4 cards: right-click to gain 16 Embers, draw 3, and gain +220 Oblivion. While on board: chain multiplier grows +0.12 faster per card.',
  ...
  },
  {
    ...
    rarity: 'Legendary',
    name: 'Obliteron',
    description: 'Summon: sacrifice Pyroclast Wraith + Void-Flame. Requires 1+ active Chaos card. Gain 15 Embers, draw 3, set chain floor to ×2.2, and gain +140 Oblivion. After 5 cards: right-click to gain 22 Embers, draw 3, set chain floor to ×3.0, and gain +380 Oblivion. While on board: +44 Oblivion per card played.',
    ...
    onSummonEffects: [
      ...
      { type: 'draw', value: 3 },
      { type: 'set_chain_floor', value: 2.2 },
      { type: 'oblivion_flat', value: 140 },
    ],
    activatedAbility: {
      name: 'Cataclysm Engine',
      cardsPlayedRequirement: 5,
      description: 'Gain 22 Embers, draw 3 cards, set chain floor to ×3.0, and gain +380 Oblivion.',
      effects: [
        { type: 'ember_gain', value: 22 },
        { type: 'draw', value: 3 },
        { type: 'set_chain_floor', value: 3.0 },
        { type: 'oblivion_flat', value: 380 },
      ],
    },
