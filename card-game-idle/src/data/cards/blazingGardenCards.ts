...
export const blazingGardenCards: CardDefinition[] = [
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '236 base Oblivion · 5 cards cooldown · chain +1.14 · Cost: discard 1 card',
    synergizedDescription: '413 base Oblivion · 8 cards cooldown · chain +1.30 · Requires Angel',
  ...
  buildSeraphim({
    ...
    description: 'On play: Empower the next card you play; Gain 6 Bloom. While on board: Chain grows +0.04 per card played while active',
    rarity: 'Rare',
    ...
    unsynergizedDescription: '300 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '525 base Oblivion · 8 cards cooldown · chain +1.49 · Requires Angel',
  ...
  buildSeraphim({
    ...
    description: 'On play: Draw 2 cards; Amplify Chain by +x1.9; Gain 5 Bloom. While on board: +22 Oblivion per card played while active',
    rarity: 'Epic',
    artKey: 'bg_ser_vethkorath_starspine',
    bonusType: 'oblivion_per_card',
    bonusValue: 22,
    onPlayEffects: [{ type: 'draw', value: 2 }, { type: 'chain_gain', value: 1.9 }, { type: 'bloom_gain', value: 5 }],
    unsynergizedName: 'Thistle Proof Cut',
    synergizedName: 'Proof Completed Cut',
    unsynergizedDescription: '418 base Oblivion · 5 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '732 base Oblivion · 8 cards cooldown · chain +1.39 · Requires Angel',
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '516 base Oblivion · 5 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '903 base Oblivion · 8 cards cooldown · chain +1.42 · Requires Angel',
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '620 base Oblivion · 5 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '1085 base Oblivion · 8 cards cooldown · chain +1.46 · Requires Angel',
  ...
  buildCherubim({
    ...
    description: 'On play: Draw 1 card. While on board: Adjacent active Seraphim gain +24 Oblivion per card played; Buffs Angel attacks: base +22, chain bonus +0.06, cooldown +0, multiplier x1.00',
    rarity: 'Common',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 7 Bloom. While on board: Adjacent active Seraphim gain +0.05 chain growth; Buffs Seraphim and Angel attacks: base +33, chain bonus +0.01, cooldown +0, multiplier x1.00',
    rarity: 'Rare',
  ...
  buildCherubim({
    ...
    description: 'On play: Draw 1 card; Gain 4 Bloom. While on board: Seraphim bonuses are amplified by +0.08; Buffs Seraphim attacks: base +42, chain bonus +0.05, cooldown -1, multiplier x1.00',
    rarity: 'Rare',
  ...
  buildCherubim({
    ...
    description: 'On play: Salvage any 1 card. While on board: Adjacent active Seraphim gain +32 Oblivion per card played; Buffs Seraphim attacks: base +34, chain bonus +0.06, cooldown -1, multiplier x1.00; Buffs Angel attacks: base +27, chain bonus +0.04, cooldown +0, multiplier x1.00',
    rarity: 'Epic',
  ...
  buildCherubim({
    ...
    description: 'On play: Draw 2 cards; Gain 10 Bloom. While on board: Adjacent active Seraphim gain +0.06 chain growth; Buffs Seraphim and Angel attacks: base +59, chain bonus +0.01, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +46, chain bonus +0.01, cooldown -1, multiplier x1.00',
    rarity: 'Legendary',
  ...
  buildCherubim({
    ...
    description: 'On play: Shuffle discard into deck; Draw 1 card. While on board: Adjacent active Seraphim gain +40 Oblivion per card played; Buffs Seraphim attacks: base +36, chain bonus +0.07, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +28, chain bonus +0.05, cooldown -1, multiplier x1.00',
    rarity: 'Legendary',
  ...
  buildOphanim({
    ...
    description: 'Amplify Chain by +x1.7; Gain 5 Bloom; Empower the next card you play; Draw 1 card',
    rarity: 'Rare',
    artKey: 'bg_oph_violet_crown_drift',
    effects: [{ type: 'chain_gain', value: 1.7 }, { type: 'bloom_gain', value: 5 }],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    description: 'Draw 4 cards; Amplify Chain by +x2.2; Gain 10 Bloom',
    rarity: 'Legendary',
    artKey: 'bg_oph_chordbearing_migration',
    effects: [{ type: 'draw', value: 4 }, { type: 'chain_gain', value: 2.2 }, { type: 'bloom_gain', value: 10 }],
  }),
  ...
  buildSeraphim({
    ...
    description: 'On play: Set Garden Law to Rose if unset; Choose a lineage, then Burn-phase cards gain 1 Seed when you play a different lineage; Echo effects are doubled for 1 turn; Gain 2 Wild Pollen. While on board: Chain grows +0.18 per card played while active',
    rarity: 'Eternal',
    ...
    unsynergizedDescription: '1020 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '1785 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
    unsynergizedBase: 1100,
    synergizedBase: 1850,
    unsynergizedCooldown: 5,
    synergizedCooldown: 8,
    unsynergizedScaling: 1.32,
    synergizedScaling: 1.62,
  }),
  buildSeraphim({
    ...
    unsynergizedDescription: '1080 base Oblivion · 5 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '1890 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
    unsynergizedBase: 1200,
    synergizedBase: 2000,
    unsynergizedCooldown: 5,
    synergizedCooldown: 8,
    unsynergizedScaling: 1.36,
    synergizedScaling: 1.66,
  }),
  buildCherubim({
    definitionId: 'bg-et-vethkorath-seven-crown-proof',
    name: 'Vethkorath Seven-Crown Proof',
    description: 'On play: Gain 3 Wild Pollen. While on board: Adjacent active Seraphim gain +0.08 chain growth; Each adjacent active Seraphim adds 1 extra card whenever you play a card; Buffs Seraphim and Angel attacks: chain bonus +0.09, cooldown -1',
    rarity: 'Eternal',
  ...
  buildOphanim({
    ...
    description: 'Gain 16 Bloom; Replay last Ophanim played this turn; If you have played 4+ cards this turn, Amplify Chain by +x3.1; Empower the next card you play; Shuffle discard into deck; Draw 1 card',
    rarity: 'Eternal',
  ...
  buildSeraphim({
    ...
    description: 'On play: Snapshot current Burn-phase lineages; On new lineage: Burn cards of the lineage gain +1 Echo and 1 cooldown reduction; If all lineages are present (end of turn): Bloom all lineages at 100% effect; Gain 3 Wild Pollen; Seed all Wild Pollen (+22.0 Embers per pollen, +0.07% score per Bloom). While on board: Chain grows +0.36 per card played while active',
    rarity: 'Infinite',
    ...
    unsynergizedDescription: '1980 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '3465 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
    unsynergizedBase: 2200,
    synergizedBase: 3700,
    unsynergizedCooldown: 5,
    synergizedCooldown: 8,
    unsynergizedScaling: 1.38,
    synergizedScaling: 1.68,
  }),
  buildSeraphim({
    ...
    unsynergizedDescription: '2300 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '4025 base Oblivion · 7 cards cooldown · chain +1.55 · Requires Angel',
    unsynergizedBase: 2500,
    synergizedBase: 4100,
    unsynergizedCooldown: 5,
    synergizedCooldown: 8,
    unsynergizedScaling: 1.44,
    synergizedScaling: 1.74,
  }),
  buildCherubim({
    definitionId: 'bg-inf-embergrove-resurrection-array',
    name: 'Embergrove Resurrection Array',
    description: 'On play: Gain 4 Wild Pollen. While on board: Seraphim bonuses are amplified by +0.2; Draw 0.5 cards per card played; Buffs Seraphim and Angel attacks: base +80, chain bonus +0.11, cooldown -1, multiplier x1.00; Buffs Angel attacks: base +62, chain bonus +0.07, cooldown -1, multiplier x1.00',
    rarity: 'Infinite',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 2 Wild Pollen; Seed up to 2 Wild Pollen (+25.0 Embers per pollen, +0.05% score per Bloom). While on board: Adjacent active Seraphim gain +0.16 chain growth; If you have 22+ Bloom, this Cherubim grants +1.2 bonus power; Buffs Seraphim attacks: base +76, chain bonus +0.02, cooldown -1, multiplier x1.27; Buffs Angel attacks: base +59, chain bonus +0.01, cooldown -1, multiplier x1.20',
    rarity: 'Infinite',
  ...
  buildOphanim({
    ...
    description: 'Gain 30 Bloom; If you have played 4+ cards this turn, Amplify Chain by +x4.4; If you control 2+ active Seraphim, +1200 Oblivion; If you have 20+ Bloom, Empower the next card you play; Gain 6 Prismatic Light; Draw 1 card',
    rarity: 'Infinite',
  ...
  buildOphanim({
    ...
    description: 'Replay last Ophanim played this turn; Gain 26 Bloom; Salvage 1 card matching Ophanim; If you have played 5+ cards this turn, Amplify Chain by +x4.7; Empower the next card you play',
    rarity: 'Infinite',
