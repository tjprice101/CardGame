...
export const thornboundAngels: AngelDefinition[] = [
  {
    ...
    attacks: {
      primary: {
        ...
        description: '346 base Oblivion �E 3 cards cooldown',
        baseOblivion: 965,
        cooldownCards: 5,
        costs: [],
      ...
      exalted: {
        ...
        description: '1135 base Oblivion �E 7 cards cooldown �E Cost: spend 30 Trail, sacrifice 1 Seraphim',
        baseOblivion: 2220,
        cooldownCards: 7,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '908 base Oblivion �E 8 cards cooldown �E Cost: spend 7 Trail, discard 1 card',
        baseOblivion: 2300,
        cooldownCards: 7,
        costs: [],
        tags: ['angel', 'exalted', 'thornbound'],
