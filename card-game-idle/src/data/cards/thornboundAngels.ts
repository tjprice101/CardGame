...
export const thornboundAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: Gain 2 Trail; Draw 1 card; Amplify Chain by +1.35. After 4 cards played: Spend 3 Trail; +200 Oblivion; Empower the next card you play. While on board: +8 Oblivion for each Seraphim on board while on board',
  ...
  },
  {
    ...
    description: 'On summon: Gain 4 Trail; +170 Oblivion; Amplify Chain by +1.5. After 5 cards played: Spend 9999 Trail; +260 Oblivion. While on board: +16 Oblivion per card played while on board',
