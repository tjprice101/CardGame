...
export const thornboundAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: Gain 2 Trail; Draw 1 card; Amplify Chain by +x1.35. After 4 cards played: Spend 3 Trail; +200 Oblivion; Empower the next card you play. While on board: +8 Oblivion for each Seraphim on board while on board',
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '1135 base Oblivion · 7 cards cooldown · chain +1.32 · Cost: spend 30 Trail, sacrifice 1 Seraphim',
        baseOblivion: 2220,
        cooldownCards: 7,
        chainScaling: 1.46,
        costs: [],
  ...
  },
  {
    ...
    description: 'On summon: Gain 4 Trail; +170 Oblivion; Amplify Chain by +x1.5. After 5 cards played: Spend 9999 Trail; +260 Oblivion. While on board: +16 Oblivion per card played while on board',
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '908 base Oblivion · 8 cards cooldown · chain +1.32 · Cost: spend 7 Trail, discard 1 card',
        baseOblivion: 2300,
        cooldownCards: 7,
        chainScaling: 1.46,
        costs: [],
