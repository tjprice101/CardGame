...
export const thornboundSeraphims: SeraphimDefinition[] = [
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '174 base Oblivion · 5 cards cooldown · Cost: spend 25 Trail',
        baseOblivion: 225,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'thornbound'],
      ...
      synergized: {
        ...
        description: '410 base Oblivion · 8 cards cooldown · Requires Angel',
        baseOblivion: 383,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '186 base Oblivion · 5 cards cooldown · Cost: spend 25 Trail',
        baseOblivion: 215,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'thornbound'],
      ...
      synergized: {
        ...
        description: '467 base Oblivion · 8 cards cooldown · Requires Angel',
        baseOblivion: 366,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '215 base Oblivion · 2 cards cooldown · Cost: spend 25 Trail',
        baseOblivion: 350,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'thornbound'],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '213 base Oblivion · 2 cards cooldown · Cost: spend 25 Trail',
        baseOblivion: 350,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'thornbound'],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '289 base Oblivion · 5 cards cooldown · Cost: spend 25 Trail',
        baseOblivion: 550,
        cooldownCards: 5,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'thornbound'],
      ...
      synergized: {
        ...
        description: '721 base Oblivion · 8 cards cooldown · Requires Angel',
        baseOblivion: 935,
        cooldownCards: 6,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '315 base Oblivion · 5 cards cooldown · Cost: spend 25 Trail',
        baseOblivion: 935,
        cooldownCards: 5,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'thornbound'],
      ...
      synergized: {
        ...
        description: '665 base Oblivion · 8 cards cooldown · Requires Angel',
        baseOblivion: 1590,
        cooldownCards: 6,
        costs: [],
        requiresAngelOnBoard: true,
