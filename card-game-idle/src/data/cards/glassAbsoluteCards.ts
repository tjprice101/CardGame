...
export const glassAbsoluteCards: CardDefinition[] = [
  buildSeraphim({
    ...
    description: 'On play: +100 Oblivion; Gain 1 Refraction Charge; If you have 2+ Refraction Charges, +60 Oblivion. While on board: +12 Oblivion per card played while active',
    rarity: 'Common',
    artKey: 'ga_ser_prismwake',
    bonusType: 'oblivion_per_card',
    bonusValue: 12,
    onPlayEffects: [{ type: 'oblivion_flat', value: 100 }, { type: 'set_secondary_gain', kind: 'absol', value: 1 }, { type: 'conditional', condition: { type: 'set_secondary_gte', kind: 'absol', value: 2 }, then: [{ type: 'oblivion_flat', value: 60 }] }],
    unsynergizedName: 'Prismwake Vector Break',
    synergizedName: 'Prismwake Angelic Verdict',
    unsynergizedDescription: '240 base Oblivion · 4 cards cooldown',
    synergizedDescription: '408 base Oblivion · 5 cards cooldown · Requires Angel',
    unsynergizedBase: 437,
    synergizedBase: 551,
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 1 Refraction Charge; Draw 1 card; If you have 4+ Refraction Charges, Draw 1 card. While on board: +18 Oblivion per card played while active',
    rarity: 'Rare',
    artKey: 'ga_ser_lattice_canticle',
    bonusType: 'oblivion_per_card',
    bonusValue: 18,
    onPlayEffects: [{ type: 'set_secondary_gain', kind: 'absol', value: 1 }, { type: 'draw', value: 1 }, { type: 'conditional', condition: { type: 'set_secondary_gte', kind: 'absol', value: 4 }, then: [{ type: 'draw', value: 1 }] }],
    unsynergizedName: 'Lattice Canticle Vector Break',
    synergizedName: 'Lattice Canticle Angelic Verdict',
    unsynergizedDescription: '312 base Oblivion · 4 cards cooldown',
    synergizedDescription: '530 base Oblivion · 5 cards cooldown · Requires Angel',
    unsynergizedBase: 568,
    synergizedBase: 716,
    unsynergizedCooldown: 4,
    synergizedCooldown: 5,
  }),
  buildSeraphim({
    ...
    description: 'On play: +180 Oblivion; Gain 1 Refraction Charge; If you control 2+ active Seraphim, Gain 1 Refraction Charge. While on board: +14 Oblivion per card played while active',
    rarity: 'Rare',
    artKey: 'ga_ser_white_edge',
    bonusType: 'oblivion_per_card',
    bonusValue: 14,
    onPlayEffects: [{ type: 'oblivion_flat', value: 180 }, { type: 'set_secondary_gain', kind: 'absol', value: 1 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 2 }, then: [{ type: 'set_secondary_gain', kind: 'absol', value: 1 }] }],
    unsynergizedName: 'White Edge Vector Break',
    synergizedName: 'White Edge Angelic Verdict',
    unsynergizedDescription: '366 base Oblivion · 5 cards cooldown',
    synergizedDescription: '612 base Oblivion · 6 cards cooldown · Requires Angel',
    unsynergizedBase: 667,
    synergizedBase: 826,
  ...
  buildSeraphim({
    ...
    description: 'On play: +260 Oblivion; Gain 2 Refraction Charges; If you have 4+ Refraction Charges, +80 Oblivion. While on board: +30 Oblivion per card played while active',
    rarity: 'Epic',
    artKey: 'ga_ser_glass_hymn',
    bonusType: 'oblivion_per_card',
    bonusValue: 30,
    onPlayEffects: [{ type: 'oblivion_flat', value: 260 }, { type: 'set_secondary_gain', kind: 'absol', value: 2 }, { type: 'conditional', condition: { type: 'set_secondary_gte', kind: 'absol', value: 4 }, then: [{ type: 'oblivion_flat', value: 80 }] }],
    unsynergizedName: 'Glass Hymn Vector Break',
    synergizedName: 'Glass Hymn Angelic Verdict',
    unsynergizedDescription: '460 base Oblivion · 5 cards cooldown',
    synergizedDescription: '782 base Oblivion · 6 cards cooldown · Requires Angel',
    unsynergizedBase: 838,
    synergizedBase: 1056,
    unsynergizedCooldown: 5,
    synergizedCooldown: 6,
  }),
  buildSeraphim({
    ...
    description: 'On play: Gain 2 Refraction Charges; Draw 2 cards; If you have 6+ Refraction Charges, +120 Oblivion. While on board: +22 Oblivion per card played while active',
    rarity: 'Legendary',
    artKey: 'ga_ser_yrethborn',
    bonusType: 'oblivion_per_card',
    bonusValue: 22,
    onPlayEffects: [{ type: 'set_secondary_gain', kind: 'absol', value: 2 }, { type: 'draw', value: 2 }, { type: 'conditional', condition: { type: 'set_secondary_gte', kind: 'absol', value: 6 }, then: [{ type: 'oblivion_flat', value: 120 }] }],
    unsynergizedName: 'Yrethborn Vector Break',
    synergizedName: 'Yrethborn Angelic Verdict',
    unsynergizedDescription: '690 base Oblivion · 6 cards cooldown',
    synergizedDescription: '1166 base Oblivion · 7 cards cooldown · Requires Angel',
    unsynergizedBase: 1258,
    synergizedBase: 1574,
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 1 Refraction Charge; If you control 1+ active Seraphim, +80 Oblivion. While on board: Buffs Seraphim attacks: base +42',
    rarity: 'Rare',
    artKey: 'ga_cher_facet_gate_ward',
    effects: [{ type: 'cherubim_attack_buff', targetUnitType: 'Seraphim', bonusBaseOblivion: 42 }],
    onPlayEffects: [{ type: 'set_secondary_gain', kind: 'absol', value: 1 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 1 }, then: [{ type: 'oblivion_flat', value: 80 }] }],
  }),
  buildCherubim({
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 3 Refraction Charges; Salvage 1 card matching Seraphim. While on board: Adjacent active Seraphim gain +46 Oblivion per card played',
    rarity: 'Legendary',
    artKey: 'ga_cher_glass_mantle_custodian',
    effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'oblivion', value: 46 }],
    onPlayEffects: [{ type: 'set_secondary_gain', kind: 'absol', value: 3 }, { type: 'salvage_by_type', filter: ['Seraphim'] }],
  }),
  buildCherubim({
    definitionId: 'ga-cher-splitlight-cantor',
    name: 'Splitlight Cantor',
    description: 'On play: Gain 2 Refraction Charges; +160 Oblivion. While on board: Gain 2 Absol per card played',
    rarity: 'Rare',
    artKey: 'ga_cher_splitlight_cantor',
    effects: [{ type: 'cherubim_resource_per_card', resource: 'absol', value: 2 }],
    onPlayEffects: [{ type: 'set_secondary_gain', kind: 'absol', value: 2 }, { type: 'oblivion_flat', value: 160 }],
  }),
  buildCherubim({
    definitionId: 'ga-cher-light-archive',
    name: 'Light Archive of Glass',
    description: 'On play: Gain 2 Refraction Charges; Look at the top 5 cards, take 2 cards, and put the rest on the bottom. While on board: Buffs Seraphim and Angel attacks: base +59',
    rarity: 'Legendary',
    artKey: 'ga_cher_light_archive',
    effects: [{ type: 'cherubim_attack_buff', targetUnitType: 'Any', bonusBaseOblivion: 59 }],
    onPlayEffects: [{ type: 'set_secondary_gain', kind: 'absol', value: 2 }, { type: 'look_top_take', look: 5, take: 2 }],
  }),
  buildCherubim({
  ...
  buildOphanim({
    ...
    description: 'Gain 2 Refraction Charges; +60 Oblivion; If you have 3+ Refraction Charges, Draw 1 card',
    rarity: 'Common',
    artKey: 'ga_oph_spectral_current',
    effects: [
      { type: 'set_secondary_gain', kind: 'absol', value: 2 },
      { type: 'oblivion_flat', value: 60 },
      { type: 'conditional', condition: { type: 'set_secondary_gte', kind: 'absol', value: 3 }, then: [{ type: 'draw', value: 1 }] }
    ],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    description: 'Salvage 1 card matching Seraphim; Draw 1 card; Gain 2 Refraction Charges',
    rarity: 'Rare',
  ...
  buildOphanim({
    ...
    description: 'Shuffle discard into deck; Draw 2 cards; Gain 2 Refraction Charges',
    rarity: 'Epic',
    artKey: 'ga_oph_crystal_echo_archive',
    effects: [{ type: 'shuffle_discard' }, { type: 'draw', value: 2 }, { type: 'set_secondary_gain', kind: 'absol', value: 2 }],
  }),
  buildOphanim({
    definitionId: 'ga-oph-white-transit',
    name: 'White Transit',
    description: 'Gain 2 Refraction Charges; Draw 4 cards; +240 Oblivion',
    rarity: 'Legendary',
    artKey: 'ga_oph_white_transit',
    effects: [{ type: 'set_secondary_gain', kind: 'absol', value: 2 }, { type: 'draw', value: 4 }, { type: 'oblivion_flat', value: 240 }],
  }),
  buildOphanim({
    ...
    effects: [
      ...
      { type: 'set_secondary_gain', kind: 'absol', value: 3 },
      { type: 'conditional', condition: { type: 'set_secondary_gte', kind: 'absol', value: 4 }, then: [{ type: 'oblivion_flat', value: 120 }] }
    ],
  }),
  buildOphanim({
    ...
    effects: [
      { type: 'look_top_take', look: 5, take: 2 },
      { type: 'set_secondary_gain', kind: 'absol', value: 2 },
      { type: 'conditional', condition: { type: 'set_secondary_gte', kind: 'absol', value: 6 }, then: [{ type: 'oblivion_flat', value: 120 }] }
    ],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    name: 'Clear Beyond',
    description: 'Shuffle discard into deck; Draw 2 cards; Gain 3 Refraction Charges',
    rarity: 'Common',
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 3 Refraction Charges; Salvage any 1 card. While on board: +84 Oblivion per card played while active',
    rarity: 'Eternal',
