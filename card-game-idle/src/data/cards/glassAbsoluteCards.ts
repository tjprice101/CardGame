...
export const glassAbsoluteCards: CardDefinition[] = [
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 14 of your dominant resource; Amplify Chain by +2.0. While on board: +14 Oblivion per card played while active',
    rarity: 'Rare',
  ...
  buildSeraphim({
    ...
    description: 'On play: Draw 2 cards; Set chain multiplier to x2.0; Gain 22 of your dominant resource. While on board: +22 Oblivion per card played while active',
    rarity: 'Legendary',
