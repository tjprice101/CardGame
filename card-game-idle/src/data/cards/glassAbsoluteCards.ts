...
export const glassAbsoluteCards: CardDefinition[] = [
  buildSeraphim({
    ...
    description: 'On play: Draw 1 card; Amplify Chain by +x1.5. While on board: +12 Oblivion per card played while active',
    rarity: 'Common',
    artKey: 'ga_ser_prismwake',
    bonusType: 'oblivion_per_card',
    bonusValue: 12,
    onPlayEffects: [{ type: 'draw', value: 1 }, { type: 'chain_gain', value: 1.5 }],
    unsynergizedName: 'Prismwake Vector Break',
    synergizedName: 'Prismwake Angelic Verdict',
    unsynergizedDescription: '240 base Oblivion · 5 cards cooldown · chain +1.22 · Cost: discard 1 card',
    synergizedDescription: '420 base Oblivion · 8 cards cooldown · chain +1.32 · Requires Angel',
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '312 base Oblivion · 5 cards cooldown · chain +1.24 · Cost: discard 1 card',
    synergizedDescription: '546 base Oblivion · 8 cards cooldown · chain +1.35 · Requires Angel',
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 14 Proof; Amplify Chain by +x2.0. While on board: +14 Oblivion per card played while active',
    rarity: 'Rare',
    artKey: 'ga_ser_white_edge',
    bonusType: 'oblivion_per_card',
    bonusValue: 14,
    onPlayEffects: [{ type: 'proof_gain', value: 14 }, { type: 'chain_gain', value: 2.0 }],
    unsynergizedName: 'White Edge Vector Break',
    synergizedName: 'White Edge Angelic Verdict',
    unsynergizedDescription: '366 base Oblivion · 5 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '641 base Oblivion · 8 cards cooldown · chain +1.38 · Requires Angel',
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '460 base Oblivion · 5 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '805 base Oblivion · 8 cards cooldown · chain +1.41 · Requires Angel',
  ...
  buildSeraphim({
    ...
    description: 'On play: Draw 2 cards; Set chain multiplier to x2.0; Gain 22 Proof. While on board: +22 Oblivion per card played while active',
    rarity: 'Legendary',
    ...
    unsynergizedDescription: '690 base Oblivion · 5 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '1208 base Oblivion · 8 cards cooldown · chain +1.45 · Requires Angel',
  ...
  buildCherubim({
    ...
    description: 'On play: Draw 1 card. While on board: Adjacent active Seraphim gain +28 Oblivion per card played; Buffs Seraphim and Angel attacks: base +26, chain bonus +0.05, cooldown +0, multiplier x1.00',
    rarity: 'Common',
  ...
  buildCherubim({
    ...
    description: 'On play: Amplify Chain by +x1.8. While on board: Adjacent active Seraphim gain +0.05 chain growth; Buffs Seraphim attacks: base +42, chain bonus +0.01, cooldown -1, multiplier x1.00',
    rarity: 'Rare',
    artKey: 'ga_cher_facet_gate_ward',
    effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'chain', value: 0.05 }],
    onPlayEffects: [{ type: 'chain_gain', value: 1.8 }],
  }),
  buildCherubim({
    definitionId: 'ga-cher-prismatic-reliquary',
    name: 'Prismatic Reliquary',
    description: 'On play: Draw 2 cards; Gain 8 Proof. While on board: Adjacent active Seraphim gain +38 Oblivion per card played; Buffs Seraphim attacks: base +34, chain bonus +0.05, cooldown +0, multiplier x1.00',
    rarity: 'Rare',
  ...
  buildCherubim({
    ...
    description: 'On play: Shuffle discard into deck. While on board: Each adjacent active Seraphim adds 1 extra card whenever you play a card; Buffs Seraphim and Angel attacks: base +48, chain bonus +0.07, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +37, chain bonus +0.05, cooldown +0, multiplier x1.00',
    rarity: 'Epic',
  ...
  buildCherubim({
    ...
    description: 'On play: +260 Oblivion. While on board: Seraphim bonuses are amplified by +0.09; Buffs Angel attacks: base +46, chain bonus +0.09, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +36, chain bonus +0.06, cooldown +0, multiplier x1.00',
    rarity: 'Epic',
  ...
  buildCherubim({
    ...
    description: 'On play: Salvage any 1 card. While on board: Adjacent active Seraphim gain +46 Oblivion per card played; Buffs Angel attacks: base +41, chain bonus +0.10, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +32, chain bonus +0.07, cooldown -1, multiplier x1.00',
    rarity: 'Legendary',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 18 Radiance; Draw 1 card. While on board: Gain 12 Radiance per card played; Buffs Seraphim attacks: base +42, chain bonus +0.05, cooldown -1, multiplier x1.00',
    rarity: 'Rare',
  ...
  buildCherubim({
    ...
    description: 'On play: +180 Oblivion; Draw 2 cards. While on board: Adjacent active Seraphim gain +20 Oblivion per card played; Buffs Seraphim and Angel attacks: base +17, chain bonus +0.04, cooldown +0, multiplier x1.00',
    rarity: 'Common',
  ...
  buildOphanim({
    ...
    description: 'Draw 1 card; Amplify Chain by +x1.5',
    rarity: 'Common',
    artKey: 'ga_oph_spectral_current',
    effects: [{ type: 'draw', value: 1 }, { type: 'chain_gain', value: 1.5 }],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    name: 'White Transit',
    description: 'Draw 4 cards; Gain 24 Radiance; Set chain multiplier to x2.5; Gain 20 Proof',
    rarity: 'Legendary',
  ...
  buildOphanim({
    ...
    description: 'Amplify Chain by +x2.0; Gain 18 Proof; Amplify Chain by +x1.4',
    rarity: 'Epic',
    artKey: 'ga_oph_lattice_horizon',
    effects: [{ type: 'chain_gain', value: 2.0 }, { type: 'proof_gain', value: 18 }],
  }),
  buildOphanim({
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 26 Proof; Amplify Chain by +x0.9; Gain 2 Cascade Proofs; If you have 35+ Proof, Spend 10 Proof; Set chain multiplier to x2.6; Empower the next card you play. While on board: +84 Oblivion per card played while active',
    rarity: 'Eternal',
    artKey: 'ga_et_lattice_archive_seraph',
    bonusType: 'oblivion_per_card',
    bonusValue: 84,
    // Role: PASSIVE CASCADE-PROOF BATTERY (Seraphim Eternal). +2 absol each play,
    // never amplifies — hoards proofs for downstream finishers.
    onPlayEffects: [
      { type: 'proof_gain', value: 26 },
      { type: 'chain_gain', value: 0.9 },
      { type: 'set_secondary_gain', kind: 'absol', value: 2 },
      {
        type: 'conditional',
        condition: { type: 'proof_gte', value: 35 },
        then: [{ type: 'proof_spend', value: 10 }, { type: 'chain_multiplier_set', value: 2.6 }, { type: 'multiply_next' }],
      },
    ],
    unsynergizedName: 'Lattice Archive Vector Break',
    synergizedName: 'Lattice Archive Angelic Verdict',
    unsynergizedDescription: '1360 base Oblivion · 6 cards cooldown · chain +1.52',
    synergizedDescription: '2420 base Oblivion · 8 cards cooldown · chain +1.74 · Requires Angel',
    unsynergizedBase: 1360,
    synergizedBase: 2420,
    unsynergizedCooldown: 6,
    synergizedCooldown: 8,
    unsynergizedScaling: 1.52,
    synergizedScaling: 1.74,
  }),
  buildCherubim({
    definitionId: 'ga-et-angled-infinity',
    name: 'Angled Infinity',
    description: 'On play: Gain 18 Proof; Gain 1 Cascade Proof; If this is the first card you played this turn, Amplify Chain by +x1.3; Set chain multiplier to x2.1; Amplify up to 1 Cascade Proofs (+0.1 chain per proof); If you have 30+ Proof, Empower the next card you play. While on board: Adjacent active Seraphim gain +0.12 chain growth; Adjacent active Seraphim gain +44 Oblivion per card played; Buffs Seraphim attacks: base +80, chain bonus +0.08, cooldown -1, when you have 40+ Proof',
    rarity: 'Eternal',
    artKey: 'ga_et_angled_infinity',
    effects: [
      { type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'chain', value: 0.12 },
    ...
    onPlayEffects: [
      ...
      { type: 'conditional', condition: { type: 'first_card_this_turn' }, then: [{ type: 'chain_gain', value: 1.3 }, { type: 'chain_multiplier_set', value: 2.1 }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.10, consume: 1 }] },
  ...
  buildOphanim({
    ...
    name: 'First White',
    description: 'Gain 1 Cascade Proof; If this is the first card you played this turn, Gain 30 Proof; Amplify Chain by +x1.2; If you have played 1+ cards this turn, Gain 14 Proof; Empower the next card you play; If you have 40+ Proof, Spend 10 Proof; Set chain multiplier to x2.4; Amplify Chain by +x0.8; Amplify up to 2 Cascade Proofs (+0.12 chain per proof)',
    rarity: 'Eternal',
    ...
    effects: [
      { type: 'set_secondary_gain', kind: 'absol', value: 1 },
      {
        ...
        then: [{ type: 'proof_gain', value: 30 }, { type: 'chain_gain', value: 1.2 }],
      },
      {
        type: 'conditional',
      ...
      },
      {
        type: 'conditional',
        condition: { type: 'proof_gte', value: 40 },
        then: [{ type: 'proof_spend', value: 10 }, { type: 'chain_multiplier_set', value: 2.4 }, { type: 'chain_gain', value: 0.8 }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.12, consume: 2 }],
      },
    ],
  }),
  buildSeraphim({
    ...
    description: 'On play: Gain 34 Proof; Set chain multiplier to x3.2; Gain 2 Cascade Proofs; If you have 55+ Proof, Spend 12 Proof; Amplify Chain by +x1.0; Empower the next card you play; Amplify up to 2 Cascade Proofs (+0.14 chain per proof). While on board: +140 Oblivion per card played while active',
    rarity: 'Eternal',
    ...
    onPlayEffects: [
      ...
      { type: 'chain_multiplier_set', value: 3.2 },
      { type: 'set_secondary_gain', kind: 'absol', value: 2 },
      { type: 'conditional', condition: { type: 'proof_gte', value: 55 }, then: [{ type: 'proof_spend', value: 12 }, { type: 'chain_gain', value: 1.0 }, { type: 'multiply_next' }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.14, consume: 2 }] },
    ],
    unsynergizedName: 'Center Everywhere Vector Break',
    synergizedName: 'Center Everywhere Angelic Verdict',
    unsynergizedDescription: '1620 base Oblivion · 6 cards cooldown · chain +1.58',
    synergizedDescription: '2860 base Oblivion · 8 cards cooldown · chain +1.80 · Requires Angel',
    unsynergizedBase: 1620,
    synergizedBase: 2860,
    unsynergizedCooldown: 6,
    synergizedCooldown: 8,
    unsynergizedScaling: 1.58,
    synergizedScaling: 1.80,
  }),
  buildCherubim({
    definitionId: 'ga-et-perfect-refraction',
    name: 'Perfect Refraction',
    description: 'On play: Gain 24 Proof; Set chain multiplier to x2.2; Gain 3 Cascade Proofs; If you have 45+ Proof, Empower the next card you play. While on board: Seraphim bonuses are amplified by +0.16; Buffs Seraphim attacks: base +110, chain bonus +0.10, cooldown -1, multiplier x1.00; If you have 50+ Proof, this Cherubim grants +0.14 bonus power; Buffs Angel attacks: base +140, chain bonus +0.08, cooldown -1, when you have 65+ Proof',
    rarity: 'Eternal',
    artKey: 'ga_et_perfect_refraction',
    effects: [
      { type: 'cherubim_seraphim_amp', value: 0.16 },
      { type: 'cherubim_attack_buff', targetUnitType: 'Seraphim', bonusBaseOblivion: 110, bonusChainScaling: 0.10, cooldownDeltaCards: -1, multiplier: 1.0 },
      {
        type: 'cherubim_conditional_buff',
        condition: { type: 'proof_gte', value: 50 },
        value: 0.14,
      },
      {
        type: 'cherubim_attack_buff',
        ...
        bonusChainScaling: 0.08,
        cooldownDeltaCards: -1,
        condition: { type: 'proof_gte', value: 65 },
      },
    ],
    // Role: BACK-ROW CASCADE-PROOF BATTERY (Cherubim Eternal). +3 absol; never
    // amplifies — feeds adjacent Seraphim/Angel finishers.
    onPlayEffects: [
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 50 Proof; Set chain multiplier to x3.6; Amplify Chain by +x3.8; Gain 3 Cascade Proofs; If you have 90+ Proof, Spend 20 Proof; Empower the next card you play; Empower the next card you play; Amplify all Cascade Proofs (+0.16 chain per proof). While on board: +250 Oblivion per card played while active',
    rarity: 'Infinite',
    ...
    onPlayEffects: [
      ...
      { type: 'chain_multiplier_set', value: 3.6 },
      { type: 'chain_gain', value: 3.8 },
      { type: 'set_secondary_gain', kind: 'absol', value: 3 },
      {
        type: 'conditional',
        condition: { type: 'proof_gte', value: 90 },
        then: [{ type: 'proof_spend', value: 20 }, { type: 'multiply_next' }, { type: 'multiply_next' }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.16 }],
      },
    ],
    unsynergizedName: 'Glass Absolute Vector Break',
    synergizedName: 'Glass Absolute Angelic Verdict',
    unsynergizedDescription: '3280 base Oblivion · 7 cards cooldown · chain +1.88',
    synergizedDescription: '5780 base Oblivion · 9 cards cooldown · chain +2.10 · Requires Angel',
    unsynergizedBase: 3280,
    synergizedBase: 5780,
    unsynergizedCooldown: 7,
    synergizedCooldown: 9,
    unsynergizedScaling: 1.88,
    synergizedScaling: 2.10,
  }),
  buildCherubim({
    definitionId: 'ga-inf-refracted-sovereign',
    name: 'Refracted Sovereign',
    description: 'On play: Gain 36 Proof; Set chain multiplier to x2.8; Amplify Chain by +x4.4; Gain 4 Cascade Proofs; If you have 60+ Proof, Spend 12 Proof; Empower the next card you play. While on board: Adjacent active Seraphim gain +0.22 chain growth; Adjacent active Seraphim gain +88 Oblivion per card played; Buffs Seraphim attacks: base +130, chain bonus +0.12, cooldown -1, multiplier x1.00; Buffs Angel attacks: base +180, chain bonus +0.10, cooldown -1, when you have 70+ Proof',
    rarity: 'Infinite',
    artKey: 'ga_inf_refracted_sovereign',
    effects: [
      { type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'chain', value: 0.22 },
      { type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'oblivion', value: 88 },
      { type: 'cherubim_attack_buff', targetUnitType: 'Seraphim', bonusBaseOblivion: 130, bonusChainScaling: 0.12, cooldownDeltaCards: -1, multiplier: 1.0 },
      {
        type: 'cherubim_attack_buff',
        targetUnitType: 'Angel',
        bonusBaseOblivion: 180,
        bonusChainScaling: 0.10,
        cooldownDeltaCards: -1,
        condition: { type: 'proof_gte', value: 70 },
      },
    ],
    // Role: BIG INFINITE BATTERY (Cherubim). +4 Cascade Proofs, no amplify —
    // the highest-volume back-row reservoir in the set.
    onPlayEffects: [
      { type: 'proof_gain', value: 36 },
      { type: 'chain_multiplier_set', value: 2.8 },
      { type: 'chain_gain', value: 4.4 },
  ...
  buildOphanim({
    ...
    description: 'Gain 42 Proof; Set chain multiplier to x2.7; Amplify Chain by +x4.2; Gain 2 Cascade Proofs; If you have 65+ Proof, Spend 14 Proof; Amplify Chain by +x1.6; If you have 90+ Proof, Empower the next card you play; Amplify up to 2 Cascade Proofs (+0.2 chain per proof)',
    rarity: 'Infinite',
    ...
    effects: [
      ...
      { type: 'chain_multiplier_set', value: 2.7 },
      { type: 'chain_gain', value: 4.2 },
      { type: 'set_secondary_gain', kind: 'absol', value: 2 },
      { type: 'conditional', condition: { type: 'proof_gte', value: 65 }, then: [{ type: 'proof_spend', value: 14 }, { type: 'chain_gain', value: 1.6 }] },
      { type: 'conditional', condition: { type: 'proof_gte', value: 90 }, then: [{ type: 'multiply_next' }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.20, consume: 2 }] },
    ],
  }),
  buildSeraphim({
    definitionId: 'ga-inf-chorus-unbroken-spectrum',
    name: 'Chorus of the Unbroken Spectrum',
    description: 'On play: Gain 36 Proof; Set chain multiplier to x2.9; Gain 2 Cascade Proofs; If you have 75+ Proof, Spend 16 Proof; Amplify Chain by +x1.0; Empower the next card you play; Amplify up to 1 Cascade Proofs (+0.3 chain per proof). While on board: +170 Oblivion per card played while active',
    rarity: 'Infinite',
    ...
    onPlayEffects: [
      { type: 'proof_gain', value: 36 },
      { type: 'chain_multiplier_set', value: 2.9 },
      { type: 'set_secondary_gain', kind: 'absol', value: 2 },
      { type: 'conditional', condition: { type: 'proof_gte', value: 75 }, then: [{ type: 'proof_spend', value: 16 }, { type: 'chain_gain', value: 1.0 }, { type: 'multiply_next' }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.30, consume: 1 }] },
    ],
    unsynergizedName: 'Unbroken Spectrum Vector Break',
    synergizedName: 'Unbroken Spectrum Angelic Verdict',
    unsynergizedDescription: '2860 base Oblivion · 7 cards cooldown · chain +1.82',
    synergizedDescription: '4960 base Oblivion · 9 cards cooldown · chain +2.03 · Requires Angel',
    unsynergizedBase: 2860,
    synergizedBase: 4960,
    unsynergizedCooldown: 7,
    synergizedCooldown: 9,
    unsynergizedScaling: 1.82,
    synergizedScaling: 2.03,
  }),
  buildCherubim({
    definitionId: 'ga-inf-shattered-without-shattering',
    name: 'Shattered Without Shattering',
    description: 'On play: Gain 30 Proof; Set chain multiplier to x2.5; Amplify Chain by +x1.4; Gain 3 Cascade Proofs; If you have 70+ Proof, Spend 14 Proof; Empower the next card you play; Amplify Chain by +x0.9; Amplify up to 2 Cascade Proofs (+0.18 chain per proof). While on board: Seraphim bonuses are amplified by +0.24; Adjacent active Seraphim gain +86 Oblivion per card played; Adjacent active Seraphim gain +0.14 chain growth; Buffs Angel attacks: base +180, chain bonus +0.14, cooldown -1, multiplier x1.00; Buffs Seraphim attacks: base +120, chain bonus +0.10, cooldown -1, when you have 60+ Proof',
    rarity: 'Infinite',
    ...
    effects: [
      ...
      { type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'chain', value: 0.14 },
      { type: 'cherubim_attack_buff', targetUnitType: 'Angel', bonusBaseOblivion: 180, bonusChainScaling: 0.14, cooldownDeltaCards: -1, multiplier: 1.0 },
      {
        type: 'cherubim_attack_buff',
        targetUnitType: 'Seraphim',
    ...
    onPlayEffects: [
      ...
      { type: 'set_secondary_gain', kind: 'absol', value: 3 },
      { type: 'conditional', condition: { type: 'proof_gte', value: 70 }, then: [{ type: 'proof_spend', value: 14 }, { type: 'multiply_next' }, { type: 'chain_gain', value: 0.9 }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.18, consume: 2 }] },
    ],
  }),
  buildOphanim({
    definitionId: 'ga-inf-color-after-white',
    name: 'Color After White',
    description: 'Gain 40 Proof; Spend 20 Proof; Set chain multiplier to x3.0; Amplify Chain by +x2.4; Empower the next card you play; Gain 3 Cascade Proofs; If you have 70+ Proof, Spend 10 Proof; Empower the next card you play; If you have 95+ Proof, Amplify Chain by +x1.0; Set chain multiplier to x3.4; Amplify all Cascade Proofs (+0.25 chain per proof)',
    rarity: 'Infinite',
    artKey: 'ga_inf_color_after_white',
    // Role: APEX OPHANIM PROOF FINISHER. Seeds 3; inside proof_gte≥95, amplifies
    // ALL banked Cascade Proofs — the Ophanim counterpart to Glass Absolute Seraph.
    effects: [
      ...
      { type: 'conditional', condition: { type: 'proof_gte', value: 95 }, then: [{ type: 'chain_gain', value: 1.0 }, { type: 'chain_multiplier_set', value: 3.4 }, { type: 'absol_cascade_proof_amplify', chainPerProofDepth: 0.25 }] },
    ],
  }),
];
