...
export const lightAngels: AngelDefinition[] = [
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '502 base Oblivion �E 7 cards cooldown �E Cost: spend 4 Radiance, discard 1 card',
        baseOblivion: 722,
        cooldownCards: 5,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      primary: {
        ...
        description: '269 base Oblivion �E 4 cards cooldown',
        baseOblivion: 465,
        cooldownCards: 4,
        costs: [],
        tags: ['angel', 'primary', 'light'],
      ...
      exalted: {
        ...
        description: '834 base Oblivion �E 6 cards cooldown �E Cost: spend 29 Radiance, spend 26 Strain',
        baseOblivion: 930,
        cooldownCards: 6,
        costs: [],
        tags: ['angel', 'exalted', 'light'],
  ...
  },
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '1135 base Oblivion �E 7 cards cooldown �E Cost: spend 31 Radiance, sacrifice 1 Seraphim',
        baseOblivion: 2345,
        cooldownCards: 7,
        costs: [],
        tags: ['angel', 'exalted', 'light'],
