...
export const lightAngels: AngelDefinition[] = [
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '502 base Oblivion, 7 cards cooldown, x1.22 chain scaling, Cost: spend 4 Radiance, discard 1 card',
        baseOblivion: 722,
        cooldownCards: 5,
        chainScaling: 1.22,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      primary: {
        ...
        description: '269 base Oblivion, 4 cards cooldown, x1.04 chain scaling',
        baseOblivion: 465,
        cooldownCards: 4,
        chainScaling: 1.06,
        costs: [],
      ...
      exalted: {
        ...
        description: '548 base Oblivion, 6 cards cooldown, x1.25 chain scaling, Cost: spend 5 Radiance, spend 2 Strain',
        baseOblivion: 930,
        cooldownCards: 6,
        chainScaling: 1.28,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '746 base Oblivion, 7 cards cooldown, x1.32 chain scaling, Cost: spend 7 Radiance, sacrifice 1 Seraphim',
        baseOblivion: 2345,
        cooldownCards: 7,
        chainScaling: 1.46,
        costs: [],
