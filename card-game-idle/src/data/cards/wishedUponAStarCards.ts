...
const baseSeraphim: SeraphimDefinition[] = [
  buildSeraphim({
    ...
    unsynergizedDescription: '323 base Oblivion 2 cards cooldown',
    synergizedDescription: '554 base Oblivion 4 cards cooldown Requires Angel',
    unsynergizedBase: 497, synergizedBase: 554,
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '431 base Oblivion 3 cards cooldown',
    synergizedDescription: '755 base Oblivion 5 cards cooldown Requires Angel',
    unsynergizedBase: 664, synergizedBase: 755,
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '462 base Oblivion 3 cards cooldown',
    synergizedDescription: '801 base Oblivion 5 cards cooldown Requires Angel',
    unsynergizedBase: 711, synergizedBase: 801,
    unsynergizedCooldown: 3, synergizedCooldown: 5,
  }),
  buildSeraphim({
    ...
    unsynergizedDescription: '662 base Oblivion 4 cards cooldown',
    synergizedDescription: '1170 base Oblivion 7 cards cooldown Requires Angel Cost: discard 1 card',
    unsynergizedBase: 1019, synergizedBase: 1170,
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '862 base Oblivion 6 cards cooldown',
    synergizedDescription: '1509 base Oblivion 9 cards cooldown Requires Angel Cost: discard 1 card',
    unsynergizedBase: 1327, synergizedBase: 1509,
...
const baseCherubim: CherubimDefinition[] = [
  buildCherubim({
    ...
    description: 'On play: Draw 1 card; Gain 1 Starlight Charge. While on board: Each adjacent active Seraphim adds 1 extra card whenever you play a card',
    rarity: 'Common',
    artKey: 'wuas_cher_wishwright_pulse',
    effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'draw', value: 1 }],
    onPlayEffects: [{ type: 'draw', value: 1 }, { type: 'starlight_gain', amount: 1 }],
  }),
  buildCherubim({
    definitionId: 'wuas-cher-dreamvault-keeper',
    name: 'Dreamvault Keeper',
    description: 'On play: Gain 1 Starlight Charge; Gain 1 Dream Lattice stack. While on board: +10 Oblivion per card played',
    rarity: 'Rare',
    artKey: 'wuas_cher_dreamvault_keeper',
    effects: [{ type: 'cherubim_oblivion_per_card', value: 10 }],
    onPlayEffects: [{ type: 'starlight_gain', amount: 1 }, { type: 'dream_lattice_gain', amount: 1 }],
  }),
  buildCherubim({
    definitionId: 'wuas-cher-solarvex-ward',
    name: 'Solarvex Ward',
    description: 'On play: Gain 2 Dream Lattice stacks; Gain 1 Starlight Charge. While on board: +12 Oblivion per card played',
    rarity: 'Rare',
    artKey: 'wuas_cher_solarvex_ward',
    effects: [{ type: 'cherubim_oblivion_per_card', value: 12 }],
    onPlayEffects: [{ type: 'dream_lattice_gain', amount: 2 }, { type: 'starlight_gain', amount: 1 }],
  }),
  buildCherubim({
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 3 Starlight Charges; Gain 1 Dream Lattice stack. While on board: Seraphim bonuses are amplified by +10%',
    rarity: 'Legendary',
...
const baseOphanim: OphanimDefinition[] = [
  buildOphanim({
    ...
    name: 'Skyrift Mote',
    description: 'Gain 1 Starlight Charge; If this is the first card you played this turn, Gain 1 Dream Lattice stack',
    rarity: 'Common',
    artKey: 'wuas_oph_skyrift_mote',
    effects: [{ type: 'starlight_gain', amount: 1 }, { type: 'conditional', condition: { type: 'first_card_this_turn' }, then: [{ type: 'dream_lattice_gain', amount: 1 }] }],
  }),
  buildOphanim({
    definitionId: 'wuas-oph-dream-shard',
    name: 'Dream Shard',
    description: 'Look at the top 3 cards, take 1 card, and put the rest on the bottom; Gain 1 Dream Lattice stack; Gain 1 Starlight Charge',
    rarity: 'Common',
    artKey: 'wuas_oph_dream_shard',
    effects: [{ type: 'look_top_take', look: 3, take: 1 }, { type: 'dream_lattice_gain', amount: 1 }, { type: 'starlight_gain', amount: 1 }],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    name: 'Wishfire Surge',
    description: 'Gain 1 Dream Lattice stack; +120 Oblivion; If you have played 2+ cards this turn, Gain 2 Starlight Charges',
    rarity: 'Rare',
    artKey: 'wuas_oph_wishfire_surge',
    effects: [
      { type: 'dream_lattice_gain', amount: 1 },
      { type: 'oblivion_flat', value: 120 },
      { type: 'conditional', condition: { type: 'cards_played_gte', value: 2 }, then: [{ type: 'starlight_gain', amount: 2 }] }],
  }),
  buildOphanim({
...
const baseAngels: AngelDefinition[] = [
  buildAngel({
    ...
    description: 'On summon: Gain 4 Starlight Charges; Gain 2 Dream Lattice stacks; Draw 1 card. After 2 cards played: Gain 2 Dream Lattice stacks; Draw 1 card; Cash out up to 3 Star Crowns (+280 Oblivion per Crown). While on board: +66 Oblivion per card played while on board',
    rarity: 'Legendary',
    ...
    activatedAbility: {
      ...
      description: 'Gain 2 Dream Lattice stacks; Draw 1 card; Cash out up to 3 Star Crowns (+280 Oblivion per Crown)',
      effects: [
        { type: 'dream_lattice_gain', amount: 2 },
        { type: 'draw', value: 1 },
    ...
    primaryDescription: '1170 base Oblivion 8 cards cooldown',
    exaltedDescription: '2017 base Oblivion 12 cards cooldown Cost: discard 1 card',
    primaryBase: 1170, exaltedBase: 2017,
  ...
  buildAngel({
    ...
    description: 'On summon: Gain 5 Starlight Charges; Gain 3 Dream Lattice stacks; Draw 1 card. After 3 cards played: Nova Wish Burst (Oblivion = Starlight × (1 + Dream × 0.7)); Gain 3 Starlight Charges; Infinite Starbirth (Ob = Seraphim × Starlight × 45). While on board: +62 Oblivion per card played while on board',
    rarity: 'Legendary',
    ...
    activatedAbility: {
      ...
      description: 'Nova Wish Burst (Oblivion = Starlight × (1 + Dream × 0.7)); Gain 3 Starlight Charges; Infinite Starbirth (Ob = Seraphim × Starlight × 45)',
      effects: [
    ...
    primaryDescription: '1217 base Oblivion 8 cards cooldown',
    exaltedDescription: '2094 base Oblivion 13 cards cooldown Cost: discard 1 card',
    primaryBase: 1217, exaltedBase: 2094,
  ...
  buildAngel({
    ...
    primaryDescription: '1294 base Oblivion 7 cards cooldown Cost: discard 1 card',
    exaltedDescription: '2233 base Oblivion 13 cards cooldown Cost: discard 2 cards',
    primaryBase: 1294, exaltedBase: 2233,
...
const eternalCards: CardDefinition[] = [
  buildSeraphim({
    ...
    unsynergizedDescription: '1078 base Oblivion 7 cards cooldown',
    synergizedDescription: '1879 base Oblivion 11 cards cooldown Requires Angel Cost: discard 1 card',
    unsynergizedBase: 1660, synergizedBase: 1879,
  ...
  buildAngel({
    ...
    primaryDescription: '1386 base Oblivion 8 cards cooldown Cost: discard 1 card',
    exaltedDescription: '2587 base Oblivion 15 cards cooldown Cost: discard 2 cards',
    primaryBase: 1386, exaltedBase: 2587,
...
const infiniteCards: CardDefinition[] = [
  ...
  buildSeraphim({
    ...
    unsynergizedDescription: '1571 base Oblivion 9 cards cooldown Cost: discard 1 card',
    synergizedDescription: '2710 base Oblivion 15 cards cooldown Requires Angel Cost: discard 2 cards',
    unsynergizedBase: 2419, synergizedBase: 2710,
