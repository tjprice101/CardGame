...
const baseSeraphim: SeraphimDefinition[] = [
  ...
  buildSeraphim({
    ...
    description: "Selenira's patient gaze, distilled into a watchful star. On play: +2 Starlight Charges. While in play: +40 Oblivion per card played.",
    rarity: 'Rare',
...
const eternalCards: CardDefinition[] = [
  buildSeraphim({
    ...
    description: 'The Wishwright unbound ? original maker of stars and grief. On play: +6 Starlight Charges; +5 Dream Lattice; +15 Star Crowns banked (no cashout). While in play: +32 Oblivion per card played; Aethervex hoards crowns for other cards to detonate.',
    rarity: 'Eternal',
  ...
  buildAngel({
    ...
    description: 'Draethos preserved against time itself ? gravity made eternal. On summon: +5 Starlight Charges; +3 Dream Lattice; +6 Star Crowns banked. Activated (after 3 cards played): +4 Starlight Charges; +2 Dream Lattice; +6 Star Crowns; then cash out up to 12 Star Crowns (+280 Oblivion per crown Lattice). While on board: +70 Oblivion per card played. The slow burner ? wait for the activation window and his cashout out-scales any other Eternal.',
    rarity: 'Eternal',
    ...
    activatedAbility: {
      ...
      cardsPlayedRequirement: 3,
      description: 'Gain +4 Starlight Charges, +2 Dream Lattice, and +6 Star Crowns; then cash out up to 12 Star Crowns (+280 Oblivion per crown Lattice).',
      effects: [
        { type: 'starlight_gain', amount: 4 },
        { type: 'dream_lattice_gain', amount: 2 },
        { type: 'eternal_stack_gain', stack: 'wuas', value: 6 },
