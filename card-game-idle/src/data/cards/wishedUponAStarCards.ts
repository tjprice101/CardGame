...
synergizedDescription: '335 base Oblivion 5 cards cooldown Requires Angel',
  ...
  buildSeraphim({
    ...
    bonusValue: 44,
    onPlayEffects: [{ type: 'starlight_gain', amount: 2 }, { type: 'dream_lattice_gain', amount: 1 }],
    unsynergizedName: 'Vigil Strike', synergizedName: 'Selenira Watch',
unsynergizedDescription: '272 base Oblivion 4 cards cooldown',
synergizedDescription: '470 base Oblivion 5 cards cooldown Requires Angel',
  unsynergizedBase: 272, synergizedBase: 470,
    unsynergizedCooldown: 4, synergizedCooldown: 5,
  }),
  buildSeraphim({
    ...
    bonusType: 'oblivion_per_card',
    bonusValue: 96,
    onPlayEffects: [{ type: 'starlight_gain', amount: 2 }, { type: 'look_top_take', look: 3, take: 1 }],
    unsynergizedName: 'Lune Echo', synergizedName: 'Choir Refrain',
unsynergizedDescription: '286 base Oblivion 4 cards cooldown',
synergizedDescription: '502 base Oblivion 5 cards cooldown Requires Angel',
  unsynergizedBase: 286, synergizedBase: 502,
    unsynergizedCooldown: 4, synergizedCooldown: 5,
  }),
  buildSeraphim({
...
unsynergizedDescription: '408 base Oblivion 5 cards cooldown',
synergizedDescription: '718 base Oblivion 6 cards cooldown Requires Angel',
  unsynergizedBase: 408, synergizedBase: 718,
...
const baseCherubim: CherubimDefinition[] = [
  buildCherubim({
    ...
    description: 'On play: Gain 2 Starlight Charges. While on board: Draw 0.2 cards per card played',
    rarity: 'Common',
    artKey: 'wuas_cher_wishwright_pulse',
    effects: [{ type: 'cherubim_draw_per_card', value: 0.2 }],
    onPlayEffects: [{ type: 'starlight_gain', amount: 2 }],
  }),
  buildCherubim({
  ...
  buildCherubim({
    ...
    name: 'Solarvex Ward',
    description: 'On play: Gain 2 Starlight Charges; Gain 2 Dream Lattice stacks',
    rarity: 'Rare',
    artKey: 'wuas_cher_solarvex_ward',
    effects: [],
    onPlayEffects: [{ type: 'starlight_gain', amount: 2 }, { type: 'dream_lattice_gain', amount: 2 }],
  }),
  buildCherubim({
  ...
  buildCherubim({
    ...
    effects: [{
      type: 'cherubim_attack_buff',
      targetUnitType: 'Any',
      condition: { type: 'cards_played_gte', value: 5 },
...
const baseOphanim: OphanimDefinition[] = [
  ...
  buildOphanim({
    ...
    name: 'Dream Shard',
    description: 'Gain 1 Starlight Charge; Look at the top 2 cards, take 1 card, and put the rest on the bottom',
    rarity: 'Common',
    artKey: 'wuas_oph_dream_shard',
    effects: [{ type: 'starlight_gain', amount: 1 }, { type: 'look_top_take', look: 2, take: 1 }],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    effects: [
      { type: 'starlight_gain', amount: 1 },
      { type: 'dream_lattice_gain', amount: 1 },
      { type: 'oblivion_flat', value: 85 }],
  }),
  buildOphanim({
...
exaltedDescription: '1338 base Oblivion 8 cards cooldown',
  ...
  buildAngel({
    ...
    activatedAbility: {
      ...
      cardsPlayedRequirement: 3,
      description: 'Gain 6 Starlight Charges; Gain 4 Dream Lattice stacks',
      effects: [
        { type: 'starlight_gain', amount: 6 },
        { type: 'dream_lattice_gain', amount: 4 }],
    },
...
const eternalCards: CardDefinition[] = [
  buildSeraphim({
    ...
    description: 'On play: Gain 6 Starlight Charges; Gain 5 Dream Lattice stacks; Gain 15 Star Crowns. If Dream Lattice is 6+, gain 5 Star Crowns. While on board: +32 Oblivion per card played while active',
    rarity: 'Eternal',
    ...
    onPlayEffects: [
      ...
      { type: 'eternal_stack_gain', stack: 'wuas', value: 15 },
      {
        ...
        then: [{ type: 'eternal_stack_gain', stack: 'wuas', value: 5 }],
      }],
...
description: 'Gain 8 Starlight Charges; Gain 4 Dream Lattice stacks; Nova Wish Burst (Oblivion = Starlight (1 + Dream 1.2)); Cash out up to 18 Star Crowns (+220 Oblivion per Crown)',
    rarity: 'Eternal',
  ...
  buildAngel({
    ...
    activatedAbility: {
      ...
      cardsPlayedRequirement: 3,
      description: 'Gain 4 Starlight Charges; Gain 2 Dream Lattice stacks; Gain 6 Star Crowns; Nova Wish Burst (Oblivion = Starlight (1 + Dream 0.7)); Cash out up to 10 Star Crowns (+260 Oblivion per Crown)',
      effects: [
        { type: 'starlight_gain', amount: 4 },
        { type: 'dream_lattice_gain', amount: 2 },
        { type: 'eternal_stack_gain', stack: 'wuas', value: 6 },
...
description: 'Gain 8 Starlight Charges; Gain 6 Dream Lattice stacks; Gain 12 Star Crowns; Infinite Starbirth (Ob = Seraphim × Starlight × 140; draw 0.5 per Dream Lattice); If you have 8+ Dream Lattice, Gain 6 Star Crowns',
    rarity: 'Infinite',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 6 Starlight Charges; Gain 6 Dream Lattice stacks; Gain 6 Star Crowns. While on board: Draw 0.25 cards per card played; Buffs Seraphim and Angel attacks: base +140, when you have 8+ Star Crowns',
    rarity: 'Infinite',
