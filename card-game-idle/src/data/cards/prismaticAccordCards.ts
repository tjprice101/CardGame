...
export const prismaticAccordSeraphims: SeraphimDefinition[] = [
  ...
  },
  {
    ...
    description: 'On play: Set chain floor to x1.4. While on board: +12 Oblivion per card played while active',
  ...
  },
  {
    ...
    description: 'On play: Salvage any 1 card; Set chain floor to x1.6. While on board: +20 Oblivion per card played while active',
...
export const prismaticAccordOphanims: OphanimDefinition[] = [
  ...
  },
  {
    ...
    description: 'Look at the top 4 cards, take 1 card, and put the rest on the bottom; Set chain floor to x1.45',
  ...
  },
  {
    ...
    description: 'Look at the top 4 cards and take 1 matching Ophanim; Set chain floor to x1.4',
  ...
  },
  {
    ...
    description: 'Set chain floor to x1.6; If you control 1+ active Seraphim, Draw 1 card; Shuffle discard into deck; Draw 1 card',
...
export const prismaticAccordCherubim: CherubimDefinition[] = [
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Fracture Veil',
      description: 'On play: Set chain floor to x1.5; Shuffle discard into deck. While on board: Adjacent active Seraphim gain +10 Oblivion per card played; Buffs Seraphim attacks: base +9, chain scaling +0.04, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    name: 'Canopy Eclipse Knot',
      description: 'On play: Empower the next card you play; Set chain floor to x1.7. While on board: Adjacent active Seraphim gain +14 Oblivion per card played; Buffs Seraphim attacks: base +13, chain scaling +0.05, cooldown +0, multiplier x1.00',
...
export const prismaticAccordCherubimCards: CherubimDefinition[] = [
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Spectrum Veil',
    description: 'On play: Set chain floor to x1.6; Draw 2 cards. While on board: Adjacent active Seraphim gain +12 Oblivion per card played; Buffs Seraphim attacks: base +13, chain scaling +0.04, cooldown -1, multiplier x1.00',
