...
const eternalCards: CardDefinition[] = [
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 3 Forge Crowns; Drop 8 Pearls; Nacre-Recast last 3 cards at 100% power; Draw 2 cards. While on board: +33 Oblivion per card played while active',
    rarity: 'Eternal',
...
const infinityCards: CardDefinition[] = [
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 6 Forge Crowns; Ignite the Unrecorded Hue; Ouroboric Recast at 100% power; Cash out all Forge Crowns (+220 Oblivion per crown); Draw 3 cards. While on board: +50 Oblivion per card played while active',
    rarity: 'Infinite',
    artKey: 'af_inf_reforging_world',
    bonusType: 'oblivion_per_card',
    bonusValue: 50,
    onPlayEffects: [{ type: 'eternal_stack_gain', stack: 'forge', value: 6 }, { type: 'forge_unrecorded_ignite' }, { type: 'forge_ouroboric_recast', power: 1.0 }, { type: 'forge_crown_cashout', oblivionPerCrown: 220 }, { type: 'draw', value: 3 }],
