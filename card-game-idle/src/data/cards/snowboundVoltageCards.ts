...
const SNOWBOUND_SERAPHIM_SPECS: SnowboundSeraphimSpec[] = [
  ...
  },
  {
    ...
    description: 'Voltage. On play: Gain 1 Strain; Empower the next card you play; Discharge Arctic Charge. While on board: +24 Oblivion whenever you play an Ophanim while active',
    rarity: 'Epic',
    phase: 'Voltage',
    artKey: 'sv_ser_whiteout_engine',
    bonusType: 'ophanim_bonus',
    bonusValue: 24,
    onPlayEffects: [{ type: 'strain_gain', value: 1 }, { type: 'multiply_next' }, { type: 'arctic_charge_discharge' }],
...
const SNOWBOUND_CHERUBIM_SPECS: SnowboundCherubimSpec[] = [
  ...
  },
  {
    ...
    description: 'Voltage. On play: +80 Oblivion; Gain 1 Radiance; Discharge Arctic Charge. While on board: Buffs Angel attacks: base +36, cooldown +0, multiplier x1.00',
    rarity: 'Rare',
    phase: 'Voltage',
...
const SNOWBOUND_OPHANIM_SPECS: SnowboundOphanimSpec[] = [
  ...
  },
  {
    ...
    description: 'Voltage. Gain 3 Strain; Empower the next card you play; Gain 3 Arctic Charge; Discharge Arctic Charge',
    rarity: 'Epic',
    phase: 'Voltage',
    artKey: 'sv_oph_first_static',
    effects: [{ type: 'strain_gain', value: 3 }, { type: 'multiply_next' }, { type: 'arctic_charge_gain', value: 3 }, { type: 'arctic_charge_discharge' }],
  },
  {
...
const SNOWBOUND_ANGEL_SPECS: SnowboundAngelSpec[] = [
  ...
  },
  {
    ...
    description: 'Voltage. On summon: +180 Oblivion; Gain 14 Arctic Charge. After 5 cards played: Gain 8 Arctic Charge; Empower the next card you play; +220 Oblivion; Discharge Arctic Charge. While on board: +24 Oblivion per card played while on board',
    rarity: 'Legendary',
    phase: 'Voltage',
