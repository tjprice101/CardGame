...
const SNOWBOUND_SERAPHIM_SPECS: SnowboundSeraphimSpec[] = [
  {
    ...
    description: 'On play: Gain 1 Strain; Gain 4 Arctic Charge. While on board: +10 Oblivion per card played while active',
    rarity: 'Common',
  ...
  },
  {
    ...
    description: 'On play: Gain 4 Arctic Charge. While on board: +18 Oblivion per card played while active',
    rarity: 'Rare',
    artKey: 'sv_ser_icegrid',
    bonusType: 'oblivion_per_card',
    bonusValue: 18,
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 4 }],
  ...
  },
  {
    ...
    description: 'On play: Gain 9 Arctic Charge. While on board: +22 Oblivion per card played while active',
    rarity: 'Legendary',
...
const SNOWBOUND_CHERUBIM_SPECS: SnowboundCherubimSpec[] = [
  {
    ...
    description: 'On play: Gain 4 Strain; Gain 7 Arctic Charge. While on board: Gain 2 Strain per card played; Buffs Angel attacks: base +26, cooldown +0, multiplier x1.00',
    rarity: 'Common',
    artKey: 'sv_cher_polar_sanctum',
    maxDurability: 2,
    effects: [{ type: 'cherubim_resource_per_card', resource: 'strain', value: 2 }],
    onPlayEffects: [{ type: 'strain_gain', value: 4 }, { type: 'arctic_charge_gain', value: 7 }],
  },
  {
  ...
  },
  {
    ...
    description: 'On play: Gain 5 Strain; Gain 8 Arctic Charge. While on board: Gain 3 Strain per card played; Buffs Seraphim attacks: base +42, cooldown -1, multiplier x1.00',
    rarity: 'Rare',
    artKey: 'sv_cher_cryoscale_engine',
    maxDurability: 3,
    effects: [{ type: 'cherubim_resource_per_card', resource: 'strain', value: 3 }],
    onPlayEffects: [{ type: 'strain_gain', value: 5 }, { type: 'arctic_charge_gain', value: 8 }],
  },
  {
  ...
  },
  {
    ...
    description: 'On play: Gain 4 Strain; Gain 9 Arctic Charge. While on board: Buffs Angel attacks: base +16, cooldown -1, multiplier x1.00',
    rarity: 'Epic',
    ...
    onPlayEffects: [{ type: 'strain_gain', value: 4 }, { type: 'arctic_charge_gain', value: 9 }],
  },
  {
  ...
  },
  {
    ...
    description: 'On play: Gain 10 Strain; Gain 10 Arctic Charge. While on board: If you control 2+ active Cherubim, this Cherubim grants +1.2 bonus power; Buffs Seraphim and Angel attacks: base +59, cooldown +0, multiplier x1.20; Buffs Angel attacks: base +46, cooldown -1, multiplier x1.15',
    rarity: 'Legendary',
    artKey: 'sv_cher_aurora_gate',
    maxDurability: 8,
    effects: [{ type: 'cherubim_global_oblivion_mult', value: 0.30 }],
    onPlayEffects: [{ type: 'strain_gain', value: 10 }, { type: 'arctic_charge_gain', value: 10 }],
  },
  {
  ...
  },
  {
    ...
    description: 'On play: Gain 8 Arctic Charge. While on board: +18 Oblivion per card played; Buffs Angel attacks: base +18, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +14, cooldown -1, multiplier x1.00',
    rarity: 'Legendary',
...
const SNOWBOUND_OPHANIM_SPECS: SnowboundOphanimSpec[] = [
  {
    ...
    effects: [{ type: 'strain_gain', value: 2 }, { type: 'arctic_charge_gain', value: 5 }],
  },
  {
    ...
    effects: [{ type: 'strain_gain', value: 3 }, { type: 'arctic_charge_gain', value: 6 }],
  },
  {
    ...
    effects: [{ type: 'radiance_gain', value: 2 }, { type: 'arctic_charge_gain', value: 5 }],
  },
  {
    ...
    effects: [{ type: 'shuffle_discard' }, { type: 'arctic_charge_gain', value: 6 }],
  },
  {
  ...
  },
  {
    ...
    effects: [{ type: 'radiance_gain', value: 3 }, { type: 'arctic_charge_gain', value: 7 }],
  },
  {
    ...
    effects: [{ type: 'strain_gain', value: 5 }, { type: 'arctic_charge_gain', value: 12 }],
  },
  {
    ...
    effects: [{ type: 'radiance_gain', value: 5 }, { type: 'arctic_charge_gain', value: 10 }],
  }];
...
const SNOWBOUND_ANGEL_SPECS: SnowboundAngelSpec[] = [
  {
    ...
    description: 'On summon: Gain 5 Strain; Gain 10 Arctic Charge. After 3 cards played: Gain 4 Arctic Charge; +80 Oblivion; Discharge Arctic Charge. While on board: +16 Oblivion per card played while on board',
    rarity: 'Common',
  ...
  },
  {
    ...
    description: 'On summon: +120 Oblivion; Gain 11 Arctic Charge. After 4 cards played: Gain 4 Arctic Charge; +100 Oblivion; Discharge Arctic Charge. While on board: +0.06 Oblivion per card played while on board',
    rarity: 'Rare',
  ...
  },
  {
    ...
    description: 'On summon: Gain 14 Arctic Charge. After 4 cards played: Gain 1 Radiance; Gain 9 Arctic Charge. While on board: +18 Oblivion per card played while on board',
    rarity: 'Rare',
    ...
    activatedAbility: {
      name: 'Frozen Current',
      cardsPlayedRequirement: 4,
      description: 'Gain 1 Radiance; Gain 9 Arctic Charge',
      effects: [{ type: 'radiance_gain', value: 1 }, { type: 'arctic_charge_gain', value: 9 }],
    },
  ...
  },
  {
    ...
    description: 'On summon: +180 Oblivion; Gain 14 Arctic Charge. After 5 cards played: Gain 8 Arctic Charge; Empower the next card you play; +220 Oblivion; Discharge Arctic Charge. While on board: +24 Oblivion per card played while on board',
    rarity: 'Legendary',
    ...
    activatedAbility: {
      ...
      description: 'Gain 8 Arctic Charge; Empower the next card you play; +220 Oblivion; Discharge Arctic Charge',
      effects: [{ type: 'arctic_charge_gain', value: 8 }, { type: 'multiply_next' }, { type: 'oblivion_flat', value: 220 }, { type: 'arctic_charge_discharge' }],
    },
  ...
  },
  {
    ...
    name: 'Neon Blizzard',
    description: 'On summon: +200 Oblivion; Gain 15 Arctic Charge. After 5 cards played: Gain 2 Strain; Gain 6 Arctic Charge; Discharge Arctic Charge. While on board: +28 Oblivion whenever you play an Ophanim while on board',
    rarity: 'Legendary',
  ...
  },
  {
    ...
    description: 'On summon: Gain 19 Arctic Charge. After 6 cards played: Gain 8 Arctic Charge; +240 Oblivion; Empower the next card you play; Discharge Arctic Charge. While on board: +0.08 Oblivion per card played while on board',
    rarity: 'Legendary',
    ...
    activatedAbility: {
      ...
      description: 'Gain 8 Arctic Charge; +240 Oblivion; Empower the next card you play; Discharge Arctic Charge',
      effects: [{ type: 'arctic_charge_gain', value: 8 }, { type: 'oblivion_flat', value: 240 }, { type: 'multiply_next' }, { type: 'arctic_charge_discharge' }],
    },
