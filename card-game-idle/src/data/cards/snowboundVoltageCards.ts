...
const SNOWBOUND_SERAPHIM_SPECS: SnowboundSeraphimSpec[] = [
  ...
  },
  {
    ...
    description: 'Voltage. On play: Gain 4 Arctic Charge; Discharge Arctic Charge. While on board: +14 Oblivion whenever you play an Ophanim while active',
    rarity: 'Common',
    phase: 'Voltage',
  ...
  },
  {
    ...
    description: 'Voltage. On play: Gain 2 Arctic Charge; Discharge Arctic Charge. While on board: +24 Oblivion whenever you play an Ophanim while active',
    rarity: 'Epic',
    phase: 'Voltage',
    artKey: 'sv_ser_whiteout_engine',
    bonusType: 'ophanim_bonus',
    bonusValue: 24,
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 2 }, { type: 'arctic_charge_discharge' }],
  ...
  },
  {
    ...
    description: 'Voltage. On play: Gain 4 Arctic Charge; +80 Oblivion; Discharge Arctic Charge. While on board: +20 Oblivion per card played while active',
    rarity: 'Legendary',
    phase: 'Voltage',
    artKey: 'sv_ser_polar_circuit',
    bonusType: 'oblivion_per_card',
    bonusValue: 20,
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 4 }, { type: 'oblivion_flat', value: 80 }, { type: 'arctic_charge_discharge' }],
...
const SNOWBOUND_CHERUBIM_SPECS: SnowboundCherubimSpec[] = [
  {
    ...
    maxDurability: 2,
    effects: [{ type: 'cherubim_resource_per_card', resource: 'arcticCharge', value: 2 }],
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 16 }],
  },
  {
    definitionId: 'sv-cher-first-whiteout',
    name: 'The First Whiteout',
    description: 'Voltage. On play: +60 Oblivion; Gain 4 Arctic Charge; Discharge Arctic Charge. While on board: +12 Oblivion per card played',
    rarity: 'Common',
    phase: 'Voltage',
    artKey: 'sv_cher_first_whiteout',
    maxDurability: 3,
    effects: [{ type: 'cherubim_oblivion_per_card', value: 12 }],
    onPlayEffects: [{ type: 'oblivion_flat', value: 60 }, { type: 'arctic_charge_gain', value: 4 }, { type: 'arctic_charge_discharge' }],
  },
  {
    ...
    maxDurability: 3,
    effects: [{ type: 'cherubim_resource_per_card', resource: 'arcticCharge', value: 3 }],
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 19 }],
  },
  {
    definitionId: 'sv-cher-overcurrent-accord',
    name: 'The Overcurrent Accord',
    description: 'Voltage. On play: +80 Oblivion; Gain 2 Arctic Charge; Discharge Arctic Charge. While on board: Buffs Angel attacks: base +36',
    rarity: 'Rare',
    phase: 'Voltage',
    ...
    onPlayEffects: [{ type: 'oblivion_flat', value: 80 }, { type: 'arctic_charge_gain', value: 2 }, { type: 'arctic_charge_discharge' }],
  },
  {
    definitionId: 'sv-cher-station-nullpoint',
    name: 'Station Nullpoint',
    description: 'Frost. On play: Gain 18 Arctic Charge. While on board: Buffs Angel attacks: base +16, cooldown -1',
    rarity: 'Epic',
    phase: 'Frost',
    ...
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 18 }],
  },
  {
    definitionId: 'sv-cher-aeldris',
    name: 'Aeldris, the Frosted Saint',
    description: 'Voltage. On play: Gain 8 Arctic Charge; +100 Oblivion; Discharge Arctic Charge. While on board: +14 Oblivion per card played',
    rarity: 'Epic',
    phase: 'Voltage',
    artKey: 'sv_cher_aeldris',
    maxDurability: 4,
    effects: [{ type: 'cherubim_oblivion_per_card', value: 14 }],
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 8 }, { type: 'oblivion_flat', value: 100 }, { type: 'arctic_charge_discharge' }],
  },
  {
  ...
  },
  {
    ...
    name: 'Conductor Vael',
    description: 'Voltage. On play: Gain 12 Arctic Charge; +120 Oblivion; Discharge Arctic Charge. While on board: Ophanim plays gain +24 Oblivion',
    rarity: 'Legendary',
    phase: 'Voltage',
    artKey: 'sv_cher_conductor_vael',
    maxDurability: 4,
    effects: [{ type: 'cherubim_ophanim_bonus', value: 24 }],
    onPlayEffects: [{ type: 'arctic_charge_gain', value: 12 }, { type: 'oblivion_flat', value: 120 }, { type: 'arctic_charge_discharge' }],
  },
  {
...
const SNOWBOUND_OPHANIM_SPECS: SnowboundOphanimSpec[] = [
  ...
  },
  {
    ...
    description: 'Voltage. Gain 7 Arctic Charge; +60 Oblivion; Discharge Arctic Charge',
    rarity: 'Common',
    phase: 'Voltage',
    artKey: 'sv_oph_glacier_abyss',
    effects: [{ type: 'arctic_charge_gain', value: 7 }, { type: 'oblivion_flat', value: 60 }, { type: 'arctic_charge_discharge' }],
  },
  {
    definitionId: 'sv-oph-static-archive',
    name: 'The Static Archive',
    description: 'Frost. Look at the top 3 cards, take 1 card, and put the rest on the bottom; Gain 10 Arctic Charge',
    rarity: 'Rare',
    phase: 'Frost',
    artKey: 'sv_oph_static_archive',
    effects: [{ type: 'look_top_take', look: 3, take: 1 }, { type: 'arctic_charge_gain', value: 10 }],
  },
  {
  ...
  },
  {
    ...
    description: 'Voltage. Draw 1 card; Gain 8 Arctic Charge; +80 Oblivion; Discharge Arctic Charge',
    rarity: 'Epic',
    phase: 'Voltage',
    artKey: 'sv_oph_aurora_convergence',
    effects: [{ type: 'draw', value: 1 }, { type: 'arctic_charge_gain', value: 8 }, { type: 'oblivion_flat', value: 80 }, { type: 'arctic_charge_discharge' }],
  },
  {
    definitionId: 'sv-oph-frostwalker-neis',
    name: 'Frostwalker Neis',
    description: 'Frost. Draw 3 cards; Gain 14 Arctic Charge',
    rarity: 'Legendary',
    phase: 'Frost',
    artKey: 'sv_oph_frostwalker_neis',
    effects: [{ type: 'draw', value: 3 }, { type: 'arctic_charge_gain', value: 14 }],
  },
  {
    definitionId: 'sv-oph-drifting-relay',
    name: 'The Drifting Relay',
    description: 'Voltage. Gain 12 Arctic Charge; Draw 1 card; Discharge Arctic Charge',
    rarity: 'Legendary',
    phase: 'Voltage',
    artKey: 'sv_oph_drifting_relay',
    effects: [{ type: 'arctic_charge_gain', value: 12 }, { type: 'draw', value: 1 }, { type: 'arctic_charge_discharge' }],
  }];
...
const SNOWBOUND_ANGEL_SPECS: SnowboundAngelSpec[] = [
  {
    ...
    description: 'Voltage. On summon: Gain 20 Arctic Charge. After 3 cards played: Gain 4 Arctic Charge; +80 Oblivion; Discharge Arctic Charge. While on board: +16 Oblivion per card played while on board',
    rarity: 'Common',
    phase: 'Voltage',
    artKey: 'sv_angel_overcurrent_chorus',
    summonCost: ['sv-ser-frostcoil', 'sv-ser-static-sleet'],
    onSummonEffects: [{ type: 'arctic_charge_gain', value: 20 }],
    activatedAbility: {
      name: 'Chorus Breaker',
  ...
  },
  {
    ...
    description: 'Frost. On summon: Gain 14 Arctic Charge. After 4 cards played: Gain 12 Arctic Charge. While on board: +18 Oblivion per card played while on board',
    rarity: 'Rare',
    phase: 'Frost',
    ...
    activatedAbility: {
      name: 'Frozen Current',
      cardsPlayedRequirement: 4,
      description: 'Gain 12 Arctic Charge',
      effects: [{ type: 'arctic_charge_gain', value: 12 }],
    },
  ...
  },
  {
    ...
    name: 'Neon Blizzard',
    description: 'Voltage. On summon: +200 Oblivion; Gain 15 Arctic Charge. After 5 cards played: Gain 10 Arctic Charge; Discharge Arctic Charge. While on board: +28 Oblivion whenever you play an Ophanim while on board',
    rarity: 'Legendary',
    phase: 'Voltage',
    ...
    activatedAbility: {
      name: 'Aurora Spike',
      cardsPlayedRequirement: 5,
      description: 'Gain 10 Arctic Charge; Discharge Arctic Charge',
      effects: [{ type: 'arctic_charge_gain', value: 10 }, { type: 'arctic_charge_discharge' }],
    },
  ...
  },
  {
    ...
    description: 'Voltage. On summon: Gain 25 Arctic Charge. After 6 cards played: Gain 8 Arctic Charge; +240 Oblivion; Discharge Arctic Charge. While on board: +8 Oblivion per card played while on board',
    rarity: 'Legendary',
    phase: 'Voltage',
    artKey: 'sv_angel_polarity_throne',
    summonCost: ['sv-angel-voltage-patriarch', 'sv-ser-icegrid', 'sv-ser-snow-lattice'],
    extraSummonConditions: [{ type: 'cherubim_active_gte', value: 2 }],
    onSummonEffects: [{ type: 'arctic_charge_gain', value: 25 }],
    activatedAbility: {
