...
const SNOWBOUND_SERAPHIM_SPECS: SnowboundSeraphimSpec[] = [
  {
    ...
    unsynergizedDescription: '283 base Oblivion · 4 cards cooldown · chain +1.24 · Cost: spend 25 Strain',
    synergizedDescription: '448 base Oblivion · 5 cards cooldown · chain +1.46 · Requires Angel',
  ...
  },
  {
    ...
    unsynergizedDescription: '202 base Oblivion · 4 cards cooldown · chain +1.18 · Cost: discard 1 card, spend 1 Strain',
    synergizedDescription: '399 base Oblivion · 5 cards cooldown · chain +1.55 · Requires Angel',
  ...
  },
  {
    ...
    description: 'On play: Gain 1 Radiance; Amplify Chain by +x1.25; Gain 2 Arctic Charge. While on board: Chain grows +0.05 per card played while active',
    rarity: 'Rare',
    artKey: 'sv_ser_glacier_relay',
    bonusType: 'chain_bonus',
    bonusValue: 0.05,
    onPlayEffects: [{ type: 'radiance_gain', value: 1 }, { type: 'chain_gain', value: 1.25 }, { type: 'arctic_charge_gain', value: 2 }],
    unsynergizedName: 'Glacier Relay Vector Break',
    synergizedName: 'Glacier Relay Angelic Verdict',
    unsynergizedDescription: '311 base Oblivion · 2 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '616 base Oblivion · 5 cards cooldown · chain +1.55 · Requires Angel',
  ...
  },
  {
    ...
    unsynergizedDescription: '501 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: spend 25 Strain',
    synergizedDescription: '795 base Oblivion · 5 cards cooldown · chain +1.52 · Requires Angel',
  ...
  },
  {
    ...
    unsynergizedDescription: '737 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: spend 26 Strain',
    synergizedDescription: '1169 base Oblivion · 6 cards cooldown · chain +1.55 · Requires Angel',
  ...
  },
  {
    ...
    unsynergizedDescription: '495 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: spend 1 Strain, discard 1 card',
    synergizedDescription: '980 base Oblivion · 6 cards cooldown · chain +1.55 · Requires Angel',
  ...
  },
  {
    ...
    description: 'On play: Draw 2 cards; Gain 5 Arctic Charge. While on board: Chain grows +0.06 per card played while active',
    rarity: 'Legendary',
    ...
    unsynergizedDescription: '719 base Oblivion · 2 cards cooldown · chain +1.25 · Cost: discard 1 card',
    synergizedDescription: '1421 base Oblivion · 6 cards cooldown · chain +1.55 · Requires Angel',
  ...
  },
  {
    ...
    unsynergizedDescription: '743 base Oblivion · 4 cards cooldown · chain +1.25 · Cost: spend 2 Strain, discard 1 card',
    synergizedDescription: '1470 base Oblivion · 6 cards cooldown · chain +1.55 · Requires Angel',
...
const SNOWBOUND_CHERUBIM_SPECS: SnowboundCherubimSpec[] = [
  {
    ...
    description: 'On play: Gain 4 Strain; Draw 1 card; Gain 5 Arctic Charge. While on board: Gain 2 Strain per card played; Buffs Angel attacks: base +26, chain bonus +0.06, cooldown +0, multiplier x1.00',
    rarity: 'Common',
  ...
  },
  {
    ...
    description: 'On play: +40 Oblivion; Gain 2 Strain; Gain 3 Arctic Charge. While on board: +12 Oblivion per card played; Buffs Seraphim and Angel attacks: base +13, chain bonus +0.05, cooldown +0, multiplier x1.00',
    rarity: 'Common',
  ...
  },
  {
    ...
    description: 'On play: Gain 5 Strain; Draw 1 card; Gain 6 Arctic Charge. While on board: Gain 3 Strain per card played; Buffs Seraphim attacks: base +42, chain bonus +0.05, cooldown -1, multiplier x1.00',
    rarity: 'Rare',
  ...
  },
  {
    ...
    description: 'On play: +60 Oblivion; Gain 1 Radiance; Gain 3 Arctic Charge. While on board: Chain grows +0.08 per card played; Buffs Angel attacks: base +36, chain bonus +0.02, cooldown +0, multiplier x1.00',
    rarity: 'Rare',
  ...
  },
  {
    ...
    description: 'On play: Draw 2 cards; Gain 4 Strain; Gain 5 Arctic Charge. While on board: Buffs Angel attacks: base +16, chain bonus +0.01, cooldown -1, multiplier x1.00',
    rarity: 'Epic',
  ...
  },
  {
    ...
    description: 'On play: Gain 6 Strain; +80 Oblivion; Gain 7 Arctic Charge. While on board: +14 Oblivion per card played; Buffs Seraphim and Angel attacks: base +15, chain bonus +0.07, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +12, chain bonus +0.05, cooldown +0, multiplier x1.00',
    rarity: 'Epic',
  ...
  },
  {
    ...
    description: 'On play: Gain 10 Strain; Draw 1 card; Gain 8 Arctic Charge. While on board: If you control 2+ active Cherubim, this Cherubim grants +1.2 bonus power; Buffs Seraphim and Angel attacks: base +59, chain bonus +0.08, cooldown +0, multiplier x1.20; Buffs Angel attacks: base +46, chain bonus +0.06, cooldown -1, multiplier x1.15',
    rarity: 'Legendary',
  ...
  },
  {
    ...
    name: 'Conductor Vael',
    description: 'On play: Gain 8 Strain; +100 Oblivion; Gain 8 Arctic Charge. While on board: Ophanim plays gain +24 Oblivion; Buffs Seraphim and Angel attacks: base +25, chain bonus +0.08, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +20, chain bonus +0.06, cooldown -1, multiplier x1.00',
    rarity: 'Legendary',
  ...
  },
  {
    ...
    description: 'On play: Draw 2 cards; Amplify Chain by +x1.4; Gain 4 Arctic Charge. While on board: +18 Oblivion per card played; Buffs Angel attacks: base +18, chain bonus +0.10, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +14, chain bonus +0.07, cooldown -1, multiplier x1.00',
    rarity: 'Legendary',
    artKey: 'sv_cher_last_transmission',
    maxDurability: 4,
    effects: [{ type: 'cherubim_oblivion_per_card', value: 18 }],
    onPlayEffects: [{ type: 'draw', value: 2 }, { type: 'chain_gain', value: 1.4 }, { type: 'arctic_charge_gain', value: 4 }],
  },
];
...
const SNOWBOUND_OPHANIM_SPECS: SnowboundOphanimSpec[] = [
  ...
  },
  {
    ...
    description: 'Gain 3 Strain; Amplify Chain by +x1.3; Gain 4 Arctic Charge; Gain 3 Prismatic Light; Draw 1 card',
    rarity: 'Common',
    artKey: 'sv_oph_glacier_abyss',
    effects: [{ type: 'strain_gain', value: 3 }, { type: 'chain_gain', value: 1.3 }, { type: 'arctic_charge_gain', value: 4 }],
  },
  {
  ...
  },
  {
    ...
    description: 'Gain 4 Strain; Empower the next card you play; Gain 5 Arctic Charge; Amplify Chain by +x1.4',
    rarity: 'Epic',
  ...
  },
  {
    ...
    description: 'Gain 3 Radiance; Set chain multiplier to x1.6; Gain 5 Arctic Charge; Gain 5 Prismatic Light; Draw 1 card',
    rarity: 'Epic',
  ...
  },
  {
    ...
    description: 'Gain 5 Radiance; Draw 2 cards; Amplify Chain by +x1.7; Gain 6 Arctic Charge',
    rarity: 'Legendary',
    artKey: 'sv_oph_drifting_relay',
    effects: [{ type: 'radiance_gain', value: 5 }, { type: 'draw', value: 2 }, { type: 'chain_gain', value: 1.7 }, { type: 'arctic_charge_gain', value: 6 }],
  },
];
...
const SNOWBOUND_ANGEL_SPECS: SnowboundAngelSpec[] = [
  {
    ...
    description: 'On summon: Gain 5 Strain; Draw 2 cards; Amplify Chain by +x1.5; Gain 6 Arctic Charge. After 3 cards played: Draw 2 cards; +80 Oblivion; Discharge Arctic Charge. While on board: +16 Oblivion per card played while on board',
    rarity: 'Common',
    artKey: 'sv_angel_overcurrent_chorus',
    summonCost: ['sv-ser-frostcoil', 'sv-ser-static-sleet'],
    onSummonEffects: [{ type: 'strain_gain', value: 5 }, { type: 'draw', value: 2 }, { type: 'chain_gain', value: 1.5 }, { type: 'arctic_charge_gain', value: 6 }],
    activatedAbility: {
      name: 'Chorus Breaker',
    ...
    primaryDescription: '392 base Oblivion · 3 cards cooldown · chain +1.00',
    primaryBase: 392,
    primaryCooldown: 3,
    primaryScaling: 1.0,
    exaltedName: 'Overcurrent Chorus Throne Decree',
    exaltedDescription: '1163 base Oblivion · 5 cards cooldown · chain +1.22 · Cost: spend 27 Strain',
    exaltedBase: 748,
    exaltedCooldown: 5,
    exaltedScaling: 1.22,
  ...
  },
  {
    ...
    description: 'On summon: Draw 3 cards; +120 Oblivion; Gain 5 Arctic Charge. After 4 cards played: Set chain multiplier to x2.0; Draw 2 cards; +100 Oblivion; Discharge Arctic Charge. While on board: Chain grows +0.06 per card played while on board',
    rarity: 'Rare',
    ...
    primaryDescription: '470 base Oblivion · 4 cards cooldown · chain +1.06',
    primaryBase: 470,
    primaryCooldown: 4,
    primaryScaling: 1.06,
    exaltedName: 'Whiteout Judicator Throne Decree',
    exaltedDescription: '1402 base Oblivion · 6 cards cooldown · chain +1.28 · Cost: spend 28 Strain',
    exaltedBase: 922,
    exaltedCooldown: 6,
    exaltedScaling: 1.28,
  ...
  },
  {
    ...
    description: 'On summon: Draw 4 cards; Set chain multiplier to x1.8; Gain 6 Arctic Charge. After 4 cards played: Draw 3 cards; Gain 1 Radiance; Amplify Chain by +x2.1; Gain 3 Arctic Charge. While on board: +18 Oblivion per card played while on board',
    rarity: 'Rare',
    ...
    activatedAbility: {
      name: 'Frozen Current',
      cardsPlayedRequirement: 4,
      description: 'Draw 3 cards; Gain 1 Radiance; Amplify Chain by +x2.1; Gain 3 Arctic Charge',
      effects: [{ type: 'draw', value: 3 }, { type: 'radiance_gain', value: 1 }, { type: 'chain_gain', value: 2.1 }, { type: 'arctic_charge_gain', value: 3 }],
    },
    primaryName: 'Icebound Conductor Ordinance',
    primaryDescription: '486 base Oblivion · 4 cards cooldown · chain +1.08',
    primaryBase: 486,
    primaryCooldown: 4,
    primaryScaling: 1.08,
    exaltedName: 'Icebound Conductor Throne Decree',
    exaltedDescription: '1442 base Oblivion · 6 cards cooldown · chain +1.30 · Cost: spend 28 Strain',
    exaltedBase: 946,
    exaltedCooldown: 6,
    exaltedScaling: 1.3,
  ...
  },
  {
    ...
    description: 'On summon: Draw 3 cards; +180 Oblivion; Amplify Chain by +x1.9; Gain 8 Arctic Charge. After 5 cards played: Draw 4 cards; Empower the next card you play; +220 Oblivion; Discharge Arctic Charge. While on board: +24 Oblivion per card played while on board',
    rarity: 'Legendary',
    ...
    onSummonEffects: [{ type: 'draw', value: 3 }, { type: 'oblivion_flat', value: 180 }, { type: 'chain_gain', value: 1.9 }, { type: 'arctic_charge_gain', value: 8 }],
    activatedAbility: {
      name: 'Grid of Winter',
    ...
    primaryDescription: '1062 base Oblivion · 5 cards cooldown · chain +1.24',
    primaryBase: 1062,
    primaryCooldown: 5,
    primaryScaling: 1.24,
    exaltedName: 'Voltage Patriarch Throne Decree',
    exaltedDescription: '3704 base Oblivion · 7 cards cooldown · chain +1.46 · Cost: spend 31 Strain',
    exaltedBase: 2436,
    exaltedCooldown: 7,
    exaltedScaling: 1.46,
  ...
  },
  {
    ...
    name: 'Neon Blizzard',
    description: 'On summon: Draw 4 cards; +200 Oblivion; Gain 7 Arctic Charge. After 5 cards played: Draw 3 cards; Gain 2 Strain; Set chain multiplier to x2.3; Discharge Arctic Charge. While on board: +28 Oblivion whenever you play an Ophanim while on board',
    rarity: 'Legendary',
    ...
    primaryDescription: '1098 base Oblivion · 5 cards cooldown · chain +1.24',
    primaryBase: 1098,
    primaryCooldown: 5,
    primaryScaling: 1.24,
    exaltedName: 'Neon Blizzard Throne Decree',
    exaltedDescription: '3833 base Oblivion · 7 cards cooldown · chain +1.46 · Cost: spend 30 Strain',
    exaltedBase: 2520,
    exaltedCooldown: 7,
    exaltedScaling: 1.46,
  ...
  },
  {
    ...
    description: 'On summon: Draw 5 cards; Set chain multiplier to x2.0; Gain 9 Arctic Charge. After 6 cards played: Draw 4 cards; +240 Oblivion; Empower the next card you play; Discharge Arctic Charge. While on board: Chain grows +0.08 per card played while on board',
    rarity: 'Legendary',
    ...
    primaryDescription: '1180 base Oblivion · 5 cards cooldown · chain +1.24',
    primaryBase: 1180,
    primaryCooldown: 5,
    primaryScaling: 1.24,
    exaltedName: 'Polarity Throne Throne Decree',
    exaltedDescription: '3948 base Oblivion · 7 cards cooldown · chain +1.46 · Cost: spend 31 Strain',
    exaltedBase: 2596,
    exaltedCooldown: 7,
    exaltedScaling: 1.46,
