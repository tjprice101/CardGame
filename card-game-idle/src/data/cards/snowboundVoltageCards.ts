...
const SNOWBOUND_SERAPHIM_SPECS: SnowboundSeraphimSpec[] = [
  {
    ...
    bonusValue: 10,
    onPlayEffects: [{ type: 'strain_gain', value: 1 }, { type: 'draw', value: 1 }],
  ...
  },
  {
    ...
    bonusValue: 0.05,
    onPlayEffects: [{ type: 'radiance_gain', value: 1 }, { type: 'set_chain_floor', value: 1.25 }],
  ...
  },
  {
    ...
    bonusType: 'ophanim_bonus',
    bonusValue: 24,
    onPlayEffects: [{ type: 'ember_gain', value: 2 }, { type: 'strain_gain', value: 1 }],
  ...
  },
  {
    ...
    bonusType: 'oblivion_per_card',
    bonusValue: 15,
    onPlayEffects: [{ type: 'radiance_gain', value: 2 }],
  ...
  },
  {
    ...
    bonusType: 'oblivion_per_card',
    bonusValue: 20,
    onPlayEffects: [{ type: 'strain_gain', value: 3 }],
...
const SNOWBOUND_CHERUBIM_SPECS: SnowboundCherubimSpec[] = [
  {
    ...
    onPlayEffects: [{ type: 'strain_gain', value: 4 }, { type: 'draw', value: 1 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'oblivion_flat', value: 40 }, { type: 'strain_gain', value: 2 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'strain_gain', value: 5 }, { type: 'draw', value: 1 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'oblivion_flat', value: 60 }, { type: 'radiance_gain', value: 1 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'draw', value: 2 }, { type: 'strain_gain', value: 4 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'strain_gain', value: 6 }, { type: 'oblivion_flat', value: 80 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'strain_gain', value: 10 }, { type: 'draw', value: 1 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'strain_gain', value: 8 }, { type: 'oblivion_flat', value: 100 }],
  },
  {
    ...
    onPlayEffects: [{ type: 'draw', value: 2 }, { type: 'set_chain_floor', value: 1.4 }],
  },
];
...
const SNOWBOUND_OPHANIM_SPECS: SnowboundOphanimSpec[] = [
  {
    ...
    effects: [{ type: 'strain_gain', value: 2 }, { type: 'draw', value: 1 }],
  },
  {
  ...
  },
  {
    ...
    effects: [{ type: 'radiance_gain', value: 2 }, { type: 'draw', value: 1 }],
  },
  {
    ...
    effects: [{ type: 'draw', value: 2 }, { type: 'shuffle_discard' }],
  },
  {
  ...
  },
  {
    ...
    effects: [{ type: 'radiance_gain', value: 3 }, { type: 'chain_multiplier_set', value: 1.6 }],
  },
  {
    ...
    effects: [{ type: 'draw', value: 3 }, { type: 'strain_gain', value: 5 }],
  },
  {
...
const SNOWBOUND_ANGEL_SPECS: SnowboundAngelSpec[] = [
  {
    ...
    onSummonEffects: [{ type: 'strain_gain', value: 5 }, { type: 'draw', value: 2 }, { type: 'set_chain_floor', value: 1.5 }],
    activatedAbility: {
      name: 'Chorus Breaker',
      cardsPlayedRequirement: 3,
      description: 'Draw 2 cards; +80 Oblivion',
      effects: [{ type: 'draw', value: 2 }, { type: 'oblivion_flat', value: 80 }],
    },
  ...
  },
  {
    ...
    onSummonEffects: [{ type: 'draw', value: 3 }, { type: 'oblivion_flat', value: 120 }],
    activatedAbility: {
      name: 'Drift Verdict',
      cardsPlayedRequirement: 4,
      description: 'Set chain multiplier to x2.0; Draw 2 cards; +100 Oblivion',
      effects: [{ type: 'chain_multiplier_set', value: 2.0 }, { type: 'draw', value: 2 }, { type: 'oblivion_flat', value: 100 }],
    },
  ...
  },
  {
    ...
    onSummonEffects: [{ type: 'draw', value: 4 }, { type: 'chain_multiplier_set', value: 1.8 }],
    activatedAbility: {
      name: 'Frozen Current',
      cardsPlayedRequirement: 4,
  ...
  },
  {
    ...
    onSummonEffects: [{ type: 'draw', value: 3 }, { type: 'oblivion_flat', value: 180 }, { type: 'set_chain_floor', value: 1.9 }],
    activatedAbility: {
      name: 'Grid of Winter',
      cardsPlayedRequirement: 5,
      description: 'Draw 4 cards; Empower the next card you play; +220 Oblivion',
      effects: [{ type: 'draw', value: 4 }, { type: 'multiply_next' }, { type: 'oblivion_flat', value: 220 }],
    },
  ...
  },
  {
    ...
    onSummonEffects: [{ type: 'draw', value: 4 }, { type: 'oblivion_flat', value: 200 }],
    activatedAbility: {
      name: 'Aurora Spike',
      cardsPlayedRequirement: 5,
      description: 'Draw 3 cards; Gain 2 Strain; Set chain multiplier to x2.3',
      effects: [{ type: 'draw', value: 3 }, { type: 'strain_gain', value: 2 }, { type: 'chain_multiplier_set', value: 2.3 }],
    },
  ...
  },
  {
    ...
    extraSummonConditions: [{ type: 'cherubim_active_gte', value: 2 }],
    onSummonEffects: [{ type: 'draw', value: 5 }, { type: 'chain_multiplier_set', value: 2.0 }],
    activatedAbility: {
      name: 'Throne of Poles',
      cardsPlayedRequirement: 6,
      description: 'Draw 4 cards; +240 Oblivion; Empower the next card you play',
      effects: [{ type: 'draw', value: 4 }, { type: 'oblivion_flat', value: 240 }, { type: 'multiply_next' }],
    },
