...
export const prismaticAccordAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: Draw 2 cards; Look at the top 4 cards, take 1 card, and put the rest on the bottom; Gain 6 Prismatic Light. After 4 cards played: Salvage any 1 card; Draw 1 card; Gain 5 Prismatic Light. While on board: +8 Oblivion for each Seraphim on board while on board',
    ...
    activatedAbility: {
      ...
      description: 'Salvage any 1 card; Draw 1 card; Gain 5 Prismatic Light',
      effects: [
        { type: 'salvage_any' },
        { type: 'draw', value: 1 },
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '746 base Oblivion �E 7 cards cooldown �E Cost: discard 2 cards, spend 3 Strain',
        baseOblivion: 2220,
        cooldownCards: 7,
        costs: [],
  ...
  },
  {
    ...
    description: 'On summon: Draw 2 cards; +170 Oblivion; Gain 7 Prismatic Light. After 5 cards played: Empower the next card you play; Salvage any 1 card; Gain 5 Prismatic Light. While on board: +16 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Empower the next card you play; Salvage any 1 card; Gain 5 Prismatic Light',
      effects: [
        { type: 'multiply_next' },
        { type: 'salvage_any' },
        { type: 'prismatic_light_gain', value: 5 }],
