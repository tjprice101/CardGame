...
export const prismaticAccordAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: Draw 2 cards; Look at the top 4 cards, take 1 card, and put the rest on the bottom; Set chain floor to x1.45. After 4 cards played: Set chain multiplier to x2.1; Salvage any 1 card; Draw 1 card. While on board: +8 Oblivion for each Seraphim on board while on board',
    ...
    activatedAbility: {
      ...
      description: 'Set chain multiplier to x2.1; Salvage any 1 card; Draw 1 card',
      effects: [
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '746 base Oblivion, 7 cards cooldown, x1.32 chain scaling, Cost: discard 2 cards, spend 3 Strain',
        baseOblivion: 2220,
        cooldownCards: 7,
        chainScaling: 1.46,
        costs: [],
  ...
  },
  {
    ...
    description: 'On summon: Draw 2 cards; +170 Oblivion; Set chain floor to x1.6. After 5 cards played: Set chain multiplier to x2.4; Empower the next card you play; Salvage any 1 card. While on board: +16 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Set chain multiplier to x2.4; Empower the next card you play; Salvage any 1 card',
      effects: [
