...
export const INFINITE_RECIPES: InfiniteRecipe[] = [
  ...
  // Age of the Butterfly
  {
    ...
    ingredients: [
      { definitionId: 'bf-oph-midair-citadel', count: 2 },
      { definitionId: 'bf-oph-ridge-trace', count: 1 },
      { definitionId: 'bf-cher-stained-century-choir', count: 2 },
      { definitionId: 'bf-ser-unfurling-cantor', count: 1 },
      { definitionId: 'bf-angel-generational-witness', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'bf-oph-suppression-wake', count: 2 },
      { definitionId: 'bf-cher-nullwake-attendant', count: 2 },
      { definitionId: 'bf-ser-nullwing-stillness', count: 1 },
      { definitionId: 'bf-angel-chrysalis-warden', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'bf-oph-crystal-ornament-route', count: 2 },
      { definitionId: 'bf-oph-lens-current', count: 1 },
      { definitionId: 'bf-cher-prismedge-novice', count: 1 },
      { definitionId: 'bf-cher-echo-shed-lamina', count: 1 },
      { definitionId: 'bf-ser-mireth-lenshost', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'bf-oph-copper-green-trail', count: 3 },
      { definitionId: 'bf-cher-mireth-flutterlings', count: 3 },
      { definitionId: 'bf-cher-flutter-vigil-sexton', count: 1 },
      { definitionId: 'bf-angel-flutter-cartographer', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'bf-oph-electromagnetic-arrival', count: 2 },
      { definitionId: 'bf-oph-velmargin-lensfall', count: 1 },
      { definitionId: 'bf-cher-volthari-filament', count: 2 },
      { definitionId: 'bf-ser-volthari-stormscript', count: 1 },
      { definitionId: 'bf-angel-wingpattern-archivist', count: 1 },
      { definitionId: 'bf-et-volthari-storm-lattice', count: 1 },
    ],
  },
  ...
  // Eternal Seas
  {
    ...
    ingredients: [
      { definitionId: 'es-oph-depthless-sounding', count: 2 },
      { definitionId: 'es-oph-blackwater-cant', count: 1 },
      { definitionId: 'es-cher-blackzone-lamplure', count: 2 },
      { definitionId: 'es-ser-veleth-itself-echo', count: 1 },
      { definitionId: 'es-angel-veleth-undying-water', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'es-oph-whitewater-cant', count: 3 },
      { definitionId: 'es-cher-aeveleth-trace', count: 2 },
      { definitionId: 'es-ser-velthiri-bloomschool', count: 1 },
      { definitionId: 'es-angel-aeveleth-remembered', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'es-oph-veilmargin-crossflow', count: 2 },
      { definitionId: 'es-cher-veilmargin-conductor', count: 2 },
      { definitionId: 'es-ser-veilmargin-harbinger', count: 1 },
      { definitionId: 'es-angel-veilmargin-cartographer', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'es-oph-crowncurrent-atlas', count: 2 },
      { definitionId: 'es-cher-crowned-current-keeper', count: 2 },
      { definitionId: 'es-angel-crowned-one-ruby', count: 1 },
      { definitionId: 'es-angel-crowned-one-azure', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'es-oph-shallows-spiral-map', count: 2 },
      { definitionId: 'es-oph-neon-pressure-line', count: 1 },
      { definitionId: 'es-cher-silver-shallow-attendant', count: 1 },
      { definitionId: 'es-cher-surevaan-pulse-reader', count: 1 },
      { definitionId: 'es-ser-surevaan-tiltborne', count: 1 },
  ...
  // Abyssal Forge
  {
    ...
    ingredients: [
      { definitionId: 'af-oph-ouroglas-discarded-scale', count: 3 },
      { definitionId: 'af-cher-ioreks-echo', count: 1 },
      { definitionId: 'af-ser-ophrax-vermilion-kraken', count: 1 },
      { definitionId: 'af-angel-iorek-reforged', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'af-oph-anvilstorm-halo', count: 2 },
      { definitionId: 'af-oph-crown-of-the-forge-beneath', count: 1 },
      { definitionId: 'af-cher-anvilborn-sovereign', count: 1 },
      { definitionId: 'af-cher-first-lampwright-iorek', count: 1 },
      { definitionId: 'af-angel-lampwright-sovereign', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'af-oph-chromatic-ember-cluster', count: 2 },
      { definitionId: 'af-oph-quenching-ring', count: 2 },
      { definitionId: 'af-cher-quench-mistress', count: 1 },
      { definitionId: 'af-ser-cerumel-verdant-anglerfish', count: 1 },
      { definitionId: 'af-angel-bearer-unrecorded-hue', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'af-oph-saffron-ember-wheel', count: 2 },
      { definitionId: 'af-oph-cobalt-ember-wheel', count: 2 },
      { definitionId: 'af-cher-nacre-touched-initiate', count: 1 },
      { definitionId: 'af-cher-pearl-welded-cantor', count: 1 },
      { definitionId: 'af-angel-covenant-herald', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'af-oph-forge-wheel-sigil', count: 3 },
      { definitionId: 'af-cher-bellows-acolyte', count: 1 },
      { definitionId: 'af-cher-apprentice-lampwright', count: 1 },
      { definitionId: 'af-ser-vairoch-sapphire-bellows', count: 1 },
      { definitionId: 'af-angel-crowned-one-sapphire', count: 1 },
      { definitionId: 'af-angel-crowned-one-saffron', count: 1 },
  ...
  // Death-flamed Hell
  {
    ...
    ingredients: [
      { definitionId: 'dfh-oph-funeral-march-drummer', count: 2 },
      { definitionId: 'dfh-oph-hollow-throne-coronation', count: 1 },
      { definitionId: 'dfh-cher-cathedral-anchorite', count: 1 },
      { definitionId: 'dfh-ser-sablecrown-herald', count: 1 },
      { definitionId: 'dfh-ang-sablecrown-the-unnamed', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'dfh-oph-choirhouse-conductor', count: 2 },
      { definitionId: 'dfh-cher-stigmata-flame-confessor', count: 1 },
      { definitionId: 'dfh-cher-othraks-confessor', count: 1 },
      { definitionId: 'dfh-cher-cinder-saint-othrak', count: 1 },
      { definitionId: 'dfh-ser-choirhouse-cantor', count: 1 },
      { definitionId: 'dfh-ang-council-of-the-seven-choirs', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'dfh-oph-wedding-procession-living-world', count: 1 },
      { definitionId: 'dfh-oph-faceless-bridesmaid-choir', count: 2 },
      { definitionId: 'dfh-oph-veil-stitcher', count: 1 },
      { definitionId: 'dfh-cher-severed-sanctity-hierophant', count: 1 },
      { definitionId: 'dfh-ang-veil-iorn-the-faceless-bride', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'dfh-oph-pyrelungs-exhalation', count: 2 },
      { definitionId: 'dfh-oph-wickless-litany', count: 1 },
      { definitionId: 'dfh-cher-the-flayed-halo', count: 1 },
      { definitionId: 'dfh-ser-ash-marrow-reaver', count: 1 },
      { definitionId: 'dfh-ang-mournshade-the-wickless', count: 1 },
      { definitionId: 'dfh-ang-pyrelung-the-breathless', count: 1 },
  ...
  // [EVENT] Wished Upon A Star
  {
    ...
    ingredients: [
      { definitionId: 'wuas-oph-stargazer-token', count: 2 },
      { definitionId: 'wuas-oph-celestine-cascade', count: 1 },
      { definitionId: 'wuas-cher-starlace-binding', count: 1 },
      { definitionId: 'wuas-ser-solarvex-fragment', count: 1 },
      { definitionId: 'wuas-ang-aethervex-triumphant', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'wuas-oph-luna-glitch', count: 3 },
      { definitionId: 'wuas-oph-aeolian-nova', count: 1 },
      { definitionId: 'wuas-cher-dreamvault-keeper', count: 1 },
      { definitionId: 'wuas-ser-lune-refrain', count: 1 },
      { definitionId: 'wuas-ser-seleniras-vigil', count: 1 },
      { definitionId: 'wuas-ang-starwarden-selenira', count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { definitionId: 'wuas-oph-wishfire-surge', count: 2 },
      { definitionId: 'wuas-oph-skyrift-mote', count: 1 },
      { definitionId: 'wuas-oph-dream-shard', count: 1 },
      { definitionId: 'wuas-cher-voidbane-doctrine', count: 1 },
      { definitionId: 'wuas-cher-wishwright-pulse', count: 1 },
      { definitionId: 'wuas-ser-draethos-gravity', count: 1 },
      { definitionId: 'wuas-ser-nullspire-monolith', count: 1 },
      { definitionId: 'wuas-ang-draethos-eclipse-lord', count: 1 },
