...
export const infiniteSeraphimCards: SeraphimDefinition[] = [
  {
    ...
    rarity: 'Infinite',
    name: 'Genesis Throne',
    description: 'On play: +2400 Oblivion; All Seraphim on board gain +9 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks). While on board: +760 Oblivion per card played while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion',
  ...
  },
  {
    ...
    rarity: 'Infinite',
    name: 'Null Apex',
    description: 'On play: All Seraphim on board gain +12 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); +1100 Oblivion. While on board: +1100 Oblivion whenever you play an Ophanim while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion',
...
export const infiniteCherubimCards: CherubimDefinition[] = [
  {
    ...
    rarity: 'Infinite',
    name: 'Entropic Crown',
      description: 'On play: +2600 Oblivion; All Seraphim on board gain +6 Patience; Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks). While on board: Adjacent Seraphim gain +6 Patience per card played',
  ...
  },
  {
    ...
    name: 'Annihilation Field',
      description: 'On play: All Seraphim on board gain +10 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks). While on board: Adjacent Seraphim gain +5 Patience per card played',
...
export const infiniteAngelCards: AngelDefinition[] = [
  {
    ...
    rarity: 'Infinite',
    name: 'Sovereign Void',
    description: 'On summon: All Seraphim on board gain +24 Patience. After 4 cards played: Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +10 Patience; +2800 Oblivion; Empower the next card you play. While on board: +420 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +10 Patience; +2800 Oblivion; Empower the next card you play',
      effects: [
        { type: 'neutrality_patient_light_gain', value: 3 },
  ...
  },
  {
    ...
    description: 'On summon: All Seraphim on board gain +16 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); +1800 Oblivion. After 5 cards played: Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +8 Patience; +2600 Oblivion; Empower the next card you play. While on board: +500 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +8 Patience; +2600 Oblivion; Empower the next card you play',
      effects: [
        { type: 'neutrality_patient_light_gain', value: 3 },
