...
export const neutralityAngels: AngelDefinition[] = [
  ...
  },
  {
    ...
    description: 'On summon: All Seraphim gain +6 Patience; Draw 4 cards; +120 Oblivion. After 4 cards played: Double Patience on all Seraphim; Draw 5 cards; Salvage any 1 card; Amplify Chain by +2.4. While on board: +35 Oblivion whenever you play an Ophanim.',
    ...
    activatedAbility: {
      ...
      description: 'Double Patience on all Seraphim; Draw 5 cards; Salvage any 1 card; Amplify Chain by +2.4',
      effects: [
  ...
  },
  {
    ...
    description: 'On summon: All Seraphim gain +8 Patience; Draw 4 cards; Shuffle discard into deck; Set chain multiplier to x2.2. After 5 cards played: Double Patience on all Seraphim; Draw 4 cards; Empower the next card you play; Amplify Chain by +2.5; +250 Oblivion. While on board: Chain grows +0.14 per card played.',
    ...
    activatedAbility: {
      ...
      description: 'Double Patience on all Seraphim; Draw 4 cards; Empower the next card you play; Amplify Chain by +2.5; +250 Oblivion',
      effects: [
        { type: 'patience_double_all' },
        { type: 'draw', value: 4 },
        { type: 'multiply_next' },
