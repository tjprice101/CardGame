...
export const neutralityAngels: AngelDefinition[] = [
  ...
  },
  {
    ...
    description: 'Summon: sacrifice The Beginning of the End + Equilibrium Seraphim. Draw 4 cards and gain +120 Oblivion. After 4 cards: right-click to draw 5, salvage any card from your discard pile, and set chain floor to ×2.4. While on board: +35 Oblivion per Seeker card played.',
  ...
  },
  {
    ...
    description: 'Summon: sacrifice Aegis of Presence + Still Seraphim. Requires 1+ active Chaos card. Draw 4, shuffle your discard pile into the deck, and set chain multiplier to ×2.2. After 5 cards: right-click to draw 4, empower the next card, set chain floor to ×2.8, and gain +320 Oblivion. While on board: chain multiplier grows +0.14 faster per card played.',
    ...
    activatedAbility: {
      ...
      description: 'Draw 4 cards, empower the next card, set chain floor to ×2.8, and gain +320 Oblivion.',
      effects: [
        { type: 'draw', value: 4 },
        { type: 'multiply_next' },
        { type: 'set_chain_floor', value: 2.8 },
        { type: 'oblivion_flat', value: 320 },
      ],
    },
