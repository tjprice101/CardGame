...
const baseSeraphim: SeraphimDefinition[] = [
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 3 Flutter Spectrum; If you control 1+ active Cherubim, +60 Oblivion. While on board: Resource generation +3 while active',
    rarity: 'Rare',
    artKey: 'bf_ser_pyrethkai_whiteflame',
    bonusType: 'resource_generation',
    bonusValue: 3,
    onPlayEffects: [{ type: 'butterfly_spectrum_gain', value: 3 }, { type: 'conditional', condition: { type: 'cherubim_active_gte', value: 1 }, then: [{ type: 'oblivion_flat', value: 60 }] }],
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 4 Flutter Spectrum; Release up to 1 Spectrum (+100 Oblivion per Spectrum). While on board: +20 Oblivion whenever you play an Ophanim while active',
    rarity: 'Epic',
    artKey: 'bf_ser_volthari_stormscript',
    bonusType: 'ophanim_bonus',
    bonusValue: 20,
    onPlayEffects: [{ type: 'butterfly_spectrum_gain', value: 4 }, { type: 'butterfly_release', spend: 1, oblivionPerSpectrum: 100 }],
...
const baseCherubim: CherubimDefinition[] = [
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 2 Flutter Spectrum; If you control 1+ active Seraphim, Draw 1 card. While on board: Gain 1 Spectrum per card played',
    rarity: 'Common',
    artKey: 'bf_cher_copper_bank_spark',
    effects: [{ type: 'cherubim_resource_per_card', resource: 'butterflySpectrum', value: 1 }],
    onPlayEffects: [{ type: 'butterfly_spectrum_gain', value: 2 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 1 }, then: [{ type: 'draw', value: 1 }] }],
  }),
  buildCherubim({
    definitionId: 'bf-cher-prismedge-novice',
    name: 'Prismedge Novice',
    description: 'On play: Gain 3 Flutter Spectrum; Look at the top 4 cards, take 1 card, and put the rest on the bottom; If you have played 2+ cards this turn, +40 Oblivion. While on board: Each adjacent active Seraphim adds 1 extra card whenever you play a card',
    rarity: 'Rare',
    artKey: 'bf_cher_prismedge_novice',
    effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'draw', value: 1 }],
    onPlayEffects: [{ type: 'butterfly_spectrum_gain', value: 3 }, { type: 'look_top_take', look: 4, take: 1 }, { type: 'conditional', condition: { type: 'cards_played_gte', value: 2 }, then: [{ type: 'oblivion_flat', value: 40 }] }],
  }),
  buildCherubim({
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 6 Flutter Spectrum; Release up to 2 Spectrum (+70 Oblivion per Spectrum). While on board: Seraphim bonuses are amplified by +8%',
    rarity: 'Epic',
    artKey: 'bf_cher_nullwake_attendant',
    effects: [{ type: 'cherubim_seraphim_amp', value: 0.08 }],
    onPlayEffects: [{ type: 'butterfly_spectrum_gain', value: 6 }, { type: 'butterfly_release', spend: 2, oblivionPerSpectrum: 70 }],
  }),
  buildCherubim({
    definitionId: 'bf-cher-volthari-filament',
    name: 'Volthari Filament',
    description: 'On play: Gain 4 Flutter Spectrum; Release up to 1 Spectrum (+80 Oblivion per Spectrum). While on board: Buffs Seraphim and Angel attacks: base +42; Buffs Angel attacks: base +33',
    rarity: 'Epic',
    ...
    onPlayEffects: [{ type: 'butterfly_spectrum_gain', value: 4 }, { type: 'butterfly_release', spend: 1, oblivionPerSpectrum: 80 }],
  }),
  buildCherubim({
...
const baseOphanim: OphanimDefinition[] = [
  ...
  buildOphanim({
    ...
    description: 'Gain 3 Flutter Spectrum; Release up to 1 Spectrum (+90 Oblivion per Spectrum)',
    rarity: 'Rare',
    artKey: 'bf_oph_copper_green_trail',
    effects: [{ type: 'butterfly_spectrum_gain', value: 3 }, { type: 'butterfly_release', spend: 1, oblivionPerSpectrum: 90 }],
  }),
  buildOphanim({
    definitionId: 'bf-oph-crystal-ornament-route',
    name: 'Crystal Ornament Route',
    description: 'Gain 3 Flutter Spectrum; Draw 2 cards; If you have played 2+ cards this turn, +60 Oblivion',
    rarity: 'Rare',
    artKey: 'bf_oph_crystal_ornament_route',
    effects: [{ type: 'butterfly_spectrum_gain', value: 3 }, { type: 'draw', value: 2 }, { type: 'conditional', condition: { type: 'cards_played_gte', value: 2 }, then: [{ type: 'oblivion_flat', value: 60 }] }],
  }),
  buildOphanim({
    definitionId: 'bf-oph-suppression-wake',
    name: 'Suppression Wake',
    description: 'Gain 4 Flutter Spectrum; +180 Oblivion; If you control 2+ active Seraphim, Release up to 1 Spectrum (+120 Oblivion per Spectrum)',
    rarity: 'Epic',
    artKey: 'bf_oph_suppression_wake',
    effects: [{ type: 'butterfly_spectrum_gain', value: 4 }, { type: 'oblivion_flat', value: 180 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 2 }, then: [{ type: 'butterfly_release', spend: 1, oblivionPerSpectrum: 120 }] }],
  }),
  buildOphanim({
    definitionId: 'bf-oph-electromagnetic-arrival',
    name: 'Electromagnetic Arrival',
    description: 'Gain 4 Flutter Spectrum; Draw 1 card; If you have played 3+ cards this turn, +80 Oblivion',
    rarity: 'Epic',
    artKey: 'bf_oph_electromagnetic_arrival',
    effects: [{ type: 'butterfly_spectrum_gain', value: 4 }, { type: 'draw', value: 1 }, { type: 'conditional', condition: { type: 'cards_played_gte', value: 3 }, then: [{ type: 'oblivion_flat', value: 80 }] }],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    description: 'Gain 5 Flutter Spectrum; Release up to 3 Spectrum (+120 Oblivion per Spectrum); If you control 2+ active Seraphim, Draw 1 card',
    rarity: 'Legendary',
    artKey: 'bf_oph_velmargin_lensfall',
    effects: [{ type: 'butterfly_spectrum_gain', value: 5 }, { type: 'butterfly_release', spend: 3, oblivionPerSpectrum: 120 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 2 }, then: [{ type: 'draw', value: 1 }] }],
  })];
