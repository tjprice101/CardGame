...
const baseCherubim: CherubimDefinition[] = [
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 2 Undertow. While on board: +10 Oblivion per card played; Whenever you release Undertow, +10 Oblivion',
    rarity: 'Common',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 5 Radiance; Gain 3 Undertow; Gain 2 Foam. While on board: Gain 2 Radiance per card played',
    rarity: 'Rare',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 4 Undertow; Draw 1 card. While on board: Seraphim bonuses are amplified by +10%',
    rarity: 'Epic',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 4 Undertow; Draw 2 cards. While on board: Buffs Angel attacks: base +60; +1 draw every 3 cards played',
    rarity: 'Legendary',
  ...
  buildCherubim({
    ...
    name: 'Aeveleth Trace',
    description: 'On play: Gain 5 Undertow; Gain 1 Foam. While on board: The first time each turn you release Undertow, +90 Oblivion and draw 1 card',
    rarity: 'Legendary',
