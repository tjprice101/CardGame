...
const baseSeraphim: SeraphimDefinition[] = [
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 2 Undertow; Gain 1 Foam; +80 Oblivion; If this is the first card you played this turn, Gain 1 Foam. While on board: +12 Oblivion per card played while active',
    rarity: 'Common',
    artKey: 'es_ser_kethavar_helixhunter',
    bonusType: 'oblivion_per_card',
    bonusValue: 12,
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 2 }, { type: 'seas_foam_gain', value: 1 }, { type: 'oblivion_flat', value: 80 }, { type: 'conditional', condition: { type: 'first_card_this_turn' }, then: [{ type: 'seas_foam_gain', value: 1 }] }],
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 3 Undertow; Gain 2 Foam; If you control 1+ active Cherubim, Draw 1 card. While on board: +20 Oblivion whenever you play an Ophanim while active',
    rarity: 'Rare',
    artKey: 'es_ser_surevaan_tiltborne',
    bonusType: 'ophanim_bonus',
    bonusValue: 20,
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 3 }, { type: 'seas_foam_gain', value: 2 }, { type: 'conditional', condition: { type: 'cherubim_active_gte', value: 1 }, then: [{ type: 'draw', value: 1 }] }],
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 4 Undertow; Gain 2 Foam; If you control 2+ active Seraphim, Release up to 1 Undertow (+110 Oblivion per Undertow). While on board: +24 Oblivion per card played while active',
    rarity: 'Epic',
    artKey: 'es_ser_veilmargin_harbinger',
    bonusType: 'oblivion_per_card',
    bonusValue: 24,
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 4 }, { type: 'seas_foam_gain', value: 2 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 2 }, then: [{ type: 'seas_undertow_release', spend: 1, oblivionPerUndertow: 110 }] }],
...
const baseCherubim: CherubimDefinition[] = [
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 2 Undertow; Gain 1 Foam; If you control 1+ active Seraphim, +30 Oblivion. While on board: +8 Oblivion per card played',
    rarity: 'Common',
    artKey: 'es_cher_blackzone_lamplure',
    effects: [{ type: 'cherubim_oblivion_per_card', value: 8 }],
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 2 }, { type: 'seas_foam_gain', value: 1 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 1 }, then: [{ type: 'oblivion_flat', value: 30 }] }],
  }),
  buildCherubim({
    definitionId: 'es-cher-veilmargin-conductor',
    name: 'Veilmargin Conductor',
    description: 'On play: Gain 3 Undertow; Gain 2 Foam; If you have played 2+ cards this turn, Draw 1 card. While on board: Buffs Angel attacks: base +36',
    rarity: 'Rare',
    artKey: 'es_cher_veilmargin_conductor',
    effects: [{ type: 'cherubim_attack_buff', targetUnitType: 'Angel', bonusBaseOblivion: 36 }],
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 3 }, { type: 'seas_foam_gain', value: 2 }, { type: 'conditional', condition: { type: 'cards_played_gte', value: 2 }, then: [{ type: 'draw', value: 1 }] }],
  }),
  buildCherubim({
    definitionId: 'es-cher-neon-cell-cantor',
    name: 'Neon Cell Cantor',
    description: 'On play: Gain 3 Undertow; Gain 2 Foam. While on board: Gain 1 Undertow per card played; +1 draw every 3 cards played',
    rarity: 'Rare',
...
const baseOphanim: OphanimDefinition[] = [
  buildOphanim({
    ...
    description: 'Gain 2 Undertow; Gain 1 Foam; Draw 1 card',
    rarity: 'Common',
    artKey: 'es_oph_shallows_spiral_map',
    effects: [{ type: 'seas_undertow_gain', value: 2 }, { type: 'seas_foam_gain', value: 1 }, { type: 'draw', value: 1 }],
  }),
  buildOphanim({
  ...
  buildOphanim({
    ...
    description: 'Gain 3 Undertow; Gain 1 Foam; +150 Oblivion; If you control 1+ active Seraphim, Gain 1 Foam',
    rarity: 'Rare',
    artKey: 'es_oph_blackwater_cant',
    effects: [{ type: 'seas_undertow_gain', value: 3 }, { type: 'seas_foam_gain', value: 1 }, { type: 'oblivion_flat', value: 150 }, { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 1 }, then: [{ type: 'seas_foam_gain', value: 1 }] }],
  }),
  buildOphanim({
