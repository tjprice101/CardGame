...
const baseSeraphim: SeraphimDefinition[] = [
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 3 Undertow. While on board: Whenever you play an Eternal Seas Ophanim, gain +20 Oblivion and +1 Undertow.',
    rarity: 'Rare',
  ...
  buildSeraphim({
    ...
    description: 'On play: Gain 3 Undertow; Gain 1 Foam; Draw 1 card. While on board: The first card you draw each turn grants +1 Undertow.',
    rarity: 'Rare',
...
const baseCherubim: CherubimDefinition[] = [
  buildCherubim({
    ...
    description: 'On play: Gain 2 Undertow; Gain 1 Foam. While on board: The first Cherubim you play each turn gains +1 durability and +1 Foam if you already have 5 Foam.',
    rarity: 'Common',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 2 Undertow. While on board: Whenever you play an Eternal Seas Ophanim, gain +10 Oblivion and +1 Undertow.',
    rarity: 'Common',
    artKey: 'es_cher_blackzone_lamplure',
    effects: [{ type: 'cherubim_oblivion_per_card', value: 10 }, { type: 'cherubim_seas_release_reaction', oblivionGain: 10 }],
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 2 }],
  }),
  buildCherubim({
    definitionId: 'es-cher-veilmargin-conductor',
    name: 'Veilmargin Conductor',
    description: 'On play: Gain 3 Undertow. While on board: Buffs Angel attacks: base +44.',
    rarity: 'Rare',
    artKey: 'es_cher_veilmargin_conductor',
    effects: [{ type: 'cherubim_attack_buff', targetUnitType: 'Angel', bonusBaseOblivion: 44 }],
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 3 }],
  }),
  buildCherubim({
    definitionId: 'es-cher-neon-cell-cantor',
    name: 'Neon Cell Cantor',
    description: 'On play: Gain 3 Undertow; Gain 2 Foam; Gain 5 Radiance. While on board: Gain 2 Radiance per card played.',
    rarity: 'Rare',
    artKey: 'es_cher_neon_cell_cantor',
    effects: [{ type: 'cherubim_resource_per_card', resource: 'radiance', value: 2 }],
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 3 }, { type: 'seas_foam_gain', value: 2 }, { type: 'radiance_gain', value: 5 }],
  }),
  buildCherubim({
    definitionId: 'es-cher-surevaan-pulse-reader',
    name: 'Surevaan Pulse Reader',
    description: 'On play: Gain 4 Undertow; Draw 1 card. While on board: Seraphim bonuses are amplified by +0.10.',
    rarity: 'Epic',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 4 Undertow; Gain 2 Foam. While on board: Buffs Seraphim and Angel attacks: base +40.',
    rarity: 'Epic',
    artKey: 'es_cher_thyrvaan_breathframe',
    effects: [{ type: 'cherubim_attack_buff', targetUnitType: 'Any', bonusBaseOblivion: 40 }],
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 4 }, { type: 'seas_foam_gain', value: 2 }],
  }),
  buildCherubim({
    definitionId: 'es-cher-crowned-current-keeper',
    name: 'Crowned Current Keeper',
    description: 'On play: Gain 4 Undertow; Draw 2 cards. While on board: Buffs Angel attacks: base +60; Draw 0.34 cards per card played.',
    rarity: 'Legendary',
    artKey: 'es_cher_crowned_current_keeper',
    effects: [{ type: 'cherubim_attack_buff', targetUnitType: 'Angel', bonusBaseOblivion: 60 }, { type: 'cherubim_draw_per_card', value: 0.34 }],
    onPlayEffects: [{ type: 'seas_undertow_gain', value: 4 }, { type: 'draw', value: 2 }],
  }),
  buildCherubim({
    definitionId: 'es-cher-aeveleth-trace',
    name: 'Aeveleth Trace',
    description: 'On play: Gain 5 Undertow; Gain 1 Foam. While on board: The first time each turn you release Undertow, gain +90 Oblivion and draw 1 card.',
    rarity: 'Legendary',
    artKey: 'es_cher_aeveleth_trace',
    maxDurability: 9,
    effects: [{ type: 'cherubim_seas_release_reaction', oblivionGain: 90, draw: 1, oncePerTurn: true }],
...
const baseOphanim: OphanimDefinition[] = [
  ...
  buildOphanim({
    ...
    description: 'Gain 3 Undertow; Look at the top 6 cards of your deck; take 2 Base Eternal Seas cards, place the rest on the bottom',
    rarity: 'Epic',
  ...
  buildOphanim({
    ...
    description: 'Gain 4 Undertow; Gain 2 Foam; Search your deck for a Base Eternal Seas Ophanim and add it to hand',
    rarity: 'Legendary',
  ...
  buildOphanim({
    ...
    description: 'Gain 5 Undertow; Release up to 3 Undertow (+120 Oblivion per Undertow; +1 Foam per Undertow spent). If 3 Undertow were released, salvage a Base Eternal Seas Cherubim from discard',
    rarity: 'Legendary',
...
const baseAngels: AngelDefinition[] = [
  ...
  buildAngel({
    ...
    description: 'On summon: Gain 7 Undertow. After 4 cards played: Release up to 5 Undertow (+150 Oblivion per Undertow; +1 Foam per Undertow spent). While on board: +30 Oblivion for each Seraphim on board while on board.',
    rarity: 'Legendary',
    ...
    activatedAbility: {
      ...
      description: 'Salvage a Base Eternal Seas Ophanim from discard, then gain 2 Undertow',
  ...
  buildAngel({
    ...
    description: 'On summon: Gain 8 Undertow; Gain 3 Foam. After 4 cards played: Release up to 7 Undertow (+170 Oblivion per Undertow; +1 Foam per Undertow spent). While on board: +18 power for each Seraphim on board while on board.',
    rarity: 'Legendary',
...
const eternalCards: CardDefinition[] = [
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 7 Undertow; Gain 2 Deepwake; Gain 1 Foam. While on board: Seraphim bonuses are amplified by +0.16.',
    rarity: 'Eternal',
  ...
  buildOphanim({
    ...
    description: 'Gain 4 Undertow; Gain 1 Deepwake; Surge up to 1 Deepwake (+1 Undertow per Deepwake, then release up to 4 Undertow at +136 Oblivion per Undertow with +32 per Deepwake; +1 Foam per Deepwake). If tide is balanced, draw 1 card.',
    rarity: 'Eternal',
...
const infinityCards: CardDefinition[] = [
  ...
  buildOphanim({
    ...
    description: 'Gain 12 Undertow; Gain 5 Deepwake; Draw 1 card. If tide is imbalanced by 6 or more, gain +3 Foam.',
    rarity: 'Infinite',
  ...
  buildCherubim({
    ...
    description: 'On play: Gain 6 Undertow; Gain 2 Deepwake; Surge up to 1 Deepwake (+2 Undertow per Deepwake, then release up to 2 Undertow at +150 Oblivion per Undertow with +44 per Deepwake; +2 Foam per Deepwake). While on board: Buffs Seraphim and Angel attacks: base +122; Seraphim bonuses are amplified by +0.22.',
    rarity: 'Infinite',
  ...
  buildAngel({
    ...
    description: 'On summon: Gain 8 Undertow; Gain 4 Deepwake; Gain 3 Foam. After 4 cards played: Surge up to 9999 Deepwake (+3 Undertow per Deepwake, then release all Undertow at +200 Oblivion per Undertow with +46 per Deepwake; +2 Foam per Deepwake). While on board: +30 power for each Seraphim on board while on board.',
    rarity: 'Infinite',
    ...
    activatedAbility: {
      ...
      cardsPlayedRequirement: 4,
      description: 'Spend 3 Deepwake and 3 Foam; surge up to 9999 Deepwake (+3 Undertow per Deepwake, then release all Undertow at +200 Oblivion per Undertow with +46 per Deepwake; +2 Foam per Deepwake)',
