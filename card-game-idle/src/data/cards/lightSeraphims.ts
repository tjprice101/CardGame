...
export const lightSeraphims: SeraphimDefinition[] = [
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '186 base Oblivion · 5 cards cooldown · chain +0.98 · Cost: spend 25 Radiance',
        baseOblivion: 225,
        cooldownCards: 4,
        chainScaling: 1.18,
        costs: [],
      ...
      synergized: {
        ...
        description: '284 base Oblivion · 8 cards cooldown · chain +1.53 · Requires Angel',
        baseOblivion: 383,
        cooldownCards: 5,
        chainScaling: 1.34,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '184 base Oblivion · 5 cards cooldown · chain +1.08 · Cost: spend 25 Radiance',
        baseOblivion: 225,
        cooldownCards: 4,
        chainScaling: 1.18,
        costs: [],
      ...
      synergized: {
        ...
        description: '280 base Oblivion · 8 cards cooldown · chain +1.38 · Requires Angel',
        baseOblivion: 383,
        cooldownCards: 5,
        chainScaling: 1.34,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '213 base Oblivion · 2 cards cooldown · chain +1.24 · Cost: spend 25 Radiance',
        baseOblivion: 335,
        cooldownCards: 4,
        chainScaling: 1.24,
        costs: [],
      ...
      synergized: {
        ...
        description: '324 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
        baseOblivion: 570,
        cooldownCards: 5,
        chainScaling: 1.40,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '262 base Oblivion · 5 cards cooldown · chain +1.10 · Cost: spend 25 Radiance',
        baseOblivion: 350,
        cooldownCards: 4,
        chainScaling: 1.24,
        costs: [],
      ...
      synergized: {
        ...
        description: '399 base Oblivion · 8 cards cooldown · chain +1.41 · Requires Angel',
        baseOblivion: 595,
        cooldownCards: 5,
        chainScaling: 1.40,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '289 base Oblivion · 5 cards cooldown · chain +1.02 · Cost: spend 25 Radiance',
        baseOblivion: 570,
        cooldownCards: 5,
        chainScaling: 1.32,
        costs: [],
      ...
      synergized: {
        ...
        description: '439 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
        baseOblivion: 969,
        cooldownCards: 6,
        chainScaling: 1.48,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '244 base Oblivion · 2 cards cooldown · chain +1.25 · Cost: spend 25 Radiance',
        baseOblivion: 530,
        cooldownCards: 5,
        chainScaling: 1.32,
        costs: [],
      ...
      synergized: {
        ...
        description: '371 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
        baseOblivion: 901,
        cooldownCards: 6,
        chainScaling: 1.48,
        costs: [],
