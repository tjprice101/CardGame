...
export const mechanicalDreamsSeraphims: SeraphimDefinition[] = [
  {
    ...
    attacks: {
      ...
      synergized: {
        ...
        description: '401 base Oblivion · 5 cards cooldown · Requires Angel',
        baseOblivion: 401,
        cooldownCards: 5,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '266 base Oblivion · 4 cards cooldown',
        baseOblivion: 266,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'mechanical'],
      ...
      synergized: {
        ...
        description: '452 base Oblivion · 5 cards cooldown · Requires Angel',
        baseOblivion: 452,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '413 base Oblivion · 4 cards cooldown',
        baseOblivion: 413,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'mechanical'],
      ...
      synergized: {
        ...
        description: '702 base Oblivion · 5 cards cooldown · Requires Angel',
        baseOblivion: 702,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '401 base Oblivion · 4 cards cooldown',
        baseOblivion: 401,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'mechanical'],
      ...
      synergized: {
        ...
        description: '682 base Oblivion · 5 cards cooldown · Requires Angel',
        baseOblivion: 682,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '661 base Oblivion · 5 cards cooldown',
        baseOblivion: 661,
        cooldownCards: 5,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'mechanical'],
      ...
      synergized: {
        ...
        description: '1123 base Oblivion · 6 cards cooldown · Requires Angel',
        baseOblivion: 1123,
        cooldownCards: 6,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '1115 base Oblivion · 5 cards cooldown',
        baseOblivion: 1115,
        cooldownCards: 5,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'mechanical'],
      ...
      synergized: {
        ...
        description: '1896 base Oblivion · 6 cards cooldown · Requires Angel',
        baseOblivion: 1896,
        cooldownCards: 6,
        costs: [],
        requiresAngelOnBoard: true,
...
export const mechanicalDreamsOphanims: OphanimDefinition[] = [
  {
    ...
    description: 'Gain 3 Strain; +60 Oblivion; If you control 1+ active Seraphim, Draw 2 cards',
  ...
  },
  {
    ...
    description: 'Gain 4 Strain; +150 Oblivion; If you have 8+ Strain, +160 Oblivion; Draw 1 card',
