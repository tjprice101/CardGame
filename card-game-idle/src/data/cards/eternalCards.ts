...
export const eternalSeraphimCards: SeraphimDefinition[] = [
  {
    ...
    rarity: 'Eternal',
    name: 'Eternal Vigil',
    description: 'On play: All Seraphim on board gain +3 Patience; Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); +80 Oblivion; If this is the first card you played this turn, All Seraphim on board gain +2 Patience. While on board: +35 Oblivion per card played while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion',
...
export const expansionEternalCards: Array<OphanimDefinition | SeraphimDefinition | CherubimDefinition | AngelDefinition> = [
  {
    ...
    rarity: 'Eternal',
    name: 'Paradox Throne',
    description: '+0 Oblivion; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Look at the top 8 cards, take 2 cards, put 2 cards on the bottom, and discard the rest; If this is the first card you played this turn, All Seraphim on board gain +6 Patience; Empower the next card you play; If you have played 1+ cards this turn, +700 Oblivion',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Void Exchequer',
    description: 'On play: All Seraphim on board gain +2 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Shuffle discard into deck; +200 Oblivion. While on board: Adjacent Seraphim gain +5 Patience per card played; All Oblivion gain +4%',
  ...
  },
  {
    ...
    activatedAbility: {
      ...
      description: 'Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +3 Patience; Empower the next card you play; +1400 Oblivion',
