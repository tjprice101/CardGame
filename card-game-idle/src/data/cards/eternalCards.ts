...
export const eternalChaosCards: ChaosDefinition[] = [
  {
    ...
    description: 'Enthalpy: +150 Oblivion and draw 2 cards. While active: adjacent Seraphim in synergy gain +80 Oblivion per card played. Entropy (right-click in hand): set chain floor to ×3.0, then +150 Oblivion.',
  ...
  },
  {
    ...
    description: 'Enthalpy: +250 Oblivion, draw 3 cards, and set chain floor to ×4.0. While active: adjacent Seraphim in synergy gain +110 Oblivion per card played and +0.05 chain growth. Entropy (right-click in hand): set chain floor to ×4.5, then +250 Oblivion.',
...
export const expansionEternalCards: Array<SeekerDefinition | SeraphimDefinition | ChaosDefinition | AngelDefinition> = [
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Void Exchequer',
    description: 'Enthalpy: draw 2 and set chain floor to ×3.8. While active: adjacent Seraphim have doubled chaos payouts. Entropy (right-click in hand): draw 2 and shuffle discard into deck.',
  ...
  },
  {
    ...
    description: 'Enthalpy: draw 3 and set chain floor to ×4.2. While active: adjacent Seraphim gain +90 Oblivion per card and +0.12 chain growth. Entropy (right-click in hand): +1200 Oblivion.',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Choral Tyrant',
    description: 'Enthalpy: salvage a Seeker and draw 2. While active: adjacent Seraphim gain +140 Oblivion on Seeker plays. Entropy (right-click in hand): draw 3.',
  ...
  },
  {
    ...
    description: 'Enthalpy: discard 2 then draw 4. While active: adjacent Seraphim gain +120 Oblivion per card. Entropy (right-click in hand): set chain floor ×6.2.',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Brass Tribunal',
    description: 'Enthalpy: gain 2 Strain and draw 2. While active: adjacent Seraphim bonus is doubled and chain growth +0.08. Entropy (right-click in hand): vent all Strain and draw 2.',
  ...
  },
  {
    ...
    description: 'Enthalpy: draw 2 and salvage any 1 card. While active: adjacent Seraphim gain +135 Oblivion on Seeker plays and +0.09 chain growth. Entropy (right-click in hand): set chain floor to ×5.6.',
