...
export const eternalOphanimCards: OphanimDefinition[] = [
  {
    ...
    rarity: 'Eternal',
    name: "Void's Reaping",
    description: 'All Seraphim on board gain +6 Patience; Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); Salvage any 1 card',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Temporal Ruin',
    description: 'All Seraphim on board gain +4 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Shuffle discard into deck; If this is the first card you played this turn, All Seraphim on board gain +6 Patience; +400 Oblivion',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Null Edict',
    description: 'All Seraphim on board gain +7 Patience; Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Empower the next card you play; +350 Oblivion',
  ...
  },
  {
    ...
    description: 'All Seraphim on board gain +12 Patience; Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); If you have played 2+ cards this turn, Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); +1000 Oblivion',
...
export const eternalSeraphimCards: SeraphimDefinition[] = [
  {
    ...
    rarity: 'Eternal',
    name: 'Eternal Vigil',
    description: 'On play: All Seraphim on board gain +5 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); +120 Oblivion; If this is the first card you played this turn, All Seraphim on board gain +3 Patience. While on board: +50 Oblivion per card played while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion',
    ...
    onPlayEffects: [
      ...
      { type: 'conditional', condition: { type: 'first_card_this_turn' }, then: [{ type: 'patience_gain_all', value: 3 }] }],
  },
  {
...
export const eternalCherubimCards: CherubimDefinition[] = [
  {
    ...
    description: 'On play: All Seraphim on board gain +4 Patience; Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); Salvage any 1 card; +300 Oblivion. While on board: Adjacent Seraphim gain +4 Patience per card played',
  ...
  },
  {
    ...
    description: 'On play: All Seraphim on board gain +6 Patience; Grant 4 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Look at the top 6 cards, take 2 cards, put 1 card on the bottom, and discard the rest; +500 Oblivion. While on board: Adjacent Seraphim gain +5 Patience per card played',
    artKey: 'btei_architects_manifold',
    effects: [{ type: 'cherubim_patience_per_card', value: 5 }],
    onPlayEffects: [{ type: 'patience_gain_all', value: 6 }, { type: 'neutrality_patient_light_gain', value: 4 }, { type: 'look_top_take_drop', look: 6, take: 2, drop: 1 }, { type: 'oblivion_flat', value: 500 }],
  }];
...
export const eternalAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: All Seraphim on board gain +12 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); +300 Oblivion. After 5 cards played: Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +4 Patience; Salvage any 1 card; Empower the next card you play. While on board: +130 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +4 Patience; Salvage any 1 card; Empower the next card you play',
      effects: [
        { type: 'neutrality_patient_light_gain', value: 1 },
        { type: 'patience_gain_all', value: 4 },
        { type: 'salvage_any' },
  ...
  },
  {
    ...
    description: 'On summon: All Seraphim on board gain +8 Patience; Grant 5 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); +600 Oblivion. After 6 cards played: Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +12 Patience; Empower the next card you play; +600 Oblivion. While on board: +200 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +12 Patience; Empower the next card you play; +600 Oblivion',
      effects: [
        { type: 'neutrality_patient_light_gain', value: 1 },
        { type: 'patience_gain_all', value: 12 },
        { type: 'multiply_next' },
...
export const expansionEternalCards: Array<OphanimDefinition | SeraphimDefinition | CherubimDefinition | AngelDefinition> = [
  {
    ...
    rarity: 'Eternal',
    name: 'Paradox Throne',
    description: '+0 Oblivion; Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Look at the top 8 cards, take 2 cards, put 2 cards on the bottom, and discard the rest; If this is the first card you played this turn, All Seraphim on board gain +6 Patience; Empower the next card you play; If you have played 1+ cards this turn, +700 Oblivion',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Void Exchequer',
    description: 'On play: All Seraphim on board gain +2 Patience; Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Shuffle discard into deck; +200 Oblivion. While on board: Adjacent Seraphim gain +5 Patience per card played; All Oblivion gain +4%',
    ...
    onPlayEffects: [{ type: 'patience_gain_all', value: 2 }, { type: 'neutrality_patient_light_gain', value: 3 }, { type: 'shuffle_discard' }, { type: 'oblivion_flat', value: 200 }],
  },
  {
    ...
    description: 'On play: All Seraphim on board gain +8 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Salvage any 1 card; If you have played 1+ cards this turn, All Seraphim on board gain +4 Patience; +500 Oblivion. While on board: +180 Oblivion whenever you play an Ophanim while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Axiom Maw',
    description: 'On summon: All Seraphim on board gain +10 Patience; Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); +400 Oblivion. After 4 cards played: Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +3 Patience; Empower the next card you play; +1400 Oblivion. While on board: +190 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); All Seraphim on board gain +3 Patience; Empower the next card you play; +1400 Oblivion',
      effects: [{ type: 'neutrality_patient_light_gain', value: 3 }, { type: 'patience_gain_all', value: 3 }, { type: 'multiply_next' }, { type: 'oblivion_flat', value: 1400 }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    description: 'All Seraphim on board gain +2 Patience; Grant 2 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); If this is the first card you played this turn, Grant 3 Patient Light stacks (card-play Patience gain becomes 1 + Patient Light stacks); Empower the next card you play; +1000 Oblivion; If you have played 1+ cards this turn, All Seraphim on board gain +7 Patience; Grant 1 Patient Light stack (card-play Patience gain becomes 1 + Patient Light stacks); Salvage any 1 card; +500 Oblivion',
    artKey: 'btei_neutrality_prime_equilibrium',
    effects: [
      { type: 'patience_gain_all', value: 2 },
      { type: 'neutrality_patient_light_gain', value: 2 },
      { type: 'conditional', condition: { type: 'first_card_this_turn' }, then: [{ type: 'neutrality_patient_light_gain', value: 3 }, { type: 'multiply_next' }, { type: 'oblivion_flat', value: 1000 }] },
  ...
  },
  {
    ...
    activatedAbility: {
      ...
      cardsPlayedRequirement: 6,
      description: 'Gain 2 Strain; Gain 5 Radiance; Gain 8 Arctic Charge; Empower the next card you play; +320 Oblivion; Discharge Arctic Charge; Release all Polar Capacitors (Voltage: +290.0 Oblivion per capacitor · Frost: +8.0 Arctic Charge per capacitor)',
  ...
  },
  {
    ...
    activatedAbility: {
      ...
      cardsPlayedRequirement: 6,
      description: 'Gain 2 Strain; Gain 6 Radiance; Gain 8 Arctic Charge; Empower the next card you play; +360 Oblivion; Discharge Arctic Charge; Release all Polar Capacitors (Voltage: +270.0 Oblivion per capacitor · Frost: +9.0 Arctic Charge per capacitor)',
