...
export const expansionEternalCards: Array<OphanimDefinition | SeraphimDefinition | CherubimDefinition | AngelDefinition> = [
  ...
  },
  {
    ...
    description: 'Discard 1 card, then draw 4 cards; Shuffle discard into deck; Set chain multiplier to x3.0',
  ...
  },
  {
    ...
    description: 'Draw 3 cards; +1000 Oblivion; If you have played 4+ cards this turn, +1600 Oblivion; Empower the next card you play',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Choral Tyrant',
    description: 'On play: Salvage 1 card matching Ophanim; Draw 2 cards. While on board: Adjacent active Seraphim gain +140 Oblivion per card played; Buffs Seraphim attacks: base +126, chain scaling +0.08, cooldown -1, multiplier x1.00; Buffs Angel attacks: base +98, chain scaling +0.05, cooldown -1, multiplier x1.00',
    artKey: 'btei_light_choir_imperator',
    effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'oblivion', value: 140 }],
    onPlayEffects: [{ type: 'salvage_by_type', filter: ['Ophanim'] }, { type: 'draw', value: 2 }],
  },
  {
  ...
  },
  {
    ...
    onPlayEffects: [{ type: 'discard_draw', discard: 2, draw: 4 }],
  },
  {
  ...
  },
  {
    ...
    description: 'Draw 5 cards; Gain +160% total Oblivion this turn; Empower the next card you play',
