...
export const eternalAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: All Seraphim gain +100 Patience and +1 Patience. After 5 cards: gain +1 Patience and salvage 1 card. While on board: +10 Oblivion per card played. Unlocks Convergent Refrain (replaces Slot 1).',
  ...
  },
  {
    ...
    description: 'On summon: All Seraphim gain +8 and +3 Patience; gain 600 Oblivion. After 6 cards: gain +1 and +12 Patience, preserve 30% of consumed Patience, and gain 1000 Oblivion. While on board: +200 Oblivion per card played. Unlocks Parallax Verdict (replaces Slot 2).',
...
export const expansionEternalCards: Array<OphanimDefinition | SeraphimDefinition | CherubimDefinition | AngelDefinition> = [
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Axiom Maw',
    description: 'On summon: All Seraphim gain +10 and +1 Patience; gain 1400 Oblivion. After 4 cards: gain +2 Patience, double Patience, gain +3 Patience, and gain 1500 Oblivion. While on board: +125 Oblivion per card played. Unlocks Axiomatic Devour (replaces Slot 1).',
