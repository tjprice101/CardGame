...
export const eternalOphanimCards: OphanimDefinition[] = [
  {
    ...
    rarity: 'Eternal',
    name: "Void's Reaping",
    description: 'All Seraphim on board gain +3 Patience; Designate the Seraphim with the highest Patience as your Vessel; Your Vessel copies 30% of Patience gained by other Seraphim this turn; Draw 3 cards',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Temporal Ruin',
    description: 'Mark up to 3 other cards in hand; marked cards grant +2 Patience to all Seraphim when played; All Seraphim on board gain +4 Patience; Draw 3 cards; +500 Oblivion',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Null Edict',
    description: 'All Seraphim on board gain +5 Patience; Designate the Seraphim with the highest Patience as your Vessel; Redistribute up to 8 Vessel Patience across your other Seraphim; Draw 4 cards; +700 Oblivion',
  ...
  },
  {
    ...
    description: 'All Seraphim on board gain +6 Patience; Seraphim attacks preserve 30% of consumed Patience this turn; Seraphim bonuses are amplified by +0.3; Draw 5 cards; +1000 Oblivion',
...
export const eternalSeraphimCards: SeraphimDefinition[] = [
  {
    ...
    rarity: 'Eternal',
    name: 'Eternal Vigil',
    description: 'On play: All Seraphim on board gain +4 Patience; Designate the Seraphim with the highest Patience as your Vessel; Your Vessel copies 25% of Patience gained by other Seraphim this turn; +120 Oblivion; Draw 2 cards. While on board: +50 Oblivion per card played while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion; if Patience ≥ 6 on attack, also draw 3 cards',
  ...
  },
  {
    ...
    description: 'On play: All Seraphim on board gain +6 Patience; Link Seraphim this turn: patience gains grant +1 extra to all linked Seraphim and non-attacking linked Seraphim retain 25% Patience after each linked attack; +350 Oblivion; Draw 3 cards. While on board: +200 Oblivion per card played while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion; if Patience ≥ 6 on attack, also draw 3 cards',
...
export const eternalCherubimCards: CherubimDefinition[] = [
  {
    ...
    description: 'On play: All Seraphim on board gain +3 Patience; Seraphim bonuses are amplified by +0.25; +300 Oblivion; Draw 2 cards. While on board: Adjacent Seraphim gain +4 Patience per card played',
    ...
    onPlayEffects: [{ type: 'patience_gain_all', value: 3 }, { type: 'seraphim_bonus_amplifier', value: 0.25 }, { type: 'oblivion_flat', value: 300 }, { type: 'draw', value: 2 }],
  },
  {
    ...
    description: 'On play: All Seraphim on board gain +4 Patience; Designate the Seraphim with the highest Patience as your Vessel; Redistribute up to 6 Vessel Patience across your other Seraphim; +500 Oblivion; Draw 3 cards. While on board: Adjacent Seraphim gain +5 Patience per card played',
    ...
    onPlayEffects: [{ type: 'patience_gain_all', value: 4 }, { type: 'neutrality_designate_vessel' }, { type: 'neutrality_vessel_redistribute', value: 6 }, { type: 'oblivion_flat', value: 500 }, { type: 'draw', value: 3 }],
  }];
...
export const eternalAngels: AngelDefinition[] = [
  {
    ...
    activatedAbility: {
      ...
      description: 'Double all Patience on the board; Redistribute up to 10 Vessel Patience across your other Seraphim; Draw 3 cards; Empower the next card you play',
      effects: [
  ...
  },
  {
    ...
    description: 'On summon: All Seraphim on board gain +10 Patience; Mark up to 4 other cards in hand; marked cards grant +3 Patience to all Seraphim when played; Draw 4 cards. After 6 cards played: Double all Patience on the board; Seraphim attacks preserve 40% of consumed Patience this turn; Draw 4 cards; Empower the next card you play; +600 Oblivion. While on board: +200 Oblivion per card played while on board',
    ...
    activatedAbility: {
      ...
      description: 'Double all Patience on the board; Seraphim attacks preserve 40% of consumed Patience this turn; Draw 4 cards; Empower the next card you play; +600 Oblivion',
      effects: [
        { type: 'patience_double_all' },
...
export const expansionEternalCards: Array<OphanimDefinition | SeraphimDefinition | CherubimDefinition | AngelDefinition> = [
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Void Exchequer',
    description: 'On play: All Seraphim on board gain +3 Patience; Mark up to 2 other cards in hand; marked cards grant +2 Patience to all Seraphim when played; Draw 2 cards. While on board: Adjacent Seraphim gain +5 Patience per card played',
    ...
    effects: [{ type: 'cherubim_patience_per_card', value: 5 }],
    onPlayEffects: [{ type: 'patience_gain_all', value: 3 }, { type: 'neutrality_mark_hand', count: 2, patience: 2 }, { type: 'draw', value: 2 }],
  },
  {
    ...
    description: 'On play: All Seraphim on board gain +4 Patience; After each Seraphim attack this turn, restore 20% of consumed Patience to that attacker; Draw 2 cards; Salvage any 1 card. While on board: +180 Oblivion whenever you play an Ophanim while active. Patience: +1 stack per card played; on attack, each stack → +15 Oblivion; if Patience ≥ 6 on attack, also draw 3 cards',
    ...
    onPlayEffects: [{ type: 'patience_gain_all', value: 4 }, { type: 'neutrality_attack_restore', percent: 20 }, { type: 'draw', value: 2 }, { type: 'salvage_any' }],
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Axiom Maw',
    description: 'On summon: All Seraphim on board gain +6 Patience; Link Seraphim this turn: patience gains grant +2 extra to all linked Seraphim and non-attacking linked Seraphim retain 30% Patience after each linked attack; Draw 3 cards; Empower the next card you play. After 4 cards played: Double all Patience on the board; After each Seraphim attack this turn, restore 35% of consumed Patience to that attacker; Discard 2 cards, then draw 5 cards; +1400 Oblivion. While on board: +190 Oblivion per card played while on board',
    ...
    onSummonEffects: [{ type: 'patience_gain_all', value: 6 }, { type: 'neutrality_linked_mode', gain: 2, retainPercent: 30 }, { type: 'draw', value: 3 }, { type: 'multiply_next' }],
    activatedAbility: {
      name: 'Axiom Devour',
      cardsPlayedRequirement: 4,
      description: 'Double all Patience on the board; After each Seraphim attack this turn, restore 35% of consumed Patience to that attacker; Discard 2 cards, then draw 5 cards; +1400 Oblivion',
      effects: [{ type: 'patience_double_all' }, { type: 'neutrality_attack_restore', percent: 35 }, { type: 'discard_draw', discard: 2, draw: 5 }, { type: 'oblivion_flat', value: 1400 }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    description: 'All Seraphim on board gain +3 Patience; If this is the first card you played this turn, Mark up to 3 other cards in hand; marked cards grant +3 Patience to all Seraphim when played; Draw 3 cards; +1000 Oblivion; If you have played 1+ cards this turn, Designate the Seraphim with the highest Patience as your Vessel; Redistribute up to 4 Vessel Patience across your other Seraphim; Draw 2 cards; +500 Oblivion',
  ...
  },
  {
    ...
    description: 'On play: Gain 18 Embers; Stoke 10 Furnace Pressure; Gain 2 Inferno Tiers; Gain 1 Cinder Echo; Draw 3 cards. While on board: Adjacent active Seraphim gain +90 Oblivion per card played',
    ...
    onPlayEffects: [{ type: 'ember_gain', value: 18 }, { type: 'pyro_furnace_pressure_gain', value: 10 }, { type: 'eternal_stack_gain', stack: 'pyro', value: 2 }, { type: 'set_secondary_gain', kind: 'pyro', value: 1 }, { type: 'draw', value: 3 }],
  },
  {
    ...
    description: 'Gain 22 Embers; Stoke 12 Furnace Pressure; Open 1 Ruin Window; If Furnace Pressure is 10+, Gain 3 Inferno Tiers; Gain 2 Cinder Echoes; Ignite up to 1 Cinder Echoes (+80.0 Oblivion × echoes²); Discard 1 card, then draw 4 cards; Shuffle discard into deck',
  ...
  },
  {
    ...
    onPlayEffects: [{ type: 'ember_gain', value: 18 }, { type: 'pyro_furnace_pressure_gain', value: 14 }, { type: 'pyro_abyss_fault_gain', value: 6 }, { type: 'draw', value: 3 }, { type: 'multiply_next' }, { type: 'conditional', condition: { type: 'eternal_stack_gte', stack: 'pyro', value: 3 }, then: [{ type: 'eternal_stack_spend', stack: 'pyro', value: 3 }, { type: 'set_secondary_gain', kind: 'pyro', value: 2 }, { type: 'pyro_cinder_echo_ignite', oblivionPerEchoSquared: 120, consume: 2 }, { type: 'multiply_next' }] }],
  },
  {
    ...
    description: 'On summon: Gain 28 Embers; Stoke 18 Furnace Pressure; Open 2 Ruin Windows; Gain 4 Inferno Tiers; Gain 3 Cinder Echoes; Draw 4 cards. After 5 cards played: Convert Pressure to Fault (12 Pressure per Fault, gain 12 up to 24); Cash out all Inferno Tiers (+400 Oblivion per stack); Ignite all Cinder Echoes (+150.0 Oblivion × echoes²); Search your deck for 1 matching Ophanim or Cherubim; Draw 2 cards; Empower the next card you play. While on board: +175 Oblivion per card played while on board',
    ...
    onSummonEffects: [{ type: 'ember_gain', value: 28 }, { type: 'pyro_furnace_pressure_gain', value: 18 }, { type: 'pyro_ruin_window_gain', value: 2 }, { type: 'eternal_stack_gain', stack: 'pyro', value: 4 }, { type: 'set_secondary_gain', kind: 'pyro', value: 3 }, { type: 'draw', value: 4 }],
    activatedAbility: {
      name: 'Rift Verdict',
      cardsPlayedRequirement: 5,
      description: 'Convert Pressure to Fault (12 Pressure per Fault, gain 12 up to 24); Cash out all Inferno Tiers (+400 Oblivion per stack); Ignite all Cinder Echoes (+150.0 Oblivion × echoes²); Search your deck for 1 matching Ophanim or Cherubim; Draw 2 cards; Empower the next card you play',
      effects: [{ type: 'pyro_convert_pressure_to_fault', pressurePerFault: 12, faultGain: 12, maxFaultGain: 24 }, { type: 'eternal_stack_cashout', stack: 'pyro', oblivionPerStack: 400 }, { type: 'pyro_cinder_echo_ignite', oblivionPerEchoSquared: 150 }, { type: 'search_deck_by_type', filter: ['Ophanim', 'Cherubim'] }, { type: 'draw', value: 2 }, { type: 'multiply_next' }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Aurora Throne',
    description: 'Gain 22 Radiance; Gain 2 Resonance; Gain 1 Anchor; If you have 1+ Chorus Anchors, Gain 1 Halo Crown; Gain 1 Halo Cascade; If you have 2+ Chorus Anchors, Gain 1 Halo Crown; Gain 1 Halo Cascade; If you have 3+ Chorus Anchors, Gain 1 Halo Crown; Gain 1 Halo Cascade; If you have 4+ Chorus Anchors, Gain 1 Halo Crown; Gain 1 Halo Cascade; Look at the top 7 cards and take 1 matching Ophanim or Seraphim; Draw 1 card',
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Choral Tyrant',
    description: 'On play: Gain 14 Radiance; Gain 1 Anchor; Gain 2 Halo Crowns; Gain 2 Halo Cascades; Salvage 1 card matching Ophanim; Draw 2 cards. While on board: All Oblivion gain +12%',
  ...
  },
  {
    ...
    description: 'On summon: Gain 28 Radiance; Gain 3 Resonance; Gain 1 Anchor; Gain 4 Halo Crowns; Gain 3 Halo Cascades; Draw 5 cards. After 6 cards played: Double current Radiance; Gain 3 Resonance; Gain 1 Anchor; Cash out all Halo Crowns (+450 Oblivion per stack); Resound all Halo Cascades (cascade bonus per cascade); Draw 3 cards; +1800 Oblivion. While on board: +210 Oblivion per card played while on board',
    ...
    onSummonEffects: [{ type: 'radiance_gain', value: 28 }, { type: 'light_resonance_gain', value: 3 }, { type: 'light_anchor_gain', value: 1 }, { type: 'eternal_stack_gain', stack: 'light', value: 4 }, { type: 'set_secondary_gain', kind: 'light', value: 3 }, { type: 'draw', value: 5 }],
    activatedAbility: {
      name: 'Dominion Hymn',
      cardsPlayedRequirement: 6,
      description: 'Double current Radiance; Gain 3 Resonance; Gain 1 Anchor; Cash out all Halo Crowns (+450 Oblivion per stack); Resound all Halo Cascades (cascade bonus per cascade); Draw 3 cards; +1800 Oblivion',
      effects: [{ type: 'radiance_double' }, { type: 'light_resonance_gain', value: 3 }, { type: 'light_anchor_gain', value: 1 }, { type: 'eternal_stack_cashout', stack: 'light', oblivionPerStack: 450 }, { type: 'light_halo_cascade_resound', oblivionPerCascade: 300 }, { type: 'draw', value: 3 }, { type: 'oblivion_flat', value: 1800 }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    description: 'Gain 25 Trail; Gain 2 Thorncrowns; Gain 1 Briar Spiral; Salvage any 1 card; Draw 3 cards; If you have 60+ Trail, Spend 25 Trail; +1400 Oblivion; Empower the next card you play',
  ...
  },
  {
    ...
    description: 'On play: Gain 28 Trail; Gain 2 Thorncrowns; Gain 1 Briar Spiral; Draw 1 card; Gain +90% total Oblivion this turn; If you have 4+ Thorncrowns, Spend 4 Thorncrowns; +1600 Oblivion; Bloom up to 1 Briar Spirals (+25 Trail per spiral); Empower the next card you play; If you have 70+ Trail, Spend 30 Trail; Empower the next card you play; +1000 Oblivion. While on board: Each new Cherubim summoned while active gains +1 durability',
  ...
  },
  {
    ...
    activatedAbility: {
      name: 'Dirge Corridor',
      cardsPlayedRequirement: 5,
      description: 'Spend 50 Trail; Cash out all Thorncrowns (+500 Oblivion per stack); Bloom all Briar Spirals (+30 Trail per spiral); Salvage any 1 card; Draw 3 cards; +1800 Oblivion; If you have 80+ Trail, Empower the next card you play; +1500 Oblivion',
      ...
      effects: [{ type: 'trail_spend', value: 50 }, { type: 'eternal_stack_cashout', stack: 'thorn', oblivionPerStack: 500 }, { type: 'thorn_briar_spiral_bloom', trailPerSpiral: 30, oblivionPerTrail: 125 }, { type: 'salvage_any' }, { type: 'draw', value: 3 }, { type: 'oblivion_flat', value: 1800 }, { type: 'conditional', condition: { type: 'trail_gte', value: 80 }, then: [{ type: 'multiply_next' }, { type: 'oblivion_flat', value: 1500 }] }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    description: 'Gain 40 Trail; Gain 4 Thorncrowns; Gain 2 Briar Spirals; Draw 5 cards; Gain +160% total Oblivion this turn; If you have 5+ Thorncrowns, Cash out all Thorncrowns (+550 Oblivion per stack); Bloom all Briar Spirals (+35 Trail per spiral); Empower the next card you play',
  ...
  },
  {
    ...
    description: 'On play: Gain 2 Strain; Gain 1 Reactor Core; Gain 1 Reactor Flux; If you have 4+ Strain, Gain 2 Reactor Cores; Gain 1 Reactor Flux; Draw 2 cards. While on board: +220 Oblivion per card played while active',
    ...
    onPlayEffects: [{ type: 'strain_gain', value: 2 }, { type: 'eternal_stack_gain', stack: 'mech', value: 1 }, { type: 'set_secondary_gain', kind: 'mech', value: 1 }, { type: 'conditional', condition: { type: 'strain_gte', value: 4 }, then: [{ type: 'eternal_stack_gain', stack: 'mech', value: 2 }, { type: 'set_secondary_gain', kind: 'mech', value: 1 }] }, { type: 'draw', value: 2 }],
  },
  {
  ...
  },
  {
    ...
    description: 'On summon: Overclock: gain 2 Strain, then Draw 3 cards; Gain 4 Reactor Cores; Gain 2 Reactor Flux. After 5 cards played: Vent 9999 Strain; Cash out all Reactor Cores (+500 Oblivion per stack); Vent all Reactor Flux (consume matching Strain: +700.0 Oblivion per Strain vented, +0.2% score per flux); Draw 4 cards; +1700 Oblivion. While on board: +230 Oblivion per card played while on board',
    ...
    onSummonEffects: [{ type: 'overclock', strain: 2, then: [{ type: 'draw', value: 3 }, { type: 'eternal_stack_gain', stack: 'mech', value: 4 }, { type: 'set_secondary_gain', kind: 'mech', value: 2 }] }],
    activatedAbility: {
      name: 'Terminal Vent',
      cardsPlayedRequirement: 5,
      description: 'Vent 9999 Strain; Cash out all Reactor Cores (+500 Oblivion per stack); Vent all Reactor Flux (consume matching Strain: +700.0 Oblivion per Strain vented, +0.2% score per flux); Draw 4 cards; +1700 Oblivion',
      // Role: APEX VENT. Activated ability vents ALL Reactor Flux at high oblivionPerFlux.
      effects: [{ type: 'strain_vent', value: 9999 }, { type: 'eternal_stack_cashout', stack: 'mech', oblivionPerStack: 500 }, { type: 'mech_reactor_flux_vent', oblivionPerFlux: 700, scoreMultPerFlux: 0.20 }, { type: 'draw', value: 4 }, { type: 'oblivion_flat', value: 1700 }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    effects: [
      { type: 'overclock', strain: 4, then: [{ type: 'draw', value: 6 }, { type: 'eternal_stack_gain', stack: 'mech', value: 5 }, { type: 'set_secondary_gain', kind: 'mech', value: 2 }, { type: 'oblivion_flat', value: 2200 }] },
  ...
  },
  {
    ...
    description: 'Gain 20 Prismatic Light; Gain 2 Mirror Chain links; Gain 1 Spectrum Echo; Look at the top 8 cards, take 2 cards, put 2 cards on the bottom, and discard the rest; Draw 1 card',
    artKey: 'btei_prismatic_vorthum_edict',
    // Role: PASSIVE SPECTRUM ECHO BATTERY. +1 Spectrum Echo on play; never refracts.
    effects: [{ type: 'prismatic_light_gain', value: 20 }, { type: 'eternal_stack_gain', stack: 'prism', value: 2 }, { type: 'set_secondary_gain', kind: 'prism', value: 1 }, { type: 'look_top_take_drop', look: 8, take: 2, drop: 2 }, { type: 'draw', value: 1 }],
  },
  {
    ...
    description: 'On play: Gain 20 Prismatic Light; Gain 1 Mirror Chain link; Gain 1 Spectrum Echo; If you have played 3+ distinct channels this turn, Gain 2 Mirror Chain links; Gain 1 Spectrum Echo; Draw 2 cards; Salvage any 1 card. While on board: Adjacent active Seraphim gain +135 Oblivion per card played',
  ...
  },
  {
    ...
    onPlayEffects: [{ type: 'prismatic_light_gain', value: 20 }, { type: 'eternal_stack_gain', stack: 'prism', value: 2 }, { type: 'set_secondary_gain', kind: 'prism', value: 1 }, { type: 'conditional', condition: { type: 'eternal_stack_gte', stack: 'prism', value: 4 }, then: [{ type: 'eternal_stack_spend', stack: 'prism', value: 4 }, { type: 'oblivion_flat', value: 1500 }, { type: 'prism_spectrum_echo_refract', oblivionPerEchoPerChannel: 350, consume: 1 }, { type: 'multiply_next' }] }, { type: 'draw', value: 3 }],
  },
  {
    ...
    activatedAbility: {
      ...
      cardsPlayedRequirement: 5,
      description: 'Cash out all Mirror Chain links (+550 Oblivion per stack); Refract all Spectrum Echoes (+220.0 Oblivion per echo × distinct channels); Salvage any 1 card; Draw 3 cards; Empower the next card you play; +1600 Oblivion',
      ...
      effects: [{ type: 'eternal_stack_cashout', stack: 'prism', oblivionPerStack: 550 }, { type: 'prism_spectrum_echo_refract', oblivionPerEchoPerChannel: 220 }, { type: 'salvage_any' }, { type: 'draw', value: 3 }, { type: 'multiply_next' }, { type: 'oblivion_flat', value: 1600 }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    description: 'Gain 6 White Flame; Gain 6 Black Flame; Gain 4 Eclipse Marks; Gain 1 Veil Shard; Gain 10 Monochromatic Shards; Discard 2 cards, then draw 4 cards; +1200 Oblivion; If White Flame equals Black Flame, Cash out all Eclipse Marks (+550 Oblivion per stack); +1200 Oblivion',
  ...
  },
  {
    ...
    description: 'Gain 10 Black Flame; Gain 3 Fracture; Gain 5 Eclipse Marks; Gain 2 Veil Shards; Gain 8 Monochromatic Shards; Discard 1 card, then draw 5 cards; If you have 6+ Eclipse Marks, Spend 6 Eclipse Marks; +2000 Oblivion; Shatter up to 2 Veil Shards (swap flames, +80.0 Oblivion per higher flame per shard); Empower the next card you play',
    ...
    effects: [{ type: 'black_glass_black_flame_gain', value: 10 }, { type: 'black_glass_fracture_gain', value: 3 }, { type: 'eternal_stack_gain', stack: 'glass', value: 5 }, { type: 'set_secondary_gain', kind: 'glass', value: 2 }, { type: 'monochromatic_shards_gain', value: 8 }, { type: 'discard_draw', discard: 1, draw: 5 }, { type: 'conditional', condition: { type: 'eternal_stack_gte', stack: 'glass', value: 6 }, then: [{ type: 'eternal_stack_spend', stack: 'glass', value: 6 }, { type: 'oblivion_flat', value: 2000 }, { type: 'glass_veil_shard_swap', oblivionPerHigherFlame: 80, consume: 2 }, { type: 'multiply_next' }] }],
  },
  {
  ...
  },
  {
    ...
    description: 'On play: Gain 8 Black Flame; Gain 2 Eclipse Marks; Gain 2 Veil Shards; Gain 8 Monochromatic Shards; Discard 1 card, then draw 3 cards. While on board: +190 Oblivion per card played while active',
    ...
    onPlayEffects: [{ type: 'black_glass_black_flame_gain', value: 8 }, { type: 'eternal_stack_gain', stack: 'glass', value: 2 }, { type: 'set_secondary_gain', kind: 'glass', value: 2 }, { type: 'monochromatic_shards_gain', value: 8 }, { type: 'discard_draw', discard: 1, draw: 3 }],
  },
  {
  ...
  },
  {
    ...
    description: 'On play: Gain 6 Black Flame; Gain 2 Fracture; Gain 3 Eclipse Marks; Gain 3 Veil Shards; Gain 8 Monochromatic Shards; Discard 1 card, then draw 3 cards. While on board: Adjacent active Seraphim gain +110 Oblivion per card played',
    ...
    onPlayEffects: [{ type: 'black_glass_black_flame_gain', value: 6 }, { type: 'black_glass_fracture_gain', value: 2 }, { type: 'eternal_stack_gain', stack: 'glass', value: 3 }, { type: 'set_secondary_gain', kind: 'glass', value: 3 }, { type: 'monochromatic_shards_gain', value: 8 }, { type: 'discard_draw', discard: 1, draw: 3 }],
  },
  {
    ...
    description: 'On summon: Gain 10 White Flame; Gain 10 Black Flame; Gain 4 Eclipse Marks; Gain 2 Veil Shards; Gain 12 Monochromatic Shards; Discard 2 cards, then draw 6 cards; Salvage any 1 card. After 5 cards played: Swap White Flame and Black Flame; Gain 4 Fracture; Cash out all Eclipse Marks (+600 Oblivion per stack); Shatter all Veil Shards (swap flames, +95.0 Oblivion per higher flame per shard); Discard 2 cards, then draw 4 cards; Shuffle discard into deck; +1700 Oblivion; If White Flame equals Black Flame, +1500 Oblivion. While on board: +210 Oblivion per card played while on board',
    artKey: 'btei_bgi_throne_of_cinders',
    summonCost: [],
    extraSummonConditions: [{ type: 'seraphim_on_board_gte', value: 2 }, { type: 'cherubim_active_gte', value: 1 }],
    onSummonEffects: [{ type: 'black_glass_white_flame_gain', value: 10 }, { type: 'black_glass_black_flame_gain', value: 10 }, { type: 'eternal_stack_gain', stack: 'glass', value: 4 }, { type: 'set_secondary_gain', kind: 'glass', value: 2 }, { type: 'monochromatic_shards_gain', value: 12 }, { type: 'discard_draw', discard: 2, draw: 6 }, { type: 'salvage_any' }],
    activatedAbility: {
      name: 'Cinder Decree',
      cardsPlayedRequirement: 5,
      description: 'Swap White Flame and Black Flame; Gain 4 Fracture; Cash out all Eclipse Marks (+600 Oblivion per stack); Shatter all Veil Shards (swap flames, +95.0 Oblivion per higher flame per shard); Discard 2 cards, then draw 4 cards; Shuffle discard into deck; +1700 Oblivion; If White Flame equals Black Flame, +1500 Oblivion',
      ...
      effects: [{ type: 'black_glass_flames_swap' }, { type: 'black_glass_fracture_gain', value: 4 }, { type: 'eternal_stack_cashout', stack: 'glass', oblivionPerStack: 600 }, { type: 'glass_veil_shard_swap', oblivionPerHigherFlame: 95 }, { type: 'discard_draw', discard: 2, draw: 4 }, { type: 'shuffle_discard' }, { type: 'oblivion_flat', value: 1700 }, { type: 'conditional', condition: { type: 'black_glass_flames_equal' }, then: [{ type: 'oblivion_flat', value: 1500 }] }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    activatedAbility: {
      ...
      effects: [{ type: 'black_glass_black_flame_gain', value: 12 }, { type: 'eternal_stack_gain', stack: 'glass', value: 4 }, { type: 'black_glass_fracture_collapse', value: 0.5 }, { type: 'eternal_stack_cashout', stack: 'glass', oblivionPerStack: 650 }, { type: 'glass_veil_shard_swap', oblivionPerHigherFlame: 120 }, { type: 'discard_draw', discard: 2, draw: 4 }, { type: 'salvage_any' }, { type: 'multiply_next' }, { type: 'oblivion_flat', value: 1900 }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'Aurora Nexus',
    description: 'On summon: Gain 8 Radiance; Draw 3 cards; Gain 10 Arctic Charge; Gain 3 Static Pulses. After 5 cards played: Draw 4 cards; Gain 2 Radiance; Gain 5 Arctic Charge. While on board: +260 Oblivion per card played while on board',
    ...
    onSummonEffects: [{ type: 'radiance_gain', value: 8 }, { type: 'draw', value: 3 }, { type: 'arctic_charge_gain', value: 10 }, { type: 'set_secondary_gain', kind: 'snow', value: 3 }],
    activatedAbility: {
      name: 'Aurora Recharge',
      cardsPlayedRequirement: 5,
      description: 'Draw 4 cards; Gain 2 Radiance; Gain 5 Arctic Charge',
      effects: [{ type: 'draw', value: 4 }, { type: 'radiance_gain', value: 2 }, { type: 'arctic_charge_gain', value: 5 }],
    },
    attacks: {
      primary: {
  ...
  },
  {
    ...
    rarity: 'Eternal',
    name: 'White Requiem',
    description: 'On summon: Gain 6 Radiance; Draw 3 cards; Gain 10 Arctic Charge; Gain 1 Static Pulse. After 5 cards played: Draw 4 cards; Gain 2 Strain; +300 Oblivion; Discharge Arctic Charge; Discharge up to 2 Static Pulses (Voltage: +220.0 Oblivion per pulse · Frost: +1.0 draw per pulse). While on board: +280 Oblivion per card played while on board',
    artKey: 'sv_eternal_white_static',
    summonCost: ['sv-angel-whiteout-judicator', 'sv-cher-station-nullpoint'],
    extraSummonConditions: [{ type: 'cherubim_active_gte', value: 1 }],
    onSummonEffects: [{ type: 'radiance_gain', value: 6 }, { type: 'draw', value: 3 }, { type: 'arctic_charge_gain', value: 10 }, { type: 'set_secondary_gain', kind: 'snow', value: 1 }],
    activatedAbility: {
      name: 'Static Crown',
      cardsPlayedRequirement: 5,
  ...
  },
  {
    ...
    onSummonEffects: [{ type: 'radiance_gain', value: 12 }, { type: 'strain_gain', value: 2 }, { type: 'draw', value: 5 }, { type: 'arctic_charge_gain', value: 14 }, { type: 'set_secondary_gain', kind: 'snow', value: 2 }],
    activatedAbility: {
