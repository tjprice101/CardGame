...
export const pyroabyssSeraphims: SeraphimDefinition[] = [
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '200 base Oblivion · 4 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 200,
        cooldownCards: 4,
        costs: [],
      ...
      synergized: {
        ...
        description: '340 base Oblivion · 5 cards cooldown · Requires Angel · +3% attack per Heat (max +75%)',
        baseOblivion: 340,
        cooldownCards: 5,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '225 base Oblivion · 4 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 225,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'fire'],
      ...
      synergized: {
        ...
        description: '383 base Oblivion · 5 cards cooldown · Requires Angel · +3% attack per Heat (max +75%)',
        baseOblivion: 383,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '360 base Oblivion · 4 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 360,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'fire'],
      ...
      synergized: {
        ...
        description: '612 base Oblivion · 5 cards cooldown · Requires Angel · +3% attack per Heat (max +75%)',
        baseOblivion: 612,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '325 base Oblivion · 4 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 325,
        cooldownCards: 4,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'fire'],
      ...
      synergized: {
        ...
        description: '553 base Oblivion · 5 cards cooldown · Requires Angel · +3% attack per Heat (max +75%)',
        baseOblivion: 553,
        cooldownCards: 5,
        costs: [],
        requiresAngelOnBoard: true,
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '530 base Oblivion · 5 cards cooldown · +3% attack per Heat (max +75%)',
        baseOblivion: 530,
        cooldownCards: 5,
        costs: [],
        tags: ['seraphim', 'unsynergized', 'fire'],
      ...
      synergized: {
        ...
        description: '901 base Oblivion · 6 cards cooldown · Requires Angel · +3% attack per Heat (max +75%)',
        baseOblivion: 901,
        cooldownCards: 6,
        costs: [],
        requiresAngelOnBoard: true,
