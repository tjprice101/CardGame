...
export const neutralityStarterCherubimCards: CherubimDefinition[] = [
  {
    ...
    rarity: 'Common',
    name: 'Null Veil',
    description: 'On play: Search your deck for 1 matching Seraphim. While on board: Adjacent Seraphim gain +1 Patience per card played; Buffs Seraphim attacks: base +31, cooldown -1, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Void Shroud',
    description: 'On play: Shuffle discard into deck; All Seraphim on board gain +3 Patience. While on board: Adjacent Seraphim gain +1 Patience per card played; Buffs Seraphim and Angel attacks: base +24, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Balance Mantle',
    description: 'On play: Search your deck for 1 matching Seraphim or Cherubim; All Seraphim on board gain +2 Patience. While on board: Adjacent Seraphim gain +2 Patience per card played; Buffs Seraphim attacks: base +36, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    description: 'On play: Look at the top 4 cards, take 1 card, and put the rest on the bottom. While on board: Adjacent Seraphim gain +2 Patience per card played; Buffs Seraphim attacks: base +36, cooldown +0, multiplier x1.00',
...
export const neutralityPackCherubimCards: CherubimDefinition[] = [
  {
    ...
    description: 'On play: All Seraphim on board gain +4 Patience; +40 Oblivion. While on board: Adjacent Seraphim gain +2 Patience per card played; Buffs Seraphim attacks: base +36, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Epic',
    name: 'Void Amplifier',
    description: 'On play: +140 Oblivion; Empower the next card you play; Salvage any 1 card. While on board: Adjacent Seraphim gain +3 Patience per card played; Buffs Seraphim attacks: base +46, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +36, cooldown +0, multiplier x1.00',
