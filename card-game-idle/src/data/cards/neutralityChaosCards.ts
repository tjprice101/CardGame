...
export const neutralityStarterCherubimCards: CherubimDefinition[] = [
  {
    ...
    rarity: 'Common',
    name: 'Null Veil',
    description: 'On play: Draw 1 card; Search your deck for 1 matching Seraphim. While on board: Buffs Seraphim attacks: base +31, cooldown -1, multiplier x1.00',
...
export const neutralityPackCherubimCards: CherubimDefinition[] = [
  ...
  },
  {
    ...
    rarity: 'Epic',
    name: 'Void Amplifier',
    description: 'On play: +140 Oblivion; Draw 2 cards; Salvage any 1 card. While on board: Buffs Seraphim attacks: base +46, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +36, cooldown +0, multiplier x1.00',
