...
export const blackGlassInfernoAngels: AngelDefinition[] = [
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '746 base Oblivion �E 7 cards cooldown �E Cost: discard 2 cards, sacrifice 1 Seraphim',
        baseOblivion: 2160,
        cooldownCards: 7,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '908 base Oblivion �E 8 cards cooldown �E Cost: discard 2 cards, discard 1 card',
        baseOblivion: 2450,
        cooldownCards: 7,
        costs: [],
        tags: ['angel', 'exalted', 'dark'],
  ...
  },
  {
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '821 base Oblivion �E 7 cards cooldown �E Cost: discard 2 cards',
        baseOblivion: 2150,
        cooldownCards: 7,
        costs: [],
        tags: ['angel', 'exalted', 'dark'],
