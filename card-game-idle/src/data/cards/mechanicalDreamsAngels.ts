...
export const mechanicalDreamsAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: Gain 1 Strain; Draw 1 card; Amplify Chain by +1.4. After 4 cards played: Overclock: gain 2 Strain, then +220 Oblivion; Vent 1 Strain. While on board: +9 Oblivion for each Seraphim on board while on board',
  ...
  },
  {
    ...
    description: 'On summon: Gain 3 Strain; +180 Oblivion; Amplify Chain by +1.6. After 5 cards played: If you have 4+ Strain, +320 Oblivion; Vent 9999 Strain. While on board: +17 Oblivion per card played while on board',
