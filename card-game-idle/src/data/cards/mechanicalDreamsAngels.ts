...
export const mechanicalDreamsAngels: AngelDefinition[] = [
  {
    ...
    description: 'On summon: Gain 1 Strain; Draw 1 card; Set chain floor to x1.4. After 4 cards played: Overclock: gain 2 Strain, then +220 Oblivion; Vent 1 Strain. While on board: +9 Oblivion for each Seraphim on board while on board',
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '821 base Oblivion, 7 cards cooldown, x1.35 chain scaling, Cost: spend 6 Strain',
        baseOblivion: 2230,
        cooldownCards: 7,
        chainScaling: 1.46,
        costs: [],
  ...
  },
  {
    ...
    description: 'On summon: Gain 3 Strain; +180 Oblivion; Set chain floor to x1.6. After 5 cards played: If you have 4+ Strain, +320 Oblivion; Vent 9999 Strain. While on board: +17 Oblivion per card played while on board',
    ...
    attacks: {
      ...
      exalted: {
        ...
        description: '861 base Oblivion, 7 cards cooldown, x1.35 chain scaling, Cost: spend 7 Strain',
        baseOblivion: 2310,
        cooldownCards: 7,
        chainScaling: 1.46,
        costs: [],
