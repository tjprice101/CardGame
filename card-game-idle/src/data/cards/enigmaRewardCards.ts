...
export const enigmaRewardCards: Array<LightCardDefinition | DarkCardDefinition> = [
  {
    ...
    description: 'Two powerful attacks with a low-cost Soph burst and strong triune scaling.',
  ...
  },
  {
    ...
    cooldownCardsPlayed: 2, postActivationFate: 'hand', allowHandCast: true, sacrificeOblivionRate: 70, persistent: true,
  },
];