...
export const blackGlassInfernoSeraphims: SeraphimDefinition[] = [
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Ashen Helix',
    description: 'On play: Amplify Chain by +1.35. While on board: +24 Oblivion whenever you play an Ophanim while active',
  ...
  },
  {
    ...
    description: 'On play: Draw 1 card; Amplify Chain by +1.55. While on board: +22 Oblivion per card played while active',
  ...
  },
  {
    ...
    description: 'On play: Draw 2 cards; Amplify Chain by +1.8. While on board: Gain +260 Oblivion when a Cherubim expires while active',
...
export const blackGlassInfernoOphanims: OphanimDefinition[] = [
  ...
  },
  {
    ...
    description: 'Look at the top 4 cards, take 1 card, and put the rest on the bottom; Amplify Chain by +1.4',
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Sable Descent',
    description: 'Draw 1 card; Amplify Chain by +1.35',
  ...
  },
  {
    ...
    description: '+35 Oblivion; Empower the next card you play; Amplify Chain by +1.2',
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Covenant Split',
    description: 'Amplify Chain by +1.55; If you control 1+ active Seraphim, Draw 1 card; Draw 1 card',
  ...
  },
  {
    ...
    description: '+160 Oblivion; Amplify Chain by +1.7; Empower the next card you play; Draw 1 card',
...
export const blackGlassInfernoCherubim: CherubimDefinition[] = [
  ...
  },
  {
    ...
    name: 'Ashen Court Sigil',
      description: 'On play: Amplify Chain by +1.55; Draw 1 card; +30 Oblivion. While on board: Adjacent active Seraphim gain +12 Oblivion per card played; Buffs Seraphim and Angel attacks: base +12, chain scaling +0.05, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    name: 'Cinderborn Oath',
      description: 'On play: +50 Oblivion; Amplify Chain by +1.6; Draw 1 card. While on board: Adjacent active Seraphim gain +0.1 chain growth; Buffs Angel attacks: base +26, chain scaling +0.02, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    name: 'Veth Serath Midplace',
      description: 'On play: Amplify Chain by +1.7; Salvage 2 cards matching Ophanim or Cherubim; Draw 1 card. While on board: Adjacent active Seraphim gain +18 Oblivion per card played; Buffs Angel attacks: base +16, chain scaling +0.09, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +12, chain scaling +0.06, cooldown +0, multiplier x1.00',
...
export const blackGlassInfernoCherubimCards: CherubimDefinition[] = [
  ...
  },
  {
    ...
    description: 'On play: Amplify Chain by +1.8; Draw 2 cards. While on board: Draw 2 cards per card played; Buffs Seraphim and Angel attacks: base +48, chain scaling +0.07, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +37, chain scaling +0.05, cooldown +0, multiplier x1.00',
