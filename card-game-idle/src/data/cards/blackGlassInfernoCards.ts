...
export const blackGlassInfernoCherubimCards: CherubimDefinition[] = ([
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Chromatic Ward',
    description: 'On play: +60 Oblivion; Gain 2 White Flame. While on board: Buffs Seraphim attacks: base +36, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    description: 'On play: Look at the top 3 cards, take 1 card, and put the rest on the bottom; Gain 2 White Flame. While on board: If you control 1+ active Cherubim, this Cherubim grants +2 bonus power; Buffs Seraphim and Angel attacks: base +38, cooldown +0, multiplier x1.70',
  ...
  },
  {
    ...
    description: 'On play: Draw 2 cards; Gain 2 White Flame. While on board: +2 draw per card played; Buffs Seraphim and Angel attacks: base +48, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +37, cooldown +0, multiplier x1.00',
