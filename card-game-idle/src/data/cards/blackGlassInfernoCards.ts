...
export const blackGlassInfernoSeraphims: SeraphimDefinition[] = [
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '141 base Oblivion · 5 cards cooldown · chain +0.98 · Cost: discard 1 card',
        baseOblivion: 235,
        cooldownCards: 4,
        chainScaling: 1.18,
        costs: [],
      ...
      synergized: {
        ...
        description: '396 base Oblivion · 8 cards cooldown · chain +1.28 · Requires Angel',
        baseOblivion: 400,
        cooldownCards: 5,
        chainScaling: 1.34,
        costs: [],
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Ashen Helix',
    description: 'On play: Amplify Chain by +x1.35; Gain 2 Monochromatic Shards. While on board: +24 Oblivion whenever you play an Ophanim while active',
    ...
    attacks: {
      unsynergized: {
        ...
        description: '130 base Oblivion · 5 cards cooldown · chain +0.91 · Cost: discard 1 card',
        baseOblivion: 235,
        cooldownCards: 4,
        chainScaling: 1.18,
        costs: [],
      ...
      synergized: {
        ...
        description: '375 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
        baseOblivion: 400,
        cooldownCards: 5,
        chainScaling: 1.34,
        costs: [],
    ...
    onPlayEffects: [{ type: 'chain_gain', value: 1.35 }, { type: 'monochromatic_shards_gain', value: 2 }],
  },
  {
    ...
    description: 'On play: +35 Oblivion; Gain 2 Monochromatic Shards. While on board: Chain grows +0.08 per card played while active',
    ...
    attacks: {
      unsynergized: {
        ...
        description: '130 base Oblivion · 2 cards cooldown · chain +1.11 · Cost: discard 1 card',
        baseOblivion: 205,
        cooldownCards: 4,
        chainScaling: 1.18,
        costs: [],
      ...
      synergized: {
        ...
        description: '396 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
        baseOblivion: 349,
        cooldownCards: 5,
        chainScaling: 1.34,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '153 base Oblivion · 3 cards cooldown · chain +0.88 · Cost: discard 1 card',
        baseOblivion: 225,
        cooldownCards: 4,
        chainScaling: 1.18,
        costs: [],
      ...
      synergized: {
        ...
        description: '411 base Oblivion · 4 cards cooldown · chain +1.28 · Requires Angel',
        baseOblivion: 383,
        cooldownCards: 5,
        chainScaling: 1.34,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '176 base Oblivion · 3 cards cooldown · chain +0.90 · Cost: discard 1 card',
        baseOblivion: 410,
        cooldownCards: 4,
        chainScaling: 1.24,
        costs: [],
      ...
      synergized: {
        ...
        description: '542 base Oblivion · 5 cards cooldown · chain +1.31 · Requires Angel',
        baseOblivion: 720,
        cooldownCards: 5,
        chainScaling: 1.40,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '162 base Oblivion · 5 cards cooldown · chain +0.90 · Cost: discard 1 card',
        baseOblivion: 370,
        cooldownCards: 4,
        chainScaling: 1.24,
        costs: [],
      ...
      synergized: {
        ...
        description: '560 base Oblivion · 8 cards cooldown · chain +1.46 · Requires Angel',
        baseOblivion: 629,
        cooldownCards: 5,
        chainScaling: 1.40,
        costs: [],
  ...
  },
  {
    ...
    description: 'On play: Look at the top 3 cards, take 1 card, and put the rest on the bottom; Gain 4 Monochromatic Shards. While on board: Chain grows +0.12 per card played while active',
    ...
    attacks: {
      unsynergized: {
        ...
        description: '155 base Oblivion · 2 cards cooldown · chain +1.14 · Cost: discard 1 card',
        baseOblivion: 340,
        cooldownCards: 4,
        chainScaling: 1.24,
        costs: [],
      ...
      synergized: {
        ...
        description: '452 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
        baseOblivion: 578,
        cooldownCards: 5,
        chainScaling: 1.40,
        costs: [],
  ...
  },
  {
    ...
    description: 'On play: Draw 1 card; Amplify Chain by +x1.55; Gain 4 Monochromatic Shards. While on board: +22 Oblivion per card played while active',
    ...
    attacks: {
      unsynergized: {
        ...
        description: '217 base Oblivion · 5 cards cooldown · chain +1.07 · Cost: discard 1 card',
        baseOblivion: 600,
        cooldownCards: 5,
        chainScaling: 1.32,
        costs: [],
      ...
      synergized: {
        ...
        description: '530 base Oblivion · 8 cards cooldown · chain +1.41 · Requires Angel',
        baseOblivion: 1020,
        cooldownCards: 6,
        chainScaling: 1.48,
        costs: [],
    ...
    onPlayEffects: [{ type: 'draw', value: 1 }, { type: 'chain_gain', value: 1.55 }, { type: 'monochromatic_shards_gain', value: 4 }],
  },
  {
    ...
    description: 'On play: Set chain multiplier to x1.8; Gain 4 Monochromatic Shards. While on board: Chain grows +0.16 per card played while active',
    ...
    attacks: {
      unsynergized: {
        ...
        description: '185 base Oblivion · 2 cards cooldown · chain +1.17 · Cost: discard 1 card',
        baseOblivion: 550,
        cooldownCards: 5,
        chainScaling: 1.32,
        costs: [],
      ...
      synergized: {
        ...
        description: '530 base Oblivion · 8 cards cooldown · chain +1.55 · Requires Angel',
        baseOblivion: 935,
        cooldownCards: 6,
        chainScaling: 1.48,
        costs: [],
  ...
  },
  {
    ...
    description: 'On play: Draw 2 cards; Amplify Chain by +x1.8; Gain 5 Monochromatic Shards. While on board: Gain +260 Oblivion when a Cherubim expires while active',
    ...
    attacks: {
      unsynergized: {
        ...
        description: '280 base Oblivion · 4 cards cooldown · chain +0.94 · Cost: discard 1 card',
        baseOblivion: 1080,
        cooldownCards: 5,
        chainScaling: 1.40,
        costs: [],
      ...
      synergized: {
        ...
        description: '747 base Oblivion · 6 cards cooldown · chain +1.37 · Requires Angel',
        baseOblivion: 1880,
        cooldownCards: 6,
        chainScaling: 1.56,
        costs: [],
    ...
    onPlayEffects: [{ type: 'draw', value: 2 }, { type: 'chain_gain', value: 1.8 }, { type: 'monochromatic_shards_gain', value: 5 }],
  },
];
...
export const blackGlassInfernoOphanims: OphanimDefinition[] = [
  ...
  },
  {
    ...
    description: 'Look at the top 4 cards, take 1 card, and put the rest on the bottom; Amplify Chain by +x1.4',
    artKey: 'bgi_seek_veilplane_shard',
    effects: [{ type: 'look_top_take', look: 4, take: 1 }, { type: 'chain_gain', value: 1.4 }],
  },
  {
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Sable Descent',
    description: 'Draw 1 card; Amplify Chain by +x1.35',
    artKey: 'bgi_seek_sable_descent',
    effects: [{ type: 'draw', value: 1 }, { type: 'chain_gain', value: 1.35 }],
  },
  {
  ...
  },
  {
    ...
    description: '+35 Oblivion; Empower the next card you play; Amplify Chain by +x1.2',
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Covenant Split',
    description: 'Amplify Chain by +x1.55; If you control 1+ active Seraphim, Draw 1 card; Draw 1 card',
    artKey: 'bgi_seek_covenant_split',
    effects: [
      { type: 'chain_gain', value: 1.55 },
  ...
  },
  {
    ...
    description: '+160 Oblivion; Amplify Chain by +x1.7; Empower the next card you play; Draw 1 card',
    artKey: 'bgi_seek_copper_hate_psalm',
    effects: [{ type: 'oblivion_flat', value: 160 }, { type: 'chain_gain', value: 1.7 }],
  },
  {
  ...
  },
  {
    ...
    description: 'Draw 4 cards; Amplify Chain by +x2.0; Empower the next card you play',
    artKey: 'bgi_seek_sorveths_eleventh_second',
    effects: [{ type: 'draw', value: 4 }, { type: 'chain_gain', value: 2.0 }, { type: 'multiply_next' }, { type: 'monochromatic_shards_gain', value: 8 }],
  },
  {
...
export const blackGlassInfernoCherubim: CherubimDefinition[] = [
  {
    ...
    rarity: 'Common',
    name: 'Glassrose Pyre',
      description: 'On play: Draw 2 cards; Salvage 1 card matching Ophanim. While on board: Adjacent active Seraphim gain +8 Oblivion per card played; Buffs Seraphim and Angel attacks: base +6, chain bonus +0.04, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    name: 'Ashen Court Sigil',
      description: 'On play: Amplify Chain by +x1.55; Draw 1 card; +30 Oblivion. While on board: Adjacent active Seraphim gain +12 Oblivion per card played; Buffs Seraphim and Angel attacks: base +12, chain bonus +0.05, cooldown +0, multiplier x1.00',
    artKey: 'bgi_cherubim_ashencourt_sigil',
    maxDurability: 2,
      effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'oblivion', value: 12 }],
      onPlayEffects: [{ type: 'chain_gain', value: 1.55 }, { type: 'draw', value: 1 }, { type: 'oblivion_flat', value: 30 }],
  },
  {
    ...
    name: 'Cinderborn Oath',
      description: 'On play: +50 Oblivion; Amplify Chain by +x1.6; Draw 1 card. While on board: Adjacent active Seraphim gain +0.1 chain growth; Buffs Angel attacks: base +26, chain bonus +0.02, cooldown +0, multiplier x1.00',
    artKey: 'bgi_cherubim_cinderborn_oath',
    maxDurability: 3,
      effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'chain', value: 0.10 }],
      onPlayEffects: [{ type: 'oblivion_flat', value: 50 }, { type: 'chain_gain', value: 1.6 }, { type: 'draw', value: 1 }],
  },
  {
    ...
    name: 'Veilplane Fissure',
      description: 'On play: Salvage any 1 card; Draw 2 cards; +80 Oblivion. While on board: Adjacent active Seraphim gain +16 Oblivion per card played; Buffs Seraphim attacks: base +17, chain bonus +0.05, cooldown -1, multiplier x1.00',
  ...
  },
  {
    ...
    name: 'Chromatic Crater',
      description: 'On play: Draw 2 cards; Set chain multiplier to x1.8. While on board: Adjacent active Seraphim gain +14 Oblivion per card played; Buffs Angel attacks: base +13, chain bonus +0.07, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Ruin Garden',
      description: 'On play: Shuffle discard into deck; Salvage any 1 card; Draw 1 card. While on board: Adjacent active Seraphim gain +0.14 chain growth; Buffs Seraphim and Angel attacks: base +33, chain bonus +0.02, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Epic',
    name: "Sorveth's Ring",
      description: 'On play: Empower the next card you play; Draw 3 cards; +90 Oblivion. While on board: Adjacent active Seraphim gain +16 Oblivion per card played; Buffs Seraphim attacks: base +17, chain bonus +0.06, cooldown -1, multiplier x1.00; Buffs Angel attacks: base +13, chain bonus +0.04, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    name: 'Veth Serath Midplace',
      description: 'On play: Amplify Chain by +x1.7; Salvage 2 cards matching Ophanim or Cherubim; Draw 1 card. While on board: Adjacent active Seraphim gain +18 Oblivion per card played; Buffs Angel attacks: base +16, chain bonus +0.09, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +12, chain bonus +0.06, cooldown +0, multiplier x1.00',
    artKey: 'bgi_cherubim_veth_serath_midplace',
    maxDurability: 4,
      effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'oblivion', value: 18 }],
      onPlayEffects: [{ type: 'chain_gain', value: 1.7 }, { type: 'salvage_by_type', filter: ['Ophanim', 'Cherubim'] }, { type: 'draw', value: 1 }],
  },
  {
    ...
    name: 'Vaelthorax Grieffire',
      description: 'On play: Draw 3 cards; +180 Oblivion; Set chain multiplier to x2.1. While on board: Adjacent active Seraphim gain +20 Oblivion per card played; Buffs Seraphim attacks: base +21, chain bonus +0.07, cooldown -1, multiplier x1.00; Buffs Angel attacks: base +16, chain bonus +0.05, cooldown -1, multiplier x1.00',
...
export const blackGlassInfernoCherubimCards: CherubimDefinition[] = [
  {
    ...
    rarity: 'Common',
    name: 'Null Obsidian',
    description: 'On play: Draw 1 card; +25 Oblivion. While on board: Adjacent active Seraphim gain +9 Oblivion per card played; Buffs Seraphim and Angel attacks: base +7, chain bonus +0.04, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Rose Shroud',
    description: 'On play: Empower the next card you play. While on board: Adjacent active Seraphim gain +2 Oblivion per card played; Buffs Angel attacks: base +2, chain bonus +0.06, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Void Veil',
    description: 'On play: Shuffle discard into deck. While on board: Adjacent active Seraphim gain +11 Oblivion per card played; Buffs Seraphim attacks: base +12, chain bonus +0.04, cooldown -1, multiplier x1.00',
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Chromatic Ward',
    description: 'On play: +60 Oblivion. While on board: Adjacent active Seraphim gain +0.09 chain growth; Buffs Seraphim attacks: base +36, chain bonus +0.01, cooldown +0, multiplier x1.00',
  ...
  },
  {
    ...
    description: 'On play: Look at the top 3 cards, take 1 card, and put the rest on the bottom. While on board: If you control 1+ active Cherubim, this Cherubim grants +1.7 bonus power; Buffs Seraphim and Angel attacks: base +38, chain bonus +0.06, cooldown +0, multiplier x1.70',
  ...
  },
  {
    ...
    description: 'On play: Amplify Chain by +x1.8; Draw 2 cards. While on board: Draw 2 cards per card played; Buffs Seraphim and Angel attacks: base +48, chain bonus +0.07, cooldown +0, multiplier x1.00; Buffs Angel attacks: base +37, chain bonus +0.05, cooldown +0, multiplier x1.00',
    artKey: 'bgi_cherubim_grieffire_ascent',
    effects: [{ type: 'cherubim_draw_per_card', value: 2 }],
    onPlayEffects: [{ type: 'chain_gain', value: 1.8 }, { type: 'draw', value: 2 }],
  },
  {
  ...
  },
  {
    ...
    rarity: 'Legendary',
    name: 'Abyss Throne',
    description: 'On play: Set chain multiplier to x2.0; +100 Oblivion. While on board: Adjacent active Seraphim gain +20 Oblivion per card played; Buffs Seraphim attacks: base +21, chain bonus +0.07, cooldown -1, multiplier x1.00; Buffs Angel attacks: base +16, chain bonus +0.05, cooldown -1, multiplier x1.00',
