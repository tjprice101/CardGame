...
export const blackGlassInfernoSeraphims: SeraphimDefinition[] = ([
  ...
  },
  {
    ...
    rarity: 'Common',
    name: 'Ashen Helix',
    description: 'On play: Gain 2 Monochromatic Shards; If you have 4+ Black Flame, Swap White Flame and Black Flame; Gain 2 Black Flame. While on board: +24 Oblivion whenever you play an Ophanim while active',
    ...
    onPlayEffects: [{ type: 'monochromatic_shards_gain', value: 2 }, { type: 'conditional', condition: { type: 'black_glass_black_flame_gte', value: 4 }, then: [{ type: 'black_glass_flames_swap' }] }],
  },
  {
  ...
  },
  {
    ...
    description: 'On play: Gain 3 Monochromatic Shards; If White Flame equals Black Flame, Draw 1 card; Gain 2 Black Flame. While on board: +30 Oblivion whenever you play an Ophanim while active',
    ...
    onPlayEffects: [{ type: 'monochromatic_shards_gain', value: 3 }, { type: 'conditional', condition: { type: 'black_glass_flames_equal' }, then: [{ type: 'draw', value: 1 }] }],
  },
  {
...
export const blackGlassInfernoOphanims: OphanimDefinition[] = ([
  ...
  },
  {
    ...
    description: 'Look at the top 5 cards and take 1 matching Ophanim; Gain 3 Monochromatic Shards; Gain 2 Black Flame',
    artKey: 'bgi_seek_chromatic_sorrow',
    effects: [{ type: 'look_top_take_type', look: 5, filter: ['Ophanim'] }, { type: 'monochromatic_shards_gain', value: 3 }],
  },
  {
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Lament Siphon',
    description: 'Salvage 1 card matching Seraphim; +60 Oblivion; Gain 5 Monochromatic Shards; Gain 2 Black Flame',
    artKey: 'bgi_seek_lament_siphon',
    effects: [{ type: 'salvage_by_type', filter: ['Seraphim'] }, { type: 'oblivion_flat', value: 60 }, { type: 'monochromatic_shards_gain', value: 5 }],
  },
  {
    ...
    rarity: 'Rare',
    name: 'Covenant Split',
    description: 'If you control 1+ active Seraphim, Draw 2 cards; Gain 2 Monochromatic Shards; If you have 3+ Black Flame, +60 Oblivion; Gain 2 Black Flame',
    artKey: 'bgi_seek_covenant_split',
    effects: [
      { type: 'conditional', condition: { type: 'seraphim_active_gte', value: 1 }, then: [{ type: 'draw', value: 2 }] },
      { type: 'monochromatic_shards_gain', value: 2 },
      { type: 'conditional', condition: { type: 'black_glass_black_flame_gte', value: 3 }, then: [{ type: 'oblivion_flat', value: 60 }] }],
  },
  {
    ...
    description: 'Look at the top 6 cards, take 2 cards, and put the rest on the bottom; Gain 4 Monochromatic Shards; Gain 2 Black Flame',
    artKey: 'bgi_seek_infernal_script',
    effects: [{ type: 'look_top_take', look: 6, take: 2 }, { type: 'monochromatic_shards_gain', value: 4 }],
  },
  {
...
export const blackGlassInfernoCherubim: CherubimDefinition[] = ([
  ...
  },
  {
    ...
    name: 'Cinderborn Oath',
      description: 'On play: +50 Oblivion; Draw 1 card; Gain 2 White Flame. While on board: Adjacent active Seraphim gain +10 Oblivion per card played',
  ...
  },
  {
    ...
    rarity: 'Rare',
    name: 'Ruin Garden',
      description: 'On play: Shuffle discard into deck; Salvage 1 card matching Seraphim; Draw 1 card; Gain 2 White Flame. While on board: Adjacent active Seraphim gain +12 Oblivion per card played',
    artKey: 'bgi_cherubim_ruin_garden',
    maxDurability: 2,
      effects: [{ type: 'cherubim_adjacent_seraphim_bonus', bonusType: 'oblivion', value: 12 }],
      onPlayEffects: [{ type: 'shuffle_discard' }, { type: 'salvage_by_type', filter: ['Seraphim'] }, { type: 'draw', value: 1 }],
  },
  {
    ...
    rarity: 'Epic',
    name: "Sorveth's Ring",
      description: 'On play: Draw 3 cards; +90 Oblivion; Gain 2 White Flame. While on board: +8 Oblivion per card played',
  ...
  },
  {
    ...
    name: 'Vaelthorax Grieffire',
      description: 'On play: Draw 3 cards; +180 Oblivion; Gain 2 White Flame. While on board: Whenever you discard a card, +30 Oblivion',
    artKey: 'bgi_cherubim_vaelthorax_grieffire',
    maxDurability: 5,
      effects: [{ type: 'cherubim_on_discard', value: 30 }],
