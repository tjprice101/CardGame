...
const MILESTONE_TITLES: TitleBadgeDefinition[] = [
  ...
  // ── Divine Light milestones ──────────────────────────────────────────────
  {
    ...
    isUnlocked: (p) => (p.lifetimeDivineLight ?? p.divineLight) >= 1_000,
    group: 'milestone',
  },
  {
    ...
    isUnlocked: (p) => (p.bestSingleTurnDivineLight ?? 0) >= 10_000,
    group: 'milestone',
  },
  {
    id: 'title-stillness',
    ...
    isUnlocked: (p) => (p.lifetimeDivineLight ?? p.divineLight) >= 100_000,
    group: 'milestone',
  },
  {
    ...
    isUnlocked: (p) => (p.lifetimeDivineLight ?? p.divineLight) >= 1_000_000,
    group: 'milestone',
  },
  {
    ...
    isUnlocked: (p) => (p.lifetimeDivineLight ?? p.divineLight) >= 10_000_000,
    group: 'milestone',
  },
  // ── Divine Light apex ────────────────────────────────────────────────────
  {
    ...
    isUnlocked: (p) => (p.lifetimeDivineLight ?? p.divineLight) >= 100_000_000,
    group: 'milestone',
  },
  // ── Boss milestones ──────────────────────────────────────────────────────
  {
