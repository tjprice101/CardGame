...
export const ARTIFACT_DEFINITIONS: ArtifactDefinition[] = [
  ...
  // ── Heavenly Light ──────────────────────────────────────────────────────────
  {
    ...
    tier: 'basic',
    name: 'Radiant Prism',
    description: '+1 Radiance per Heavenly Light card played. Each note shines a little brighter.',
    powderCost: T1,
  ...
  },
  {
    ...
    setName: 'Heavenly Light',
    tier: 'advanced',
    name: 'Sanctified Radiance',
    description: '+1 additional Radiance per Heavenly Light card played. The hymn grows brighter with each note.',
    powderCost: T2,
    effects: [{ type: 'resonance_gain_bonus', value: 1 }],
  },
  {
    ...
    description: '+2 additional Radiance per Light card played. The heavens open fully for those who ascend.',
    powderCost: T3,
  ...
  // ── Mechanical Dreams ───────────────────────────────────────────────────────
  {
    ...
    tier: 'basic',
    name: 'Gear Array',
    description: 'Reactor Core +1 at the start of each turn. A small overclock spool you keep humming.',
    powderCost: T1,
  ...
  },
  {
    ...
    description: 'Reactor Core +1 at the start of each turn. The drive primes a deeper power loop.',
    powderCost: T2,
    effects: [{ type: 'queue_capacity_bonus', value: 1 }],
  },
  {
    ...
    description: 'Reactor Core +2 at the start of each turn. Apex calibration that floods the engine with cores.',
    powderCost: T3,
