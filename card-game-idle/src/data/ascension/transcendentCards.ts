  ...
  },
  {
    ...
    attacks: {
      primary: {
        ...
        description: '4600 base Oblivion · 5 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 4600,
        cooldownCards: 5,
        costs: [],
      ...
      exalted: {
        ...
        description: '13685 base Oblivion · 8 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 13685,
        cooldownCards: 8,
        costs: [],
  ...
  },
  {
    ...
    attacks: {
      unsynergized: {
        ...
        description: '9439 base Oblivion · 4 cards cooldown · +2.5% attack per Heat (max +75%)',
        baseOblivion: 9439,
        cooldownCards: 4,
        costs: [],
      ...
      synergized: {
        ...
        description: '15540 base Oblivion · 8 cards cooldown · Requires Angel · +2.5% attack per Heat (max +75%)',
        baseOblivion: 15540,
        cooldownCards: 8,
        costs: [],
        requiresAngelOnBoard: true,
