// MainMenuRadio — shuffled radio playlist for the main menu.
//
...
// 2. Append an entry to MAIN_MENU_RADIO_PLAYLIST below — done.
// ─────────────────────────────────────────────────────────────────────
...
/**
 * The main menu radio playlist.
 * Add entries here to expand the radio — no other changes required.
 */
export const MAIN_MENU_RADIO_PLAYLIST: RadioTrack[] = [
  {
    id: 'space-between-eternities',
    title: 'The Space Between Eternities',
    filename: 'the-space-between-eternities-main-menu.mp3',
    gain: 1.0,
  },
  {
    id: 'wings-of-the-board',
    title: 'Wings of the Board',
...
class MainMenuRadioImpl {
  ...
  private buildQueue(avoidLeading?: string): RadioTrack[] {
    const arr = [...MAIN_MENU_RADIO_PLAYLIST];
...
export const MainMenuRadio = new MainMenuRadioImpl();
