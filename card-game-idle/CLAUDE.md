...
- Daily login rewards use a persistent full-screen monthly calendar reachable from Main Menu > Progress. All days fit on-screen; tiles use Aberrated Shards/Card-light Shards icons and actual awarded card art. Missed days do not reset progress, but claims remain limited to one successful reward per UTC day.
